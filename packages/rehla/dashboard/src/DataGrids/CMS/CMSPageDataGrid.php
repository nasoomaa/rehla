...
namespace Rehla\Dashboard\DataGrids\CMS;
...
class CMSPageDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.cms.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'channel',
            'label' => trans('dashboard::app.cms.index.datagrid.channel'),
            'type' => 'string',
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'page_title',
            'label' => trans('dashboard::app.cms.index.datagrid.page-title'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'url_key',
            'label' => trans('dashboard::app.cms.index.datagrid.url-key'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
    ...
    public function prepareActions()
    {
        $this->addAction([
            'icon' => 'icon-view',
            'title' => trans('dashboard::app.cms.index.datagrid.view'),
            'method' => 'GET',
            'index' => 'url_key',
            'target' => '_blank',
            'url' => function ($row) {
        ...
        if (bouncer()->hasPermission('cms.edit')) {
            $this->addAction([
                'icon' => 'icon-edit',
                'title' => trans('dashboard::app.cms.index.datagrid.edit'),
                'method' => 'GET',
                'url' => function ($row) {
        ...
        if (bouncer()->hasPermission('cms.delete')) {
            $this->addAction([
                'icon' => 'icon-delete',
                'title' => trans('dashboard::app.cms.index.datagrid.delete'),
                'method' => 'DELETE',
                'url' => function ($row) {
