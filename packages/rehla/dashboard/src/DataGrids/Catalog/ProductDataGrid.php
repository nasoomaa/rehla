...
class ProductDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        if ($channels->count() > 1) {
            $this->addColumn([
                'index' => 'channel',
                'label' => trans('dashboard::app.catalog.products.index.datagrid.channel'),
                'type' => 'string',
                'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'name',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.name'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'sku',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.sku'),
            'type' => 'string',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.catalog.products.index.datagrid.attribute-family'),
            'type' => 'string',
            'filterable' => true,
            'filterable_type' => 'dropdown',
        ...
        $this->addColumn([
            'index' => 'base_image',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.image'),
            'type' => 'string',
            'exportable' => false,
        ...
        $this->addColumn([
            'index' => 'price',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.price'),
            'type' => 'decimal',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'quantity',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.qty'),
            'type' => 'integer',
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'product_id',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'status',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.status'),
            'type' => 'boolean',
            'filterable' => true,
            'filterable_options' => [
                [
                    'label' => trans('dashboard::app.catalog.products.index.datagrid.active'),
                    'value' => 1,
                ],
                [
                    'label' => trans('dashboard::app.catalog.products.index.datagrid.disable'),
                    'value' => 0,
                ],
            ],
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'category_name',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.category'),
            'type' => 'string',
        ]);

        $this->addColumn([
            'index' => 'type',
            'label' => trans('dashboard::app.catalog.products.index.datagrid.type'),
            'type' => 'string',
            'filterable' => true,
            'filterable_type' => 'dropdown',
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('catalog.products.copy')) {
            $this->addAction([
                'icon' => 'icon-copy',
                'title' => trans('dashboard::app.catalog.products.index.datagrid.copy'),
                'method' => 'POST',
                'url' => function ($row) {
        ...
        if (bouncer()->hasPermission('catalog.products.edit')) {
            $this->addAction([
                ...
                'title' => trans('dashboard::app.catalog.products.index.datagrid.edit'),
                'method' => 'GET',
                'url' => function ($row) {
    ...
    public function prepareMassActions()
    {
        if (bouncer()->hasPermission('catalog.products.delete')) {
            $this->addMassAction([
                'title' => trans('dashboard::app.catalog.products.index.datagrid.delete'),
        ...
        if (bouncer()->hasPermission('catalog.products.edit')) {
            $this->addMassAction([
                'title' => trans('dashboard::app.catalog.products.index.datagrid.update-status'),
