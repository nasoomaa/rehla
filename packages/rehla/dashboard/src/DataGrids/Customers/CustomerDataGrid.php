...
class CustomerDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            'index' => 'channel_id',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.channel'),
            'type' => 'string',
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'customer_id',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'full_name',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.name'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'email',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.email'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'phone',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.phone'),
            'type' => 'integer',
            'filterable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'status',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.status'),
            'type' => 'boolean',
            'filterable' => true,
            'filterable_options' => [
                [
                    'label' => trans('dashboard::app.customers.customers.index.datagrid.active'),
                    'value' => 1,
                ],
                [
                    'label' => trans('dashboard::app.customers.customers.index.datagrid.inactive'),
                    'value' => 0,
                ],
            ],
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'gender',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.gender'),
            'type' => 'string',
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'group',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.group'),
            'type' => 'string',
            'filterable' => true,
            'filterable_type' => 'dropdown',
        ...
        $this->addColumn([
            'index' => 'is_suspended',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.suspended'),
            'type' => 'boolean',
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'revenue',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.revenue'),
            'type' => 'integer',
            'exportable' => false,
        ...
        $this->addColumn([
            'index' => 'order_count',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.order-count'),
            'type' => 'integer',
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'address_count',
            'label' => trans('dashboard::app.customers.customers.index.datagrid.address-count'),
            'type' => 'integer',
            'sortable' => true,
        ]);
    }
    ...
    public function prepareActions()
    {
        $this->addAction([
            'icon' => 'icon-view',
            'title' => trans('dashboard::app.customers.customers.index.datagrid.view'),
            'method' => 'GET',
            'url' => function ($row) {
        ...
        $this->addAction([
            'icon' => 'icon-exit',
            'title' => trans('dashboard::app.customers.customers.index.datagrid.login-as-customer'),
            'method' => 'GET',
            'target' => 'blank',
            'url' => function ($row) {
    ...
    public function prepareMassActions()
    {
        if (bouncer()->hasPermission('customers.customers.delete')) {
            $this->addMassAction([
                'title' => trans('dashboard::app.customers.customers.index.datagrid.delete'),
                'method' => 'POST',
        ...
        if (bouncer()->hasPermission('customers.customers.edit')) {
            $this->addMassAction([
                'title' => trans('dashboard::app.customers.customers.index.datagrid.update-status'),
                'method' => 'POST',
