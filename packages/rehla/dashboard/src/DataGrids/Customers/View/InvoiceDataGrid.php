...
class InvoiceDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'increment_id',
            'label' => trans('dashboard::app.customers.customers.view.datagrid.invoices.increment-id'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'created_at',
            'label' => trans('dashboard::app.customers.customers.view.datagrid.invoices.invoice-date'),
            'type' => 'date',
            'searchable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.customers.customers.view.datagrid.invoices.invoice-amount'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'order_id',
            'label' => trans('dashboard::app.customers.customers.view.datagrid.invoices.order-id'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
    ...
    public function prepareActions()
    {
        $this->addAction([
            'icon' => 'icon-view',
            'title' => trans('dashboard::app.customers.customers.view.datagrid.invoices.view'),
            'method' => 'GET',
            'url' => function ($row) {
