...
class EventDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.marketing.communications.events.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'name',
            'label' => trans('dashboard::app.marketing.communications.events.index.datagrid.name'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'date',
            'label' => trans('dashboard::app.marketing.communications.events.index.datagrid.date'),
            'type' => 'date',
            'searchable' => true,
            'filterable' => true,
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('marketing.communications.events.edit')) {
            $this->addAction([
                'index' => 'edit',
                'icon' => 'icon-edit',
                'title' => trans('dashboard::app.marketing.communications.events.index.datagrid.edit'),
                'method' => 'PUT',
                'url' => function ($row) {
        ...
        if (bouncer()->hasPermission('marketing.communications.events.delete')) {
            $this->addAction([
                'index' => 'delete',
                'icon' => 'icon-delete',
                'title' => trans('dashboard::app.marketing.communications.events.index.datagrid.delete'),
                'method' => 'DELETE',
                'url' => function ($row) {
