...
class SearchSynonymDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'name',
            'label' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.datagrid.name'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'terms',
            'label' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.datagrid.terms'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('marketing.search_seo.search_synonyms.edit')) {
            $this->addAction([
                'index' => 'edit',
                'icon' => 'icon-edit',
                'title' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.datagrid.edit'),
                'method' => 'GET',
        ...
        if (bouncer()->hasPermission('marketing.search_seo.search_synonyms.delete')) {
            $this->addAction([
                'index' => 'delete',
                'icon' => 'icon-delete',
                'title' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.datagrid.delete'),
                'method' => 'DELETE',
                'url' => function ($row) {
