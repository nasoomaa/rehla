...
class SearchTermDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'term',
            'label' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.search-query'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'results',
            'label' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.results'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'uses',
            'label' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.uses'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'redirect_url',
            'label' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.redirect-url'),
            'type' => 'string',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'channel_id',
            'label' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.channel'),
            'type' => 'string',
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'locale',
            'label' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.locale'),
            'type' => 'string',
            'filterable' => true,
            'filterable_type' => 'dropdown',
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('marketing.search_seo.search_terms.edit')) {
            $this->addAction([
                'index' => 'edit',
                'icon' => 'icon-edit',
                'title' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.edit'),
                'method' => 'GET',
        ...
        if (bouncer()->hasPermission('marketing.search_seo.search_terms.delete')) {
            $this->addAction([
                'index' => 'delete',
                'icon' => 'icon-delete',
                'title' => trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.delete'),
                'method' => 'DELETE',
                'url' => function ($row) {
