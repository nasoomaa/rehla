...
class SitemapDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.marketing.search-seo.sitemaps.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'channel',
            'label' => trans('dashboard::app.marketing.search-seo.sitemaps.index.datagrid.channel'),
            'type' => 'string',
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'file_name',
            'label' => trans('dashboard::app.marketing.search-seo.sitemaps.index.datagrid.file-name'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'path',
            'label' => trans('dashboard::app.marketing.search-seo.sitemaps.index.datagrid.path'),
            'type' => 'string',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'url',
            'label' => trans('dashboard::app.marketing.search-seo.sitemaps.index.datagrid.link-for-google'),
            'type' => 'string',
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('marketing.search_seo.sitemaps.edit')) {
            $this->addAction([
                'index' => 'edit',
                'icon' => 'icon-edit',
                'title' => trans('dashboard::app.marketing.search-seo.sitemaps.index.datagrid.edit'),
                'method' => 'GET',
        ...
        if (bouncer()->hasPermission('marketing.search_seo.sitemaps.delete')) {
            $this->addAction([
                'index' => 'delete',
                'icon' => 'icon-delete',
                'title' => trans('dashboard::app.marketing.search-seo.sitemaps.index.datagrid.delete'),
                'method' => 'DELETE',
