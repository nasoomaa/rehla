...
class BookingDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.sales.booking.index.datagrid.id'),
            'type' => 'integer',
            'searchable' => false,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'order_id',
            'label' => trans('dashboard::app.sales.booking.index.datagrid.order-id'),
            'type' => 'integer',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'qty',
            'label' => trans('dashboard::app.sales.booking.index.datagrid.qty'),
            'type' => 'integer',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'from',
            'label' => trans('dashboard::app.sales.booking.index.datagrid.from'),
            'type' => 'datetime',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'to',
            'label' => trans('dashboard::app.sales.booking.index.datagrid.to'),
            'type' => 'datetime',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index' => 'created_at',
            'label' => trans('dashboard::app.sales.booking.index.datagrid.created-date'),
            'type' => 'datetime',
            'searchable' => true,
            'sortable' => true,
            'filterable' => true,
    ...
    public function prepareActions()
    {
        $this->addAction([
            'icon' => 'icon-view',
            'title' => trans('dashboard::app.sales.booking.index.datagrid.view'),
            'method' => 'GET',
            'url' => function ($row) {
