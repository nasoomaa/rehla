...
class OrderRefundDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.sales.refunds.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'increment_id',
            'label' => trans('dashboard::app.sales.refunds.index.datagrid.order-id'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.sales.refunds.index.datagrid.refunded-amount'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'billed_to',
            'label' => trans('dashboard::app.sales.refunds.index.datagrid.billed-to'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'created_at',
            'label' => trans('dashboard::app.sales.refunds.index.datagrid.refund-date'),
            'type' => 'date',
            'searchable' => true,
            'filterable' => true,
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('sales.refunds.view')) {
            $this->addAction([
                'icon' => 'icon-view',
                'title' => trans('dashboard::app.sales.refunds.index.datagrid.view'),
                'method' => 'GET',
                'url' => function ($row) {
