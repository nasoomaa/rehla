...
class OrderShipmentDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'shipment_id',
            'label' => trans('dashboard::app.sales.shipments.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.sales.shipments.index.datagrid.order-id'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.sales.shipments.index.datagrid.total-qty'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.sales.shipments.index.datagrid.inventory-source'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'shipped_to',
            'label' => trans('dashboard::app.sales.shipments.index.datagrid.shipment-to'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'order_date',
            'label' => trans('dashboard::app.sales.shipments.index.datagrid.order-date'),
            'type' => 'date',
            'filterable' => true,
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.sales.shipments.index.datagrid.shipment-date'),
            'type' => 'date',
            'filterable' => true,
            'filterable_type' => 'date_range',
            'sortable' => true,
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('sales.shipments.view')) {
            $this->addAction([
                'icon' => 'icon-view',
                'title' => trans('dashboard::app.sales.shipments.index.datagrid.view'),
                'method' => 'GET',
                'url' => function ($row) {
