...
class OrderTransactionDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.sales.transactions.index.datagrid.id'),
            'type' => 'integer',
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.sales.transactions.index.datagrid.transaction-id'),
            'type' => 'string',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'amount',
            'label' => trans('dashboard::app.sales.transactions.index.datagrid.transaction-amount'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'invoice_id',
            'label' => trans('dashboard::app.sales.transactions.index.datagrid.invoice-id'),
            'type' => 'integer',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'order_id',
            'label' => trans('dashboard::app.sales.transactions.index.datagrid.order-id'),
            'type' => 'integer',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'status',
            'label' => trans('dashboard::app.sales.transactions.index.datagrid.status'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'created_at',
            'label' => trans('dashboard::app.sales.transactions.index.datagrid.transaction-date'),
            'type' => 'date',
            'searchable' => true,
            'filterable' => true,
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('sales.shipments.view')) {
            $this->addAction([
                'icon' => 'icon-view',
                'title' => trans('dashboard::app.sales.transactions.index.datagrid.view'),
                'method' => 'GET',
                'url' => function ($row) {
