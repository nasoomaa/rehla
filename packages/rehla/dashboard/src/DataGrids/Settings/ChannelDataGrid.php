...
class ChannelDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index' => 'id',
            'label' => trans('dashboard::app.settings.channels.index.datagrid.id'),
            'type' => 'integer',
            'filterable' => true,
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index' => 'code',
            'label' => trans('dashboard::app.settings.channels.index.datagrid.code'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            ...
            'label' => trans('dashboard::app.settings.channels.index.datagrid.name'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            'index' => 'hostname',
            'label' => trans('dashboard::app.settings.channels.index.datagrid.host-name'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('settings.channels.edit')) {
            $this->addAction([
                'icon' => 'icon-edit',
                'title' => trans('dashboard::app.settings.channels.index.datagrid.edit'),
                'method' => 'GET',
                'url' => function ($row) {
        ...
        if (bouncer()->hasPermission('settings.channels.delete')) {
            $this->addAction([
                'icon' => 'icon-delete',
                'title' => trans('dashboard::app.settings.channels.index.datagrid.delete'),
                'method' => 'DELETE',
                'url' => function ($row) {
