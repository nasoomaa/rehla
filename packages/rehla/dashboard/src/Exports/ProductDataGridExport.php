...
namespace Rehla\Dashboard\Exports;
...
class ProductDataGridExport implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping
{
    ...
    public function headings(): array
    {
        ...
        return array_merge(
            ...
            $attributeHeaders,
            [
                trans('dashboard::app.catalog.products.edit.images.title'),
                trans('dashboard::app.catalog.products.edit.videos.title'),
            ]
        );
    }
    ...
    protected function resolveAttributeValue(int $productId, object $attribute): mixed
    {
        ...
        return match ($attribute->type) {
            ...
            'boolean' => (bool) $value
                ? trans('dashboard::app.export.yes')
                : trans('dashboard::app.export.no'),
