...
namespace Rehla\Dashboard\Helpers;

use Illuminate\Database\Eloquent\Collection as EloquentCollection;
use Illuminate\Support\Carbon;
use Rehla\Dashboard\Helpers\Reporting\Cart;
use Rehla\Dashboard\Helpers\Reporting\Customer;
use Rehla\Dashboard\Helpers\Reporting\Product;
use Rehla\Dashboard\Helpers\Reporting\Sale;
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'label',
                        'label' => trans('dashboard::app.reporting.sales.index.interval'),
                    ], [
                        'key' => 'count',
                        'label' => trans('dashboard::app.reporting.sales.index.orders'),
                    ], [
                        'key' => 'formatted_total',
                        'label' => trans('dashboard::app.reporting.sales.index.total'),
                    ],
                ],
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'id',
                        'label' => trans('dashboard::app.reporting.sales.index.id'),
                    ], [
                        'key' => 'name',
                        'label' => trans('dashboard::app.reporting.sales.index.name'),
                    ], [
                        'key' => 'count',
                        'label' => trans('dashboard::app.reporting.sales.index.count'),
                    ],
                ],
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'title',
                        'label' => trans('dashboard::app.reporting.sales.index.payment-method'),
                    ], [
                        'key' => 'total',
                        'label' => trans('dashboard::app.reporting.sales.index.orders'),
                    ], [
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'increment_id',
                        'label' => trans('dashboard::app.reporting.sales.index.order-id'),
                        'link' => 'order_link',
                    ], [
                        'key' => 'coupon_code',
                        'label' => trans('dashboard::app.reporting.sales.index.coupon-code'),
                        'link' => 'link',
                    ], [
                        'key' => 'customer_email',
                        'label' => trans('dashboard::app.reporting.sales.index.email'),
                    ], [
                        'key' => 'formatted_discount_total',
                        'label' => trans('dashboard::app.reporting.sales.index.discount'),
                    ], [
                        'key' => 'formatted_total',
                        'label' => trans('dashboard::app.reporting.sales.index.total'),
                    ], [
                        'key' => 'formatted_created_at',
                        'label' => trans('dashboard::app.reporting.sales.index.date'),
                    ],
                ],
        ...
        if ($type == 'table') {
            return [
                'columns' => [
                    [
                        'key' => 'label',
                        'label' => trans('dashboard::app.reporting.customers.index.interval'),
                    ], [
                        'key' => 'total',
                        'label' => trans('dashboard::app.reporting.customers.index.customers'),
                    ],
                ],
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'full_name',
                        'label' => trans('dashboard::app.reporting.customers.index.name'),
                    ], [
                        'key' => 'email',
                        'label' => trans('dashboard::app.reporting.customers.index.email'),
                    ], [
                        'key' => 'formatted_total',
                        'label' => trans('dashboard::app.reporting.customers.index.total'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'orders',
                        'label' => trans('dashboard::app.reporting.customers.index.orders'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'reviews',
                        'label' => trans('dashboard::app.reporting.customers.index.reviews'),
                    ],
                ],
        ...
        if ($type == 'table') {
            return [
                'columns' => [
                    [
                        'key' => 'label',
                        'label' => trans('dashboard::app.reporting.products.index.interval'),
                    ], [
                        'key' => 'total',
                        'label' => trans('dashboard::app.reporting.products.index.quantities'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'total',
                        'label' => trans('dashboard::app.reporting.products.index.total'),
                    ],
                ],
        ...
        if ($type == 'table') {
            ...
            return [
                'columns' => [
                    [
                        'key' => 'id',
                        'label' => trans('dashboard::app.reporting.products.index.id'),
                    ], [
                        'key' => 'name',
                        'label' => trans('dashboard::app.reporting.products.index.name'),
                    ], [
                        'key' => 'formatted_price',
                        'label' => trans('dashboard::app.reporting.products.index.price'),
                    ], [
                        'key' => 'formatted_revenue',
                        'label' => trans('dashboard::app.reporting.products.index.revenue'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'reviews',
                        'label' => trans('dashboard::app.reporting.products.index.reviews'),
                    ],
                ],
            ...
            return [
                'columns' => [
                    [
                        ...
                        'key' => 'term',
                        'label' => trans('dashboard::app.reporting.products.index.search-term'),
                    ], [
                        'key' => 'results',
                        'label' => trans('dashboard::app.reporting.products.index.results'),
                    ], [
                        'key' => 'uses',
                        'label' => trans('dashboard::app.reporting.products.index.uses'),
                    ], [
                        'key' => 'channel_id',
                        'label' => trans('dashboard::app.reporting.products.index.channel'),
                    ], [
                        'key' => 'locale',
                        'label' => trans('dashboard::app.reporting.products.index.locale'),
                    ],
                ],
