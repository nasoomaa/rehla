...
namespace Rehla\Dashboard\Http\Controllers\Appearance;
...
class SectionController extends Controller
{
    ...
    public function index(string $code)
    {
        ...
        return view('dashboard::appearance.sections.index', [
            'scopedTheme' => $code,
    ...
    public function store(string $code)
    {
        ...
        return new JsonResponse([
            ...
            'message' => trans('dashboard::app.appearance.sections.create-success'),
        ]);
    }
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.appearance.sections.update-success'));
    ...
    public function destroy(int $id)
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.appearance.sections.delete-success'),
        ], 200);
    }
    ...
    public function publish(string $code): JsonResponse
    {
        ...
        return new JsonResponse([
            ...
            'sections' => $this->editableSections($code, $channel->id),
            'message' => trans('dashboard::app.appearance.sections.update-success'),
        ]);
    }
    ...
    public function discard(string $code): JsonResponse
    {
        ...
        return new JsonResponse([
            ...
            'sections' => $this->editableSections($code, $channel->id),
            'message' => trans('dashboard::app.appearance.sections.index.discarded'),
        ]);
    }
    ...
    {
        $prefix = 'dashboard::app.appearance.sections.create.type.';
    ...
    protected function sectionOrFail(int $id): Section
    {
        ...
        abort_unless($section, new JsonResponse([
            'message' => trans('dashboard::app.appearance.sections.index.gone'),
        ], 404));
    ...
    protected function guardSingleFooter(?string $type, ?string $themeCode, int $channelId, ?int $ignoreId = null): void
    {
        ...
        throw ValidationException::withMessages([
            'type' => trans('dashboard::app.appearance.sections.create.footer-links-exists'),
        ]);
    }
