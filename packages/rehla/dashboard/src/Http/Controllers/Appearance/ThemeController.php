...
class ThemeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::appearance.themes.index', compact('themes', 'channels'));
    }
    ...
    public function activate(string $code)
    {
        ...
        if (
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.appearance.themes.index.not-installed'),
            ], 404);
        }
        ...
        session()->flash('success', trans('dashboard::app.appearance.themes.index.activate-success', [
            'theme' => $theme['name'],
