...
namespace Rehla\Dashboard\Http\Controllers\CMS;
...
class PageController extends Controller
{
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('dashboard::app.cms.create-success'));
    ...
    public function update(int $id)
    {
        ...
        $this->validate(request(), [
            $locale.'.url_key' => ['required', new Slug, function ($attribute, $value, $fail) use ($id) {
                if (! $this->pageRepository->isUrlKeyUnique($id, $value)) {
                    $fail(trans('dashboard::app.cms.index.already-taken', ['name' => 'Page']));
                }
            }],
        ...
        session()->flash('success', trans('dashboard::app.cms.update-success'));
    ...
    public function delete(int $id): JsonResponse
    {
        try {
            ...
            return new JsonResponse(['message' => trans('dashboard::app.cms.delete-success')]);
        } catch (\Exception $e) {
            return new JsonResponse(['message' => trans('dashboard::app.cms.no-resource')]);
        }
    }
    ...
    public function massDelete(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.cms.index.datagrid.mass-delete-success'),
        ], 200);
    }
}
