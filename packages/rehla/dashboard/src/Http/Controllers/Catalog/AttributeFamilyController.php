...
class AttributeFamilyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::catalog.families.index');
    }
    ...
    public function create()
    {
        ...
        return view('dashboard::catalog.families.create', compact('attributeFamily', 'customAttributes'));
    }
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('dashboard::app.catalog.families.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('dashboard::catalog.families.edit', compact('attributeFamily', 'customAttributes'));
    }
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.catalog.families.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if ($attributeFamily->code === AttributeFamily::DEFAULT_CODE) {
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.families.default-delete-error'),
            ], 400);
        }

        if ($attributeFamily->products()->count()) {
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.families.attribute-product-error'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.families.delete-success'),
            ]);
        } catch (\Exception $e) {
            report($e);
        }
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.catalog.families.delete-failed', ['name' => 'dashboard::app.catalog.families.family']),
        ], 500);
    }
}
