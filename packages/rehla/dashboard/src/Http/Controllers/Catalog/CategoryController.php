...
class CategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('dashboard::catalog.categories.create', compact('categories', 'attributes'));
    }
    ...
    public function store(CategoryRequest $categoryRequest)
    {
        ...
        session()->flash('success', trans('dashboard::app.catalog.categories.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('dashboard::catalog.categories.edit', compact('category', 'categories', 'attributes'));
    }
    ...
    public function update(CategoryRequest $categoryRequest, int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.catalog.categories.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if (! $this->isCategoryDeletable($category)) {
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.categories.delete-category-root'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.categories.delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.categories.delete-failed'),
            ], 500);
        }
    }
        ...
        foreach ($categoryIds as $categoryId) {
            ...
            if (isset($category)) {
                if (! $this->isCategoryDeletable($category)) {
                    ...
                    return new JsonResponse(['message' => trans('dashboard::app.catalog.categories.delete-category-root')], 400);
                } else {
                    try {
                        $suppressFlash = true;
    ...
    public function massUpdate(MassUpdateRequest $massUpdateRequest)
    {
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.categories.update-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
