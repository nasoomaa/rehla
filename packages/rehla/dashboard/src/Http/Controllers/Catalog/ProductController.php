...
namespace Rehla\Dashboard\Http\Controllers\Catalog;
...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::catalog.products.index', compact('families'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard::catalog.products.create', compact('families', 'configurableFamily'));
    }
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('dashboard::app.catalog.products.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('dashboard::catalog.products.edit', compact('product'));
    }
    ...
    public function update(ProductForm $request, int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.catalog.products.update-success'));
    ...
    public function updateInventories(InventoryRequest $inventoryRequest, int $id)
    {
        ...
        return response()->json([
            'message' => trans('dashboard::app.catalog.products.saved-inventory-message'),
    ...
    public function copy(int $id)
    {
        ...
        return response()->json([
            'message' => trans('dashboard::app.catalog.products.product-copied'),
        ]);
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.products.delete-success'),
            ]);
        } catch (\Exception $e) {
            report($e);
        }
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.catalog.products.delete-failed'),
        ], 500);
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.catalog.products.index.datagrid.mass-delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
    ...
    public function massUpdate(MassUpdateRequest $massUpdateRequest): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.catalog.products.index.datagrid.mass-update-success'),
        ], 200);
    }
