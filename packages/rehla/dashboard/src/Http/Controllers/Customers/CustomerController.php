...
use Rehla\Dashboard\DataGrids\Customers\View\ReviewDataGrid;
...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::customers.customers.index', compact('channels', 'groups'));
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'data' => $customer,
            'message' => trans('dashboard::app.customers.customers.index.create.create-success'),
        ]);
    }
    ...
    public function update(int $id)
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.customers.customers.update-success'),
            'data' => [
    ...
    public function destroy(int $id)
    {
        ...
        if (! $customer) {
            return response()->json(['message' => trans('dashboard::app.customers.customers.delete-failed')], 400);
        }
        ...
        if (! $this->customerRepository->haveActiveOrders($customer)) {
            ...
            session()->flash('success', trans('dashboard::app.customers.customers.delete-success'));

            return redirect()->route('admin.customers.customers.index');
        }

        session()->flash('error', trans('dashboard::app.customers.customers.delete-pending-order-error'));
    ...
    public function loginAsCustomer(int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.customers.customers.index.login-message', ['customer_name' => $customer->name]));
    ...
    public function storeNotes(int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.customers.customers.view.note-created-success'));
    ...
    public function show(int $id)
    {
        ...
        return view('dashboard::customers.customers.view', compact('customer', 'groups'));
    }
    ...
    public function massUpdate(MassUpdateRequest $massUpdateRequest): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.customers.customers.index.datagrid.update-success'),
        ]);
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        try {
            ...
            foreach ($customers as $customer) {
                if ($this->customerRepository->haveActiveOrders($customer)) {
                    throw new \Exception(trans('dashboard::app.customers.customers.index.datagrid.order-pending'));
                }
            }
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.customers.customers.index.datagrid.delete-success'),
            ]);
