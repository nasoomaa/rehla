...
class CustomerGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::customers.groups.index');
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.customers.groups.index.create.success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.customers.groups.index.edit.success'),
        ]);
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if (! $customerGroup->is_user_defined) {
            return new JsonResponse([
                'message' => trans('dashboard::app.customers.groups.index.edit.group-default'),
            ], 400);
        }

        if ($customerGroup->customers->count()) {
            return new JsonResponse([
                'message' => trans('dashboard::app.customers.groups.customer-associate'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.customers.groups.index.edit.delete-success'),
            ]);
        } catch (\Exception $e) {
        }

        return new JsonResponse([
            'message' => trans('dashboard::app.customers.groups.index.edit.delete-failed'),
        ], 500);
    }
}
