...
namespace Rehla\Dashboard\Http\Controllers\DataGrid;

use Illuminate\Support\Facades\Event;
use Rehla\Dashboard\Http\Controllers\Controller;
use Rehla\DataGrid\Repositories\SavedFilterRepository;
...
class SavedFilterController extends Controller
{
    ...
    public function store()
    {
        ...
        return response()->json([
            'data' => $savedFilter,
            'message' => trans('dashboard::app.components.datagrid.toolbar.filter.saved-success'),
        ]);
    }
    ...
    public function update(int $id)
    {
        ...
        return response()->json([
            'data' => $updatedFilter,
            'message' => trans('dashboard::app.components.datagrid.toolbar.filter.updated-success'),
        ]);
    }
    ...
    public function destroy(int $id)
    {
        ...
        if (! $success) {
            return response()->json([
                'message' => trans('dashboard::app.components.datagrid.toolbar.filter.delete-error'),
            ]);
        }

        return response()->json([
            'message' => trans('dashboard::app.components.datagrid.toolbar.filter.delete-success'),
        ]);
    }
}
