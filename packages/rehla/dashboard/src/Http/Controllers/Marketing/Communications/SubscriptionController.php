...
class SubscriptionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::marketing.communications.subscribers.index');
    }
    ...
    public function update()
    {
        ...
        if ($result) {
            return response()->json([
                'message' => trans('dashboard::app.marketing.communications.subscribers.index.edit.success'),
            ], 200);
        }

        return response()->json([
            'message' => trans('dashboard::app.marketing.communications.subscribers.index.edit.update-failed'),
        ], 500);
    }
    ...
    public function destroy(int $id)
    {
        try {
            ...
            return response()->json([
                'message' => trans('dashboard::app.marketing.communications.subscribers.delete-success'),
            ], 200);
        } catch (\Exception $e) {
            report($e);
        }
        ...
        return response()->json([
            'message' => trans('dashboard::app.marketing.communications.subscribers.delete-failed'),
        ], 500);
    }
}
