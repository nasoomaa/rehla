...
namespace Rehla\Dashboard\Http\Controllers\Marketing\Promotions;
...
use Rehla\Dashboard\DataGrids\Marketing\Promotions\CartRuleDataGrid;
use Rehla\Dashboard\Http\Controllers\Controller;
use Rehla\Dashboard\Http\Requests\CartRuleRequest;
...
class CartRuleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::marketing.promotions.cart-rules.index');
    }
    ...
    {
        return view('dashboard::marketing.promotions.cart-rules.create');
    }
    ...
    public function copy(int $cartRuleId)
    {
        ...
        $copiedCartRule = $cartRule->replicate()->fill([
            'status' => 0,
            'name' => trans('dashboard::app.marketing.promotions.cart-rules.index.datagrid.copy-of', ['value' => $cartRule->name]),
        ]);
        ...
        return view('dashboard::marketing.promotions.cart-rules.edit', [
    ...
    public function store(CartRuleRequest $cartRuleRequest)
    {
        try {
            ...
            session()->flash('success', trans('dashboard::app.marketing.promotions.cart-rules.create.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('dashboard::marketing.promotions.cart-rules.edit', compact('cartRule'));
    }
    ...
    public function update(CartRuleRequest $cartRuleRequest, int $id)
    {
        try {
            ...
            session()->flash('success', trans('dashboard::app.marketing.promotions.cart-rules.edit.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.marketing.promotions.cart-rules.delete-success'
                )]);
        } catch (Exception $e) {
        }

        return new JsonResponse([
            'message' => trans('dashboard::app.marketing.promotions.cart-rules.delete-failed'
            )], 400);
    }
}
