...
use Rehla\Dashboard\DataGrids\Marketing\Promotions\CatalogRuleDataGrid;
use Rehla\Dashboard\Http\Controllers\Controller;
use Rehla\Dashboard\Http\Requests\CatalogRuleRequest;
...
class CatalogRuleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::marketing.promotions.catalog-rules.index');
    }
    ...
    {
        return view('dashboard::marketing.promotions.catalog-rules.create');
    }
    ...
    public function store(CatalogRuleRequest $catalogRuleRequest)
    {
        ...
        session()->flash('success', trans('dashboard::app.marketing.promotions.catalog-rules.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('dashboard::marketing.promotions.catalog-rules.edit', compact('catalogRule'));
    }
    ...
    public function update(CatalogRuleRequest $catalogRuleRequest, int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.marketing.promotions.catalog-rules.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.marketing.promotions.catalog-rules.delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
                'message' => trans('dashboard::app.marketing.promotions.catalog-rules.delete-failed'),
            ], 400);
        }
    }
}
