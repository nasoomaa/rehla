...
namespace Rehla\Dashboard\Http\Controllers\Marketing\SearchSEO;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use Illuminate\View\View;
use Rehla\Dashboard\DataGrids\Marketing\SearchSEO\SearchSynonymDataGrid;
...
class SearchSynonymController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::marketing.search-seo.search-synonyms.index');
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.create.success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.edit.success'),
        ]);
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'message' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.edit.delete-success'),
            ], 200);
        } catch (\Exception $e) {
        }

        return response()->json([
            'message' => trans('dashboard::app.marketing.search-seo.search-synonyms.delete-failed'),
        ], 500);
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.marketing.search-seo.search-synonyms.index.datagrid.mass-delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
