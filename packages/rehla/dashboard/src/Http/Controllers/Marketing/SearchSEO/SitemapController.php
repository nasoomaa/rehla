...
use Rehla\Dashboard\DataGrids\Marketing\SearchSEO\SitemapDataGrid;
...
class SitemapController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::marketing.search-seo.sitemaps.index');
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.marketing.search-seo.sitemaps.index.create.success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.marketing.search-seo.sitemaps.index.edit.success'),
        ]);
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.marketing.search-seo.sitemaps.index.edit.delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
                'message' => trans('dashboard::app.marketing.search-seo.sitemaps.delete-failed', ['name' => 'dashboard::app.marketing.search-seo.sitemaps.index.sitemap']),
            ], 500);
        }
    }
}
