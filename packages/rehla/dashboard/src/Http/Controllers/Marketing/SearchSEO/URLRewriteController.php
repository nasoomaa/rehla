...
use Rehla\Dashboard\DataGrids\Marketing\SearchSEO\URLRewriteDataGrid;
...
class URLRewriteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::marketing.search-seo.url-rewrites.index');
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.marketing.search-seo.url-rewrites.index.create.success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.marketing.search-seo.url-rewrites.index.edit.success'),
        ]);
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'message' => trans('dashboard::app.marketing.search-seo.url-rewrites.index.edit.delete-success'),
            ], 200);
        } catch (\Exception $e) {
        }

        return response()->json([
            'message' => trans('dashboard::app.marketing.search-seo.url-rewrites.delete-failed'),
        ], 500);
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.marketing.search-seo.url-rewrites.index.datagrid.mass-delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
