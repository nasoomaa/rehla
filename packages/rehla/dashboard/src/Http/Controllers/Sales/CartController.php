...
use Rehla\Dashboard\Http\Requests\CartAddressRequest;
...
class CartController extends Controller
{
    ...
    public function storeItem(int $cartId): JsonResource
    {
        ...
        try {
            ...
            return new JsonResource([
                ...
                'message' => trans('dashboard::app.sales.orders.create.cart.success-add-to-cart'),
            ]);
        } catch (\Exception $exception) {
            return new JsonResource([
                'message' => $exception->getMessage(),
    ...
    public function destroyItem(int $cartId): JsonResource
    {
        ...
        return new JsonResource([
            'data' => new CartResource(Cart::getCart()),
            'message' => trans('dashboard::app.sales.orders.create.cart.success-remove'),
        ]);
    }
    ...
    public function updateItem(int $cartId): JsonResource
    {
        ...
        try {
            ...
            return new JsonResource([
                'data' => new CartResource(Cart::getCart()),
                'message' => trans('dashboard::app.sales.orders.create.cart.success-update'),
            ]);
        } catch (\Exception $exception) {
            return new JsonResource([
                'message' => $exception->getMessage(),
    ...
    public function storeCoupon(int $id)
    {
        ...
        try {
            ...
            if (! $coupon) {
                return (new JsonResource([
                    'data' => new CartResource(Cart::getCart()),
                    'message' => trans('dashboard::app.sales.orders.create.coupon-not-found'),
            ...
            if ($coupon->cart_rule->status) {
                if (Cart::getCart()->coupon_code == $coupon->code) {
                    return (new JsonResource([
                        'data' => new CartResource(Cart::getCart()),
                        'message' => trans('dashboard::app.sales.orders.create.coupon-already-applied'),
                ...
                if (Cart::getCart()->coupon_code == $coupon->code) {
                    return new JsonResource([
                        'data' => new CartResource(Cart::getCart()),
                        'message' => trans('dashboard::app.sales.orders.create.coupon-applied'),
                    ]);
                }
            }
            ...
            return (new JsonResource([
                'data' => new CartResource(Cart::getCart()),
                'message' => trans('dashboard::app.sales.orders.create.coupon-error'),
    ...
    public function destroyCoupon(int $id): JsonResource
    {
        ...
        return new JsonResource([
            'data' => new CartResource(Cart::getCart()),
            'message' => trans('dashboard::app.sales.orders.create.coupon-remove'),
        ]);
    }
}
