...
use Rehla\Dashboard\DataGrids\Sales\EUWithdrawalDataGrid;
...
class EUWithdrawalController extends Controller
{
    ...
    public function index(): View|JsonResponse
    {
        ...
        return view('dashboard::sales.eu-withdrawals.index');
    }
    ...
    public function view(int $id): View
    {
        ...
        return view('dashboard::sales.eu-withdrawals.view', compact('withdrawal'));
    }
    ...
    public function decline(int $id): RedirectResponse
    {
        ...
        session()->flash('success', trans('dashboard::app.eu_withdrawal.flash.declined'));
    ...
    public function markRefunded(int $id): RedirectResponse
    {
        ...
        session()->flash('success', trans('dashboard::app.eu_withdrawal.flash.refunded'));
    ...
    public function resendConfirmation(int $id): RedirectResponse
    {
        ...
        try {
            ...
            session()->flash('success', trans('dashboard::app.eu_withdrawal.flash.confirmation_resent'));
        } catch (\Throwable $e) {
            $withdrawal->update([
                'confirmation_error' => mb_substr($e->getMessage(), 0, 500),
            ]);

            session()->flash('error', trans('dashboard::app.eu_withdrawal.flash.confirmation_failed'));
        }
