...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::sales.invoices.index');
    }
    ...
    public function create(int $orderId)
    {
        ...
        return view('dashboard::sales.invoices.create', compact('order'));
    }
    ...
    public function store(int $orderId)
    {
        ...
        if (! $order->canInvoice()) {
            session()->flash('error', trans('dashboard::app.sales.invoices.create.creation-error'));
        ...
        if (! $this->invoiceRepository->haveProductToInvoice(request()->all())) {
            session()->flash('error', trans('dashboard::app.sales.invoices.create.product-error'));

            return redirect()->back();
        }

        if (! $this->invoiceRepository->isValidQuantity(request()->all())) {
            session()->flash('error', trans('dashboard::app.sales.invoices.create.invalid-qty'));
        ...
        session()->flash('success', trans('dashboard::app.sales.invoices.create.create-success'));
    ...
    public function view(int $id)
    {
        ...
        return view('dashboard::sales.invoices.view', compact('invoice'));
    }
    ...
    public function sendDuplicateEmail(Request $request, int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.sales.invoices.view.invoice-sent'));
    ...
    public function massUpdateState(MassUpdateRequest $massUpdateRequest)
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.sales.invoices.index.datagrid.mass-update-success'),
        ], 200);
    }
}
