...
use Rehla\Dashboard\DataGrids\Sales\RMA\RulesDataGrid;
...
class RulesController extends Controller
{
    ...
    public function index(): View|JsonResponse
    {
        ...
        return view('dashboard::sales.rma.rules.index');
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.sales.rma.rules.create.success'),
        ]);
    }
    ...
    public function update(int $id): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.sales.rma.rules.edit.success'),
        ]);
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.sales.rma.rules.index.datagrid.delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
                'message' => trans('dashboard::app.sales.rma.rules.index.datagrid.reason-error'),
            ], 500);
        }
    }
    ...
    public function massUpdate(MassUpdateRequest $request): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.sales.rma.rules.edit.mass-update-success'),
        ]);
    }
    ...
    public function massDestroy(MassDestroyRequest $request): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => $skipped
                ? trans('dashboard::app.sales.rma.rules.index.datagrid.mass-delete-partial', [
                    'deleted' => $existingIds->count(),
                    'skipped' => $skipped,
                ])
                : trans('dashboard::app.sales.rma.rules.index.datagrid.mass-delete-success'),
        ]);
    }
}
