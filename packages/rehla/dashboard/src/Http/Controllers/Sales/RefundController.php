...
use Rehla\Dashboard\DataGrids\Sales\OrderRefundDataGrid;
...
class RefundController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::sales.refunds.index');
    }
    ...
    public function create(int $orderId)
    {
        ...
        return view('dashboard::sales.refunds.create', compact('order'));
    }
    ...
    public function store(int $orderId)
    {
        ...
        try {
            ...
            if (! $totals) {
                throw new InvalidRefundQuantityException(trans('dashboard::app.sales.refunds.create.invalid-qty'));
            }
        ...
        if (! $refundAmount) {
            session()->flash('error', trans('dashboard::app.sales.refunds.create.invalid-refund-amount-error'));

            return redirect()->back();
        }

        if ($refundAmount > $maxRefundAmount) {
            session()->flash('error', trans('dashboard::app.sales.refunds.create.refund-limit-error', [
        ...
        session()->flash('success', trans('dashboard::app.sales.refunds.create.create-success'));
    ...
    public function view($id)
    {
        ...
        return view('dashboard::sales.refunds.view', compact('refund'));
    }
}
