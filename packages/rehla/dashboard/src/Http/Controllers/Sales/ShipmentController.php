...
use Rehla\Dashboard\DataGrids\Sales\OrderShipmentDataGrid;
...
class ShipmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::sales.shipments.index');
    }
    ...
    public function create(int $orderId)
    {
        ...
        if (! $order->channel || ! $order->canShip()) {
            session()->flash('error', trans('dashboard::app.sales.shipments.create.creation-error'));

            return redirect()->back();
        }

        return view('dashboard::sales.shipments.create', compact('order'));
    }
    ...
    public function store(int $orderId)
    {
        ...
        if (! $order->canShip()) {
            session()->flash('error', trans('dashboard::app.sales.shipments.create.order-error'));
        ...
        if (! $this->isInventoryValidate($data)) {
            session()->flash('error', trans('dashboard::app.sales.shipments.create.quantity-invalid'));
        ...
        session()->flash('success', trans('dashboard::app.sales.shipments.create.success'));
    ...
    public function view(int $id)
    {
        ...
        return view('dashboard::sales.shipments.view', compact('shipment'));
    }
}
