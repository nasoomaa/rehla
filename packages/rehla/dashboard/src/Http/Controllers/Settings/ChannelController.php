...
class ChannelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::settings.channels.index');
    }
    ...
    {
        return view('dashboard::settings.channels.create');
    }
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('dashboard::app.settings.channels.create.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('dashboard::settings.channels.edit', compact('channel'));
    }
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.settings.channels.edit.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if ($channel->code == config('app.channel')) {
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.channels.index.last-delete-error'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.channels.index.delete-success'),
            ], 200);
        } catch (\Exception $e) {
        }

        return new JsonResponse([
            'message' => trans('dashboard::app.settings.channels.index.delete-failed'),
        ], 500);
    }
