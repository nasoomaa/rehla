...
class CurrencyController extends Controller
{
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.currencies.index.create-success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.currencies.index.update-success'),
        ]);
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if ($this->currencyRepository->count() == 1) {
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.currencies.index.last-delete-error'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.currencies.index.delete-success'),
            ], 200);
        } catch (\Exception $e) {
            report($e);

            return new JsonResponse([
                'message' => trans('dashboard::app.settings.currencies.index.delete-failed'),
            ], 500);
        }
    }
}
