...
namespace Rehla\Dashboard\Http\Controllers\Settings\DataTransfer;
...
use Rehla\Dashboard\DataGrids\Settings\DataTransfer\ImportDataGrid;
...
class ImportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::settings.data-transfer.imports.index');
    }
    ...
    {
        return view('dashboard::settings.data-transfer.imports.create', [
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('dashboard::app.settings.data-transfer.imports.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('dashboard::settings.data-transfer.imports.edit', [
            'import' => $import,
            'supportedFormats' => $this->supportedFormats,
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.settings.data-transfer.imports.update-success'));
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.data-transfer.imports.delete-success'),
            ]);
        } catch (\Exception $e) {
        }

        return response()->json([
            'message' => trans('dashboard::app.settings.data-transfer.imports.delete-failed'),
        ], 500);
    }
    ...
    public function import(int $id)
    {
        ...
        return view('dashboard::settings.data-transfer.imports.import', compact(
            'import',
            'isValid',
            'stats',
            'hasImagePhase',
    ...
    public function start(int $id): JsonResponse
    {
        ...
        if (! $import->processed_rows_count) {
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.data-transfer.imports.nothing-to-import'),
            ], 400);
        }
        ...
        if (! $this->importHelper->isValid()) {
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.data-transfer.imports.not-valid'),
            ], 400);
        }
        ...
        if (
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.data-transfer.imports.setup-queue-error'),
            ], 400);
        }
        ...
        if ($import->process_in_queue) {
            try {
                ...
                return new JsonResponse([
                    'message' => trans('dashboard::app.settings.data-transfer.imports.processing-failed'),
                ], 400);
            }
