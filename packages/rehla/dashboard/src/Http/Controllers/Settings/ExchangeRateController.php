...
class ExchangeRateController extends Controller
{
    ...
    public function index(): View|JsonResponse
    {
        ...
        return view('dashboard::settings.exchange-rates.index', compact('currencies'));
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.exchange-rates.index.create-success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.exchange-rates.index.update-success'),
        ]);
    }
    ...
    public function updateRates()
    {
        try {
            ...
            session()->flash('success', trans('dashboard::app.settings.exchange-rates.index.update-success'));
        } catch (\Exception $e) {
    ...
    public function destroy(int $id): JsonResponse
    {
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.exchange-rates.index.delete-success'),
            ], 200);
        } catch (\Exception $e) {
            report($e);
        }
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.exchange-rates.index.delete-error'),
        ], 500);
    }
}
