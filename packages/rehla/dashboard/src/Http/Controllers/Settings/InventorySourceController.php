...
namespace Rehla\Dashboard\Http\Controllers\Settings;

use Illuminate\Http\JsonResponse;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\Event;
use Illuminate\View\View;
use Rehla\Dashboard\DataGrids\Settings\InventorySourcesDataGrid;
use Rehla\Dashboard\Http\Controllers\Controller;
use Rehla\Dashboard\Http\Requests\InventorySourceRequest;
...
class InventorySourceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::settings.inventory-sources.index');
    }
    ...
    {
        return view('dashboard::settings.inventory-sources.create');
    }
    ...
    public function store(InventorySourceRequest $inventorySourceRequest)
    {
        ...
        session()->flash('success', trans('dashboard::app.settings.inventory-sources.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('dashboard::settings.inventory-sources.edit', compact('inventorySource'));
    }
    ...
    public function update(InventorySourceRequest $inventorySourceRequest, int $id)
    {
        ...
        session()->flash('success', trans('dashboard::app.settings.inventory-sources.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if ($this->inventorySourceRepository->count() == 1) {
            return response()->json(['message' => trans('dashboard::app.settings.inventory-sources.last-delete-error')], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.inventory-sources.delete-success'),
            ]);
        } catch (\Exception $e) {
            report($e);
        }
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.inventory-sources.delete-failed', ['name' => 'dashboard::app.settings.inventory_sources.index.title']),
        ], 500);
    }
}
