...
class LocaleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::settings.locales.index');
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.locales.index.create-success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.locales.index.update-success'),
        ]);
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        if ($locale->count() == 1) {
            return response()->json([
                'message' => trans('dashboard::app.settings.locales.index.last-delete-error'),
            ], 400);
        }
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.locales.index.delete-success'),
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'message' => trans('dashboard::app.settings.locales.index.delete-failed'),
            ], 500);
        }
    }
}
