...
use Rehla\Dashboard\DataGrids\Settings\TaxCategoryDataGrid;
use Rehla\Dashboard\Http\Controllers\Controller;
use Rehla\Dashboard\Http\Resources\TaxCategoryResource;
...
class TaxCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard::settings.taxes.categories.index')->with('taxRates', $this->taxRateRepository->all());
    }
    ...
    public function store(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.taxes.categories.index.create-success'),
        ]);
    }
    ...
    public function update(): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('dashboard::app.settings.taxes.categories.index.update-success'),
        ]);
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        try {
            ...
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.taxes.categories.index.delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
                'message' => trans('dashboard::app.settings.taxes.categories.index.delete-failed'),
            ], 500);
        }
    }
}
