...
namespace Rehla\Dashboard\Http\Controllers\User;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Mail;
use Rehla\Dashboard\Http\Controllers\Controller;
use Rehla\Dashboard\Mail\Admin\BackupCodesNotification;
...
class TwoFactorController extends Controller
{
        ...
        try {
            ...
            if (! $admin) {
                return response()->json([
                    'message' => trans('dashboard::app.errors.401.title'),
                ], 401);
            }
    ...
    public function enable(Request $request)
    {
        ...
        if (! $isValidCode) {
            return response()->json([
                'errors' => [
                    'code' => [trans('dashboard::app.account.messages.invalid-code')],
                ],
            ], 422);
        }
        ...
        return response()->json([
            'message' => trans('dashboard::app.account.messages.enabled-success'),
    ...
    public function disable()
    {
        ...
        $message = trans('dashboard::app.account.messages.disabled-success');
    ...
    {
        return view('dashboard::account.verify');
    }
    ...
    protected function handleSuccessfulVerification()
    {
        ...
        return redirect()->intended(route('admin.dashboard.index'))
            ->with('success', trans('dashboard::app.account.messages.verified-success'));
    }
}
