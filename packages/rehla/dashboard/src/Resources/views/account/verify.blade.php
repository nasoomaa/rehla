<x-dashboard::layouts.anonymous>
    <x-slot:title>
        @lang('dashboard::app.users.verify.title')
    </x-slot>
            ...
            <div class="box-shadow w-full overflow-hidden rounded-xl bg-white dark:bg-gray-900">
                ...
                <div class="flex flex-col items-center gap-2 px-8 pt-8 text-center">
                    ...
                    <p class="text-sm leading-relaxed text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.users.verify.enter-code')
                    </p>
                </div>
                ...
                >
                    <div class="px-8 py-6">
                        <x-dashboard::form.control-group>
                            <x-dashboard::form.control-group.label class="required !text-xs !font-semibold !uppercase !tracking-wide !text-gray-500 dark:!text-gray-300">
                                @lang('dashboard::app.users.verify.code-label')
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                autofocus
                                :label="trans('dashboard::app.users.verify.code-label')"
                                :placeholder="trans('dashboard::app.users.verify.code-placeholder')"
                            />
                        ...
                        <button
                            ...
                            aria-label="@lang('dashboard::app.users.verify.verify-code')"
                        >
                            @lang('dashboard::app.users.verify.verify-code')
                        </button>
                    </div>
                </x-dashboard::form>
                ...
                <div class="border-t px-8 py-4 text-center dark:border-gray-800">
                    ...
                    >
                        @lang('dashboard::app.users.verify.back')
                    </button>
                </div>
            </div>
