<x-dashboard::layouts>
    ...
    {!! view_render_event('rehla.dashboard.appearance.sections.index.before') !!}

    <x-dashboard::appearance.sections.editor
        :sections="$sections"
    ...
    {!! view_render_event('rehla.dashboard.appearance.sections.index.after') !!}
</x-dashboard::layouts>
