<x-dashboard::layouts>
    ...
    {!! view_render_event('rehla.dashboard.appearance.themes.index.before') !!}
    ...
    <div class="grid gap-1.5">
        ...
        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
            @lang('dashboard::app.appearance.themes.index.info')
        </p>
    </div>

    {!! view_render_event('rehla.dashboard.appearance.themes.list.before') !!}

    <v-appearance-themes
        :themes='@json($themes)'
        :channels='@json($channels->map(fn ($channel) => ['id' => $channel->id, 'name' => $channel->name])->values())'
    >
        <x-dashboard::shimmer.image class="mt-8 h-[300px] w-full rounded" />
    </v-appearance-themes>

    {!! view_render_event('rehla.dashboard.appearance.themes.list.after') !!}

    {!! view_render_event('rehla.dashboard.appearance.themes.index.after') !!}
                    ...
                    <div class="mt-4 grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6">
                        ...
                        >
                            ...
                            <div class="relative flex h-[190px] items-center justify-center bg-gray-100 dark:bg-gray-950">
                                ...
                                >
                                    @lang('dashboard::app.appearance.themes.index.active')
                                </span>
                            </div>
                            ...
                            <div class="flex flex-1 flex-col gap-2 p-4">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-300">
                                    <template v-if="theme.author">
                                        @lang('dashboard::app.appearance.themes.index.by') @{{ theme.author }}
                                    </template>
                                ...
                                >
                                    @lang('dashboard::app.appearance.themes.index.active-on-all')
                                </p>
                                ...
                                >
                                    @lang('dashboard::app.appearance.themes.index.active-on')
                                ...
                                >
                                    @lang('dashboard::app.appearance.themes.index.not-in-use')
                                </p>
                                ...
                                <div class="mt-auto flex w-full flex-wrap items-center gap-2 pt-3">
                                    @if (bouncer()->hasPermission('appearance.themes.activate'))
                                        ...
                                        >
                                            @lang('dashboard::app.appearance.themes.index.activate-btn')
                                        </button>
                                    @endif
                                    ...
                                    >
                                        @lang('dashboard::app.appearance.themes.index.buy-btn')
                                    </a>
                                    ...
                                    >
                                        @lang('dashboard::app.appearance.themes.index.preview-btn')
                                    </a>
                                    ...
                                    >
                                        @lang('dashboard::app.appearance.themes.index.customize-btn')
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <Teleport to="body">
                    ...
                    >
                        <form @submit="handleSubmit($event, activate)">
                            <x-dashboard::modal ref="activateModal">
                                <x-slot:header>
                                    <p class="text-lg font-bold text-gray-800 dark:text-white">
                                        @lang('dashboard::app.appearance.themes.index.activate.title')
                                    </p>
                                </x-slot>

                                <x-slot:content>
                                    <p class="mb-4 text-sm text-gray-600 dark:text-gray-300">
                                        @lang('dashboard::app.appearance.themes.index.activate.info', ['theme' => '@{{ selected.name }}'])
                                    </p>

                                    <!-- Channels -->
                                    <x-dashboard::form.control-group>
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.appearance.themes.index.activate.channels')
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            rules="required"
                                            v-model="channelIds"
                                            :label="trans('dashboard::app.appearance.themes.index.activate.channels')"
                                            @change="loadImpact"
                                        >
                                            <option
                                        ...
                                        <x-dashboard::form.control-group.error control-name="channel_ids" />

                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">
                                            @lang('dashboard::app.appearance.themes.index.activate.channels-hint')
                                        </p>
                                    </x-dashboard::form.control-group>
                                    ...
                                    >
                                        <p
                                            ...
                                            :key="row.channel_id"
                                        >
                                            @lang('dashboard::app.appearance.themes.index.activate.warning', [
                                                'channel' => '@{{ row.channel }}',
                                ...
                                <x-slot:footer>
                                    <x-dashboard::button
                                        button-type="submit"
                                        class="primary-button"
                                        :title="trans('dashboard::app.appearance.themes.index.activate.confirm-btn')"
                                        ::loading="isLoading"
                                        ::disabled="isLoading"
                                    />
                                </x-slot>
                ...
                computed: {
                    ...
                    groups() {
                        return [
                            {
                                key: 'installed',
                                label: "@lang('dashboard::app.appearance.themes.index.my-themes')",
                                themes: this.themes.filter(theme => theme.is_installed),
                            }, {
                                key: 'available',
                                label: "@lang('dashboard::app.appearance.themes.index.buy-themes')",
                                themes: this.themes.filter(theme => ! theme.is_installed),
                            },
