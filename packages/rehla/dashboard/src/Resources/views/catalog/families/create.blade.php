<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.catalog.families.create.title')
    </x-slot>

    <!-- Input Form -->
    <x-dashboard::form :action="route('admin.catalog.families.store')">

        {!! view_render_event('rehla.dashboard.catalog.families.create.create_form_controls.before') !!}
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('dashboard::app.catalog.families.create.back-btn')
                </a>
                ...
                >
                    @lang('dashboard::app.catalog.families.create.save-btn')
                </button>
            </div>
        </div>
                ...
                <x-dashboard::accordion>
                    ...
                    <x-slot:header>
                        <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('dashboard::app.catalog.families.create.general')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-dashboard::form.control-group>
                            <x-dashboard::form.control-group.label class="required !text-gray-800 dark:!text-white">
                                @lang('dashboard::app.catalog.families.create.code')
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                :placeholder="trans('dashboard::app.catalog.families.create.enter-code')"
                            />
                        ...
                        <x-dashboard::form.control-group class="!mb-0">
                            <x-dashboard::form.control-group.label class="required !text-gray-800 dark:!text-white">
                                @lang('dashboard::app.catalog.families.create.name')
                            </x-dashboard::form.control-group.label>
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                :placeholder="trans('dashboard::app.catalog.families.create.enter-name')"
                            />
        ...
        {!! view_render_event('rehla.dashboard.catalog.families.create.create_form_controls.after') !!}
            ...
            <div>
                ...
                <div class="mb-2.5 flex flex-wrap justify-between gap-2.5 p-4">
                    ...
                    <div class="flex flex-col gap-2">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('dashboard::app.catalog.families.create.groups')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('dashboard::app.catalog.families.create.groups-info')
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-x-1">
                        ...
                        <div
                            ...
                            @click="deleteGroup"
                        >
                            @lang('dashboard::app.catalog.families.create.delete-group-btn')
                        </div>
                        ...
                        >
                            @lang('dashboard::app.catalog.families.create.add-group-btn')
                        </div>
                    </div>
                </div>
                ...
                <div class="flex [&>*]:flex-1 gap-5 justify-between px-4">
                    ...
                    <div v-for="(groups, column) in columnGroups">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600 dark:text-gray-300">
                                @{{
                                    column == 1
                                    ? "@lang('dashboard::app.catalog.families.create.main-column')"
                                    : "@lang('dashboard::app.catalog.families.create.right-column')"
                                }}
                            </p>
                            
                            <p class="text-xs font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.catalog.families.create.edit-group-info')
                            </p>
                        </div>
                    ...
                    <div class="">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.catalog.families.create.unassigned-attributes')
                            </p>

                            <p class="text-xs font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.catalog.families.create.unassigned-attributes-info')
                            </p>
                        </div>
                        ...
                        <x-dashboard::modal ref="addGroupModal">
                            ...
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    @lang('dashboard::app.catalog.families.create.add-group-title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                ...
                                <x-dashboard::form.control-group>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('dashboard::app.catalog.families.create.code')"
                                        :placeholder="trans('dashboard::app.catalog.families.create.code')"
                                    />
                                ...
                                <x-dashboard::form.control-group>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('dashboard::app.catalog.families.create.name')"
                                        :placeholder="trans('dashboard::app.catalog.families.create.name')"
                                    />
                                ...
                                <x-dashboard::form.control-group class="mb-4">
                                    <x-dashboard::form.control-group.label class="required font-medium !text-gray-800">
                                        @lang('dashboard::app.catalog.families.create.column')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        name="column"
                                        rules="required"
                                        :label="trans('dashboard::app.catalog.families.create.column')"
                                    >
                                        <!-- Default Option -->
                                        <option value="">
                            ...
                            <x-slot:footer>
                                ...
                                <x-dashboard::button
                                    button-type="button"
                                    class="primary-button"
                                    :title="trans('dashboard::app.catalog.families.create.add-group-btn')"
                                />
                            </x-slot>
                        </x-dashboard::modal>
                    </form>
        ...
        <script type="module">
            app.component('v-family-attributes', {
                ...
                methods: {
                    ...
                    addGroup(params, { resetForm, setErrors }) {
                        ...
                        if (isGroupCodeAlreadyExists || isGroupCodeAlreadyExists) {
                            if (isGroupCodeAlreadyExists) {
                                setErrors({'code': ["@lang('dashboard::app.catalog.families.create.group-code-already-exists')"]});
                            }

                            if (isGroupNameAlreadyExists) {
                                setErrors({'name': ["@lang('dashboard::app.catalog.families.create.group-name-already-exists')"]});
                            }
                    ...
                    deleteGroup() {
                        if (! this.selectedGroup.id) {
                            this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('dashboard::app.catalog.families.create.select-group')" });

                            return;
                        }

                        if (this.isGroupContainsSystemAttributes(this.selectedGroup)) {
                            this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('dashboard::app.catalog.families.create.group-contains-system-attributes')" });
