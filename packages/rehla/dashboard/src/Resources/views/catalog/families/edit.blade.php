<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.catalog.families.edit.title')
    </x-slot>
    ...
    >
        ...
        {!! view_render_event('rehla.dashboard.catalog.families.edit.edit_form_control.before', ['attributeFamily' => $attributeFamily]) !!}
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('dashboard::app.catalog.families.edit.back-btn')
                </a>
                ...
                >
                    @lang('dashboard::app.catalog.families.edit.save-btn')
                </button>
            </div>
        </div>
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            {!! view_render_event('rehla.dashboard.catalog.families.edit.card.attributes-panel.before', ['attributeFamily' => $attributeFamily]) !!}

            <div class="box-shadow flex flex-1 flex-col gap-2 rounded bg-white dark:bg-gray-900 max-xl:flex-auto">
                <v-family-attributes>
                    <x-dashboard::shimmer.catalog.families.attributes-panel />
                </v-family-attributes>
            </div>

            {!! view_render_event('rehla.dashboard.catalog.families.edit.card.attributes-panel.after', ['attributeFamily' => $attributeFamily]) !!}

            {!! view_render_event('rehla.dashboard.catalog.families.edit.card.accordion.general.before', ['attributeFamily' => $attributeFamily]) !!}
                ...
                <x-dashboard::accordion>
                    ...
                    <x-slot:header>
                        <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('dashboard::app.catalog.families.edit.general')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        <x-dashboard::form.control-group>
                            <x-dashboard::form.control-group.label class="!text-gray-800 dark:!text-white">
                                @lang('dashboard::app.catalog.families.edit.code')
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                disabled="disabled"
                                :label="trans('dashboard::app.catalog.families.create.code')"
                                :placeholder="trans('dashboard::app.catalog.families.edit.enter-code')"
                            />
                        ...
                        <x-dashboard::form.control-group class="!mb-0">
                            <x-dashboard::form.control-group.label class="!text-gray-800 dark:!text-white">
                                @lang('dashboard::app.catalog.families.edit.name')
                            </x-dashboard::form.control-group.label>
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                :label="trans('dashboard::app.catalog.families.create.name')"
                                :placeholder="trans('dashboard::app.catalog.families.edit.enter-name')"
                            />
            ...
            {!! view_render_event('rehla.dashboard.catalog.families.edit.card.accordion.general.after', ['attributeFamily' => $attributeFamily]) !!}
        </div>

        {!! view_render_event('rehla.dashboard.catalog.families.edit.edit_form_control.after', ['attributeFamily' => $attributeFamily]) !!}
            ...
            <div class="">
                ...
                <div class="mb-2.5 flex flex-wrap justify-between gap-2.5 p-4">
                    ...
                    <div class="flex flex-col gap-2">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('dashboard::app.catalog.families.edit.groups')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('dashboard::app.catalog.families.edit.groups-info')
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-x-1">
                        ...
                        <div
                            ...
                            @click="deleteGroup"
                        >
                            @lang('dashboard::app.catalog.families.edit.delete-group-btn')
                        </div>
                        ...
                        >
                            @lang('dashboard::app.catalog.families.edit.add-group-btn')
                        </div>
                    </div>
                </div>
                ...
                <div class="flex [&>*]:flex-1 gap-5 justify-between px-4">
                    ...
                    <div v-for="(groups, column) in columnGroups">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600 dark:text-gray-300">
                                @{{
                                    column == 1
                                    ? "@lang('dashboard::app.catalog.families.edit.main-column')"
                                    : "@lang('dashboard::app.catalog.families.edit.right-column')"
                                }}
                            </p>
                            
                            <p class="text-xs font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.catalog.families.edit.edit-group-info')
                            </p>
                        </div>
                    ...
                    <div class="">
                        ...
                        <div class="mb-4 flex flex-col">
                            <p class="font-semibold leading-6 text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.catalog.families.edit.unassigned-attributes')
                            </p>

                            <p class="text-xs font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.catalog.families.edit.unassigned-attributes-info')
                            </p>
                        </div>
                ...
                >
                    <form @submit="handleSubmit($event, addGroup)">
                        <x-dashboard::modal ref="addGroupModal">
                            <!-- Modal Header -->
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    @lang('dashboard::app.catalog.families.edit.add-group-title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                <x-dashboard::form.control-group>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        name="code"
                                        rules="required"
                                        :label="trans('dashboard::app.catalog.families.edit.code')"
                                        :placeholder="trans('dashboard::app.catalog.families.edit.code')"
                                    />
                                ...
                                <x-dashboard::form.control-group>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        name="name"
                                        rules="required"
                                        :label="trans('dashboard::app.catalog.families.edit.name')"
                                        :placeholder="trans('dashboard::app.catalog.families.edit.name')"
                                    />
                                ...
                                <x-dashboard::form.control-group class="mb-4">
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.catalog.families.edit.column')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        name="column"
                                        rules="required"
                                        :label="trans('dashboard::app.catalog.families.edit.column')"
                                    >
                                        <!-- Default Option -->
                                        <option value="">
                                            @lang('dashboard::app.catalog.families.create.select-group')
                                        </option>
                                    ...
                                    <x-dashboard::form.control-group.error control-name="column" />
                                </x-dashboard::form.control-group>
                            </x-slot>
                            ...
                            <x-slot:footer>
                                ...
                                <x-dashboard::button
                                    button-type="button"
                                    class="primary-button"
                                    :title="trans('dashboard::app.catalog.families.edit.add-group-btn')"
                                />
                            </x-slot>
                        </x-dashboard::modal>
                    </form>
                ...
                methods: {
                    ...
                    onEnd: function(e) {
                        if (this.dropReverted) {
                            this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('dashboard::app.catalog.families.create.removal-not-possible')" });
                        }
                    },
                    ...
                    addGroup(params, { resetForm, setErrors }) {
                        ...
                        if (isGroupCodeAlreadyExists || isGroupCodeAlreadyExists) {
                            if (isGroupCodeAlreadyExists) {
                                setErrors({'code': ["@lang('dashboard::app.catalog.families.edit.group-code-already-exists')"]});
                            }

                            if (isGroupNameAlreadyExists) {
                                setErrors({'name': ["@lang('dashboard::app.catalog.families.edit.group-name-already-exists')"]});
                            }
                    ...
                    deleteGroup() {
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                if (! this.selectedGroup.id) {
                                    this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('dashboard::app.catalog.families.edit.select-group')" });

                                    return;
                                }

                                if (this.isGroupContainsSystemAttributes(this.selectedGroup)) {
                                    this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('dashboard::app.catalog.families.edit.group-contains-system-attributes')" });
