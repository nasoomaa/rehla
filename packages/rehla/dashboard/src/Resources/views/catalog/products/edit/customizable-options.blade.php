@if ($product->getTypeInstance()->isCustomizable())
    ...
    {!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.simple.customizable-options.before', ['product' => $product]) !!}

    <v-customizable-options :errors="errors"></v-customizable-options>

    {!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.simple.customizable-options.after', ['product' => $product]) !!}
    ...
    @pushOnce('scripts')
            ...
            <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
                    ...
                    <div class="flex justify-between gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            <p class="text-base font-semibold text-gray-800 dark:text-white">
                                @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.title')
                            </p>

                            <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                                @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.info')
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-x-1">
                            ...
                            >
                                @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.add-btn')
                            </div>
                        </div>
                    </div>

                    <!-- Backend Validations -->
                    <x-dashboard::form.control-group.error control-name="customizable_options" />
                </div>
                                ...
                                >
                                    ...
                                    <div class="grid place-content-start gap-1 ltr:text-right rtl:text-left">
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            >
                                                @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.edit-btn')
                                            </p>
                                            ...
                                            >
                                                @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.delete-btn')
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.empty-info')
                        </p>
                    </div>
                ...
                >
                    <form @submit="handleSubmit($event, updateOrCreate)">
                        <x-dashboard::modal ref="updateCreateOptionModal">
                            <!-- Option Form Modal Header -->
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.name')
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.name')"
                                    />
                                ...
                                <div class="flex gap-4">
                                    <x-dashboard::form.control-group class="flex-1">
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.type')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.type')"
                                        >
                                            <option
                                                :value="type.key"
                                                :key="key"
                                    ...
                                    <x-dashboard::form.control-group class="flex-1">
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.is-required')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.is-required')"
                                        >
                                            <option value="1">
                                                @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.yes')
                                            </option>

                                            <option value="0">
                                                @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.no')
                                            </option>
                                        </x-dashboard::form.control-group.control>

                                        <x-dashboard::form.control-group.error control-name="is_required" />
                                    </x-dashboard::form.control-group>
                                </div>

                                <template v-if="! canHaveMultiplePrices(selectedOption.type)">
                                    <x-dashboard::form.control-group v-if="['text', 'textarea'].includes(selectedOption.type)">
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.max-characters')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.max-characters')"
                                        />

                                        <x-dashboard::form.control-group.error control-name="max_characters" />
                                    </x-dashboard::form.control-group>

                                    <x-dashboard::form.control-group v-else-if="selectedOption.type == 'file'">
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.supported-file-extensions')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.supported-file-extensions')"
                                        />

                                        <x-dashboard::form.control-group.error control-name="supported_file_extensions" />
                                    </x-dashboard::form.control-group>

                                    <x-dashboard::form.control-group>
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.price')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.price')"
                                        />
                            ...
                            <x-slot:footer>
                                ...
                                <x-dashboard::button
                                    ...
                                    :title="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.update-create.save-btn')"
                                />
                            </x-slot>
                        </x-dashboard::modal>
                    </form>
        ...
        >
            ...
            <div>
                ...
                <div class="mb-2.5 flex justify-between gap-5 p-4">
                    ...
                    <div class="flex items-center gap-x-5">
                        ...
                        >
                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.add-btn')
                        </p>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.empty-info')
                        </p>
                    </div>
            ...
            >
                ...
                >
                    <x-dashboard::modal ref="updateCreateOptionItemModal">
                        <!-- Option Item Modal Header -->
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.title')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <div class="flex gap-2">
                                ...
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.label')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.label')"
                                    />
                                ...
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.price')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        rules="required|decimal|min_value:0"
                                        :label="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.price')"
                                    />
                        ...
                        <x-slot:footer>
                            ...
                            <x-dashboard::button
                                button-type="button"
                                class="primary-button"
                                :title="trans('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.items.update-create.save-btn')"
                            />
                        </x-slot>
                    </x-dashboard::modal>
                </form>
                    ...
                    return {
                        types: {
                            text: {
                                ...
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.text.title')",
                            },

                            textarea: {
                                key: 'textarea',
                                canHaveMultiplePrices: false,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.textarea.title')",
                            },

                            checkbox: {
                                key: 'checkbox',
                                canHaveMultiplePrices: true,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.checkbox.title')",
                            },

                            radio: {
                                key: 'radio',
                                canHaveMultiplePrices: true,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.radio.title')",
                            },

                            select: {
                                key: 'select',
                                canHaveMultiplePrices: true,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.select.title')",
                            },

                            multiselect: {
                                key: 'multiselect',
                                canHaveMultiplePrices: true,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.multiselect.title')",
                            },

                            date: {
                                key: 'date',
                                canHaveMultiplePrices: false,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.date.title')",
                            },

                            datetime: {
                                key: 'datetime',
                                canHaveMultiplePrices: false,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.datetime.title')",
                            },

                            time: {
                                key: 'time',
                                canHaveMultiplePrices: false,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.time.title')",
                            },

                            file: {
                                key: 'file',
                                canHaveMultiplePrices: false,
                                title: "@lang('dashboard::app.catalog.products.edit.types.simple.customizable-options.option.types.file.title')",
                            },
                        },
