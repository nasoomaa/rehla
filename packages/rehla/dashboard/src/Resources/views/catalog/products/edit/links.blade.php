{!! view_render_event('rehla.dashboard.catalog.product.edit.form.links.before', ['product' => $product]) !!}
    
<v-product-links></v-product-links>

{!! view_render_event('rehla.dashboard.catalog.product.edit.form.links.after', ['product' => $product]) !!}
            ...
            >
                <div class="mb-2.5 flex justify-between gap-5 p-4">
                    ...
                    <div class="flex items-center gap-x-1">
                        ...
                        >
                            @lang('dashboard::app.catalog.products.edit.links.add-btn')
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div class="flex gap-2.5">
                            ...
                            >
                                <template v-if="! product.images.length">
                                    ...
                                    <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                                        @lang('dashboard::app.catalog.products.edit.links.image-placeholder')
                                    </p>
                                </template>
                            ...
                            <div class="grid place-content-start gap-1.5">
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('dashboard::app.catalog.products.edit.links.sku')".replace(':sku', product.sku) }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid place-content-start gap-1 text-right">
                            ...
                            >
                                @lang('dashboard::app.catalog.products.edit.links.delete')
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('dashboard::app.catalog.products.edit.links.empty-title')
                        </p>
                    ...
                    types: [
                        {
                            ...
                            title: `@lang('dashboard::app.catalog.products.edit.links.related-products.title')`,
                            info: `@lang('dashboard::app.catalog.products.edit.links.related-products.info')`,
                            empty_info: `@lang('dashboard::app.catalog.products.edit.links.related-products.empty-info')`,
                        }, {
                            key: 'up_sells',
                            title: `@lang('dashboard::app.catalog.products.edit.links.up-sells.title')`,
                            info: `@lang('dashboard::app.catalog.products.edit.links.up-sells.info')`,
                            empty_info: `@lang('dashboard::app.catalog.products.edit.links.up-sells.empty-info')`,
                        }, {
                            key: 'cross_sells',
                            title: `@lang('dashboard::app.catalog.products.edit.links.cross-sells.title')`,
                            info: `@lang('dashboard::app.catalog.products.edit.links.cross-sells.info')`,
                            empty_info: `@lang('dashboard::app.catalog.products.edit.links.cross-sells.empty-info')`,
                        }
                    ],
