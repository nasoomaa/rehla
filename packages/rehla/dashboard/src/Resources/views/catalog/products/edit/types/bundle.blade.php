...
{!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.bundle.before', ['product' => $product]) !!}

<v-bundle-options :errors="errors"></v-bundle-options>

{!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.bundle.after', ['product' => $product]) !!}
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.catalog.products.edit.types.bundle.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.catalog.products.edit.types.bundle.info')
                    </p>
                </div>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.bundle.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.bundle.empty-info')
                    </p>
                </div>
                    ...
                    <x-dashboard::modal ref="updateCreateOptionModal">
                        ...
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.title')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.name')
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.catalog.products.edit.types.bundle.update-create.name')"
                                />
                            ...
                            <div class="flex gap-4">
                                ...
                                <x-dashboard::form.control-group class="flex-1">
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.type')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.catalog.products.edit.types.bundle.update-create.type')"
                                    >
                                        <option value="select">
                                            @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.select')
                                        </option>
                                        ...
                                        <option value="checkbox">
                                            @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.checkbox')
                                        </option>

                                        <option value="multiselect">
                                            @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.multiselect')
                                        </option>
                                    </x-dashboard::form.control-group.control>
                                ...
                                <x-dashboard::form.control-group class="flex-1">
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.is-required')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.catalog.products.edit.types.bundle.update-create.is-required')"
                                    >
                                        <option value="1">
                                            @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.yes')
                                        </option>

                                        <option value="0">
                                            @lang('dashboard::app.catalog.products.edit.types.bundle.update-create.no')
                                        </option>
                                    </x-dashboard::form.control-group.control>
                        ...
                        <x-slot:footer>
                            ...
                            <x-dashboard::button
                                ...
                                :title="trans('dashboard::app.catalog.products.edit.types.bundle.update-create.save-btn')"
                            />
                        </x-slot>
                    </x-dashboard::modal>
                </form>
        ...
        <div>
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                ...
                <div class="flex items-center gap-x-5">
                    ...
                    >
                        @lang('dashboard::app.catalog.products.edit.types.bundle.option.add-btn')
                    </p>
                    ...
                    <p
                        ...
                        @click="edit"
                    >
                        @lang('dashboard::app.catalog.products.edit.types.bundle.option.edit-btn')
                    </p>
                    ...
                    <p
                        ...
                        @click="remove"
                    >
                        @lang('dashboard::app.catalog.products.edit.types.bundle.option.delete-btn')
                    </p>
                </div>
            </div>
                        ...
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 p-4 dark:border-gray-800">
                            ...
                            <div class="flex gap-2.5">
                                ...
                                >
                                    <template v-if="! element.product.images.length">
                                        ...
                                        <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                                            @lang('dashboard::app.catalog.products.edit.types.bundle.image-placeholder')
                                        </p>
                                    </template>
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @{{ `@lang('dashboard::app.catalog.products.edit.types.bundle.option.sku')`.replace(':sku', element.product.sku) }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="grid place-content-start gap-1 ltr:text-right rtl:text-left">
                                ...
                                <x-dashboard::form.control-group class="!mb-0">
                                    <x-dashboard::form.control-group.label class="required !block">
                                        @lang('dashboard::app.catalog.products.edit.types.bundle.option.default-qty')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <v-field
                                        ...
                                        label="@lang('dashboard::app.catalog.products.edit.types.bundle.option.default-qty')"
                                    ></v-field>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.bundle.option.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.bundle.option.empty-info')
                    </p>
                </div>
            ...
            data() {
                return {
                    types: {
                        select: {
                            key: 'select',
                            title: `@lang('dashboard::app.catalog.products.edit.types.bundle.option.types.select.title')`,
                            info: `@lang('dashboard::app.catalog.products.edit.types.bundle.option.types.select.info')`
                        },

                        radio: {
                            key: 'radio',
                            title: `@lang('dashboard::app.catalog.products.edit.types.bundle.option.types.radio.title')`,
                            info: `@lang('dashboard::app.catalog.products.edit.types.bundle.option.types.radio.info')`
                        },

                        multiselect: {
                            key: 'multiselect',
                            title: `@lang('dashboard::app.catalog.products.edit.types.bundle.option.types.multiselect.title')`,
                            info: `@lang('dashboard::app.catalog.products.edit.types.bundle.option.types.multiselect.info')`
                        },

                        checkbox: {
                            key: 'checkbox',
                            title: `@lang('dashboard::app.catalog.products.edit.types.bundle.option.types.checkbox.title')`,
                            info: `@lang('dashboard::app.catalog.products.edit.types.bundle.option.types.checkbox.info')`
                        }
                    },
                }
            },
