...
{!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.configurable.before', ['product' => $product]) !!}

<v-product-variations :errors="errors"></v-product-variations>

{!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.configurable.after', ['product' => $product]) !!}
...
@pushOnce('scripts')
        ...
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            <div class="mb-2.5 flex flex-wrap justify-between gap-2.5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.catalog.products.edit.types.configurable.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.catalog.products.edit.types.configurable.info')
                    </p>
                </div>
                ...
                <div class="flex items-center gap-x-1">
                    ...
                    >
                        @lang('dashboard::app.catalog.products.edit.types.configurable.add-btn')
                    </div>
                </div>
            </div>
                ...
                <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('dashboard::app.catalog.products.edit.types.configurable.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('dashboard::app.catalog.products.edit.types.configurable.empty-info')
                        </p>
                    </div>
            ...
            >
                <form @submit="handleSubmit($event, addVariant)">
                    ...
                    <x-dashboard::modal ref="variantCreateModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('dashboard::app.catalog.products.edit.types.configurable.create.title')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:footer>
                            ...
                            <x-dashboard::button
                                ...
                                :title="trans('dashboard::app.catalog.products.edit.types.configurable.create.save-btn')"
                            />
                        </x-slot>
                    </x-dashboard::modal>
                </form>
    ...
    >
        ...
        <div class="flex items-center gap-1.5 px-4">
            ...
            <x-dashboard::dropdown v-bind:close-on-click="false">
                <!-- Dropdown Toggler -->
                <x-slot:toggle>
                    <button
                        type="button"
                    ...
                    >
                        @lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.select-variants')
            ...
            <!-- Actions Selector -->
            <x-dashboard::dropdown v-if="selectedVariants.length">
                <!-- Dropdown Toggler -->
                <x-slot:toggle>
                    <button
                        type="button"
                        class="flex cursor-pointer items-center rounded-md p-1.5 text-xs font-semibold text-blue-600 transition-all hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-950"
                    >
                        @lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.select-action')
                    ...
                    >
                        ...
                        <x-slot:header>
                            <div class="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    type="submit"
                                >
                                    @lang('dashboard::app.catalog.products.edit.types.configurable.edit.save-btn')
                                </button>
                            </div>
                        </x-slot>
                        ...
                        <x-slot:content class="p-4">
                                    ...
                                    <template v-if="selectedType == 'editPrices'">
                                        <div class="border-b pb-2.5 dark:border-gray-800">
                                            <div class="flex items-end gap-2.5">
                                                <x-dashboard::form.control-group class="!mb-0 flex-1">
                                                    <x-dashboard::form.control-group.label class="required">
                                                        @lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.apply-to-all-sku')
                                                    </x-dashboard::form.control-group.label>
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <x-dashboard::form.control-group.control
                                                            ...
                                                            :label="trans('dashboard::app.catalog.products.edit.types.configurable.mass-edit.price')"
                                                        />
                                                    </div>
                                                </x-dashboard::form.control-group>

                                                <button class="secondary-button">
                                                    @lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.apply-to-all-btn')
                                                </button>
                                            </div>
                                    ...
                                    <template v-if="selectedType == 'editWeight'">
                                        <div class="border-b pb-2.5 dark:border-gray-800">
                                            <div class="flex items-end gap-2.5">
                                                <x-dashboard::form.control-group class="!mb-0 flex-1">
                                                    <x-dashboard::form.control-group.label>
                                                        @lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.apply-to-all-weight')
                                                    </x-dashboard::form.control-group.label>
                                                    ...
                                                    <div class="relative">
                                                        <x-dashboard::form.control-group.control
                                                            ...
                                                            value="0"
                                                            :label="trans('dashboard::app.catalog.products.edit.types.configurable.mass-edit.weight')"
                                                        />
                                                    </div>
                                                </x-dashboard::form.control-group>
                                            ...
                                            <x-dashboard::form.control-group.error control-name="weight" />
                                        </div>
                                    </template>
                                    ...
                                    <template v-if="selectedType == 'editName'">
                                        <div class="border-b pb-2.5 dark:border-gray-800">
                                            <div class="flex items-end gap-2.5">
                                                <x-dashboard::form.control-group class="!mb-0 flex-1">
                                                    <x-dashboard::form.control-group.label>
                                                        @lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.apply-to-all-name')
                                                    </x-dashboard::form.control-group.label>
                                                    ...
                                                    <div class="relative">
                                                        <x-dashboard::form.control-group.control
                                                            ...
                                                            name="name"
                                                            ::rules="{ required: true }"
                                                            :label="trans('dashboard::app.catalog.products.edit.types.configurable.mass-edit.name')"
                                                        />
                                                    </div>
                                                </x-dashboard::form.control-group>
                                    ...
                                    <template v-if="selectedType == 'editStatus'">
                                        <div class="border-b pb-2.5 dark:border-gray-800">
                                            <div class="flex items-end gap-2.5">
                                                <x-dashboard::form.control-group class="!mb-0 flex-1">
                                                    <x-dashboard::form.control-group.label>
                                                        @lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.apply-to-all-status')
                                                    </x-dashboard::form.control-group.label>
                                                    ...
                                                    <div class="relative">
                                                        <x-dashboard::form.control-group.control
                                                            ...
                                                            name="status"
                                                            ::rules="{ required: true }"
                                                            :label="trans('dashboard::app.catalog.products.edit.types.configurable.mass-edit.status')"
                                                        >
                                                            <option value="1">
                                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.enabled')
                                                            </option>

                                                            <option value="0">
                                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.disabled')
                                                            </option>
                                                        </x-dashboard::form.control-group.control>
                                                    </div>
                                                </x-dashboard::form.control-group>
                            ...
                            >
                                ...
                                <template v-if="selectedType == 'editPrices'">
                                    <x-dashboard::form.control-group class="mb-0 max-w-[115px] flex-1">
                                        <div class="relative">
                                            <span 
                                                class="absolute top-1/2 -translate-y-1/2 text-gray-500 ltr:left-4 rtl:right-4"
                                                v-pre
                                            ...
                                            <v-field
                                                ...
                                                label="@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.price')"
                                            >
                                            </v-field>
                                        </div>
                                    ...
                                    <x-dashboard::form.control-group class="mb-0 max-w-[115px] flex-1">
                                        <div class="relative">
                                            <v-field
                                                ...
                                                label="@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.weight')"
                                            >
                                            </v-field>
                                        </div>
                                    ...
                                    <x-dashboard::form.control-group class="mb-0 max-w-[115px] flex-1">
                                        <div class="relative">
                                            <v-field
                                                ...
                                                label="@lang('dashboard::app.catalog.products.edit.types.configurable.edit.enabled')"
                                            >
                                                <option value="1">
                                                    @lang('dashboard::app.catalog.products.edit.types.configurable.edit.enabled')
                                                </option>
                                    ...
                                    >
                                        <div class="relative">
                                            <v-field
                                                ...
                                                label="@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.variant-name')"
                                            >
                                            </v-field>
                                        </div>
                                ...
                                <template v-if="selectedType == 'editInventories'">
                                    <x-dashboard::form.control-group class="mb-0 mt-2.5">
                                        <div class="mb-2.5 grid grid-cols-3 gap-4">
                                            <x-dashboard::form.control-group
                                                class="!mb-0"
                                                v-for='inventorySource in inventorySources'
                                    ...
                                    >
                                        <div class="relative">
                                            <v-field
                                                ...
                                                ::rules="{ required: true, regex: /^([0-9]*[1-9][0-9]*(\.[0-9]+)?|[0]+\.[0-9]*[1-9][0-9]*)$/ }"
                                                v-model="variant.sku"
                                                label="@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.variant-sku')"
                                                v-slugify
                                            >
                                            </v-field>
                                        </div>
    ...
    >
        <div class="flex justify-between gap-2.5 border-b border-slate-300 px-4 py-6 dark:border-gray-800">
            ...
            <div class="flex gap-2.5">
                ...
                >
                    <template v-if="! variant.images.length">
                        ...
                        <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                            @lang('dashboard::app.catalog.products.edit.types.configurable.image-placeholder')
                        </p>
                    </template>
                ...
                <div class="grid place-content-start gap-1.5">
                    ...
                    <p class="text-gray-600 dark:text-gray-300">
                        @{{ "@lang('dashboard::app.catalog.products.edit.types.configurable.sku')".replace(':sku', variant.sku) }}
                    </p>
            ...
            <div class="grid place-content-start gap-1 text-right">
                ...
                <p class="font-semibold text-gray-800 dark:text-white">
                    @{{ "@lang('dashboard::app.catalog.products.edit.types.configurable.qty')".replace(':qty', totalQty) }}
                </p>
                ...
                <div class="flex gap-2.5">
                    ...
                    <p
                        ...
                        @click="remove"
                    >
                        @lang('dashboard::app.catalog.products.edit.types.configurable.delete-btn')
                    </p>
                    ...
                    <div>
                        ...
                        >
                            @lang('dashboard::app.catalog.products.edit.types.configurable.edit-btn')
                        </p>
                            ...
                            <form @submit="handleSubmit($event, update)">
                                ...
                                >
                                    ...
                                    <x-slot:header>
                                        <div class="flex items-center justify-between">
                                            <p class="text-xl font-medium dark:text-white">
                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.title')
                                            </p>
                                    ...
                                    <x-slot:content>
                                        ...
                                        <x-dashboard::form.control-group>
                                            <x-dashboard::form.control-group.label class="required">
                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.name')
                                            </x-dashboard::form.control-group.label>
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                ::value="variant.name"
                                                rules="required"
                                                :label="trans('dashboard::app.catalog.products.edit.types.configurable.edit.name')"
                                            />
                                        ...
                                        <x-dashboard::form.control-group>
                                            <x-dashboard::form.control-group.label class="required">
                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.sku')
                                            </x-dashboard::form.control-group.label>
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                rules="required"
                                                ::value="variant.sku"
                                                :label="trans('dashboard::app.catalog.products.edit.types.configurable.edit.sku')"
                                            />
                
                                            <x-dashboard::form.control-group.error control-name="sku" />
                                        </x-dashboard::form.control-group>

                                        <div class="mb-2.5 flex gap-4">
                                            <x-dashboard::form.control-group class="flex-1">
                                                <x-dashboard::form.control-group.label class="required">
                                                    @lang('dashboard::app.catalog.products.edit.types.configurable.edit.price')
                                                </x-dashboard::form.control-group.label>
                                                ...
                                                <x-dashboard::form.control-group.control
                                                    ...
                                                    ::rules="{required: true, decimal: true, min_value: 0}"
                                                    ::value="variant.price"
                                                    :label="trans('dashboard::app.catalog.products.edit.types.configurable.edit.price')"
                                                />
                                            ...
                                            <x-dashboard::form.control-group class="flex-1">
                                                <x-dashboard::form.control-group.label>
                                                    @lang('dashboard::app.catalog.products.edit.types.configurable.edit.status')
                                                </x-dashboard::form.control-group.label>
                                                ...
                                                <x-dashboard::form.control-group.control
                                                    ...
                                                    rules="required"
                                                    ::value="variant.status"
                                                    :label="trans('dashboard::app.catalog.products.edit.types.configurable.edit.status')"
                                                >
                                                    <option value="1">
                                                        @lang('dashboard::app.catalog.products.edit.types.configurable.edit.enabled')
                                                    </option>
                                        ...
                                        <x-dashboard::form.control-group>
                                            <x-dashboard::form.control-group.label class="required">
                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.weight')
                                            </x-dashboard::form.control-group.label>
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                ::rules="{ required: true, regex: /^([0-9]*[1-9][0-9]*(\.[0-9]+)?|[0]+\.[0-9]*[1-9][0-9]*)$/ }"
                                                ::value="variant.weight"
                                                :label="trans('dashboard::app.catalog.products.edit.types.configurable.edit.weight')"
                                            />
                                        ...
                                        <div class="mt-5 grid">
                                            <p class="mb-2.5 font-semibold text-gray-800 dark:text-white">
                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.quantities')
                                            </p>
                                        ...
                                        <div class="mb-2.5">
                                            <p class="mb-2.5 font-semibold text-gray-800 dark:text-white">
                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.images')
                                            </p>
                                        ...
                                        >
                                            @lang('dashboard::app.catalog.products.edit.types.configurable.edit.edit-info')
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                            >
                                                @lang('dashboard::app.catalog.products.edit.types.configurable.edit.edit-link-title')
                                            </a>
                                        </div>
                                    </x-slot>
                                </x-dashboard::drawer>
            ...
            methods: {
                addVariant(params, { resetForm }) {
                    ...
                    if (filteredVariants.length) {
                        this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('dashboard::app.catalog.products.edit.types.configurable.create.variant-already-exists')" });
                ...
                return {
                    ...
                    updateTypes: {
                        editName: {
                            key: 'editName',
                            value: 'name',
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.edit-names')"
                        },

                        editSku: {
                            key: 'editSku',
                            value: 'sku',
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.edit-sku')"
                        },

                        editPrices: {
                            key: 'editPrices',
                            value: 'price',
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.edit-prices')"
                        },

                        editInventories: {
                            key: 'editInventories',
                            value: 'edit-inventories',
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.edit-inventories')"
                        },

                        editWeight: {
                            key: 'editWeight',
                            value: 'weight',
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.edit-weight')",
                        },

                        editStatus: {
                            key: 'editStatus',
                            value: 'status',
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.edit-status')",
                        },

                        addImages: {
                            key: 'addImages',
                            value: 'images',
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.add-images')",
                            images: []
                        },

                        removeImages: {
                            key: 'removeImages',
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.remove-images')",
                            value: 'remove-images',
                        },
                        ...
                        removeVariants: {
                            ...
                            title: "@lang('dashboard::app.catalog.products.edit.types.configurable.mass-edit.remove-variants')",
                        }
                    },
                };
            },
