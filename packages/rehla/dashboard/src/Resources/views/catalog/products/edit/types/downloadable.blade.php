{!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.downloadable.before', ['product' => $product]) !!}

<v-downloadable-links :errors="errors"></v-downloadable-links>

<v-downloadable-samples :errors="errors"></v-downloadable-samples>

{!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.downloadable.after', ['product' => $product]) !!}
        ...
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.info')
                    </p>
                </div>
                ...
                <div class="flex items-center gap-x-1">
                    ...
                    >
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.add-btn')
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 p-4 dark:border-gray-800">
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        <template v-if="element.type == 'file'">
                                            <div>
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.links.file')
                                        ...
                                        <template v-else>
                                            <div>
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.links.url')
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        <template v-if="element.sample_type == 'file'">
                                            <div v-if="element.sample_file_url">
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.links.sample-file')
                                        ...
                                        <template v-else>
                                            <div v-if="element.sample_url">
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.links.sample-url')
                            ...
                            <div class="grid place-content-start gap-1 text-right">
                                ...
                                <div class="flex items-center gap-x-5">
                                    ...
                                    >
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.delete-btn')
                                    </p>
                                    ...
                                    >
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.edit-btn')
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.empty-info')
                    </p>
                </div>
            ...
            >
                <form @submit="handleSubmit($event, updateOrCreate)">
                    <!-- Search Drawer -->
                    <x-dashboard::drawer ref="updateCreateLinkDrawer">
                        <!-- Drawer Header -->
                        <x-slot:header>
                            <div class="grid gap-3">
                                <div class="flex items-center justify-between">
                                    <p class="text-xl font-medium dark:text-white">
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.title')
                                    </p>

                                    <button class="primary-button ltr:mr-11 rtl:ml-11">
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.save-btn')
                                    </button>
                                </div>
                            </div>
                        </x-slot>
                            ...
                            <div class="px-4 py-2.5">
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.name')
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.name')"
                                    />
                                ...
                                <div class="flex gap-4">
                                    <x-dashboard::form.control-group class="flex-1">
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.price')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.price')"
                                        />
                                    ...
                                    <x-dashboard::form.control-group class="flex-1">
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.downloads')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.downloads')"
                                        />
                
                                        <x-dashboard::form.control-group.error control-name="downloads" />
                                    </x-dashboard::form.control-group>
                                </div>
                                ...
                                <div class="flex gap-4">
                                    <x-dashboard::form.control-group class="flex-1">
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.file-type')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.file-type')"
                                        >
                                            <option value="file">
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.file')
                                            </option>

                                            <option value="url">
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.url')
                                            </option>
                                        </x-dashboard::form.control-group.control>
                                    ...
                                    <template v-if="selectedLink.type == 'file'">
                                        <x-dashboard::form.control-group class="flex-1">
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                :label="trans('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.file')"
                                            />
                                    ...
                                    <template v-else>
                                        <x-dashboard::form.control-group class="flex-1">
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                :label="trans('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.url')"
                                            />
                    
                                            <x-dashboard::form.control-group.error control-name="url" />
                                        </x-dashboard::form.control-group>
                                    </template>
                                </div>
                                ...
                                <div class="flex gap-4">
                                    <x-dashboard::form.control-group class="flex-1">
                                        <x-dashboard::form.control-group.label>
                                            @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.sample-type')
                                        </x-dashboard::form.control-group.label>
                                    ...
                                    <template v-if="selectedLink.sample_type == 'file'">
                                        <x-dashboard::form.control-group class="flex-1">
                                            <x-dashboard::form.control-group.label>
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.links.update-create.sample')
                                            </x-dashboard::form.control-group.label>
                                    ...
                                    <template v-else>
                                        <x-dashboard::form.control-group class="flex-1">
                                            ...
                                            <x-dashboard::form.control-group.error control-name="sample_url" />
                                        </x-dashboard::form.control-group>
                                    </template>
                                </div>
                            </div>
    ...
    >
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.info')
                    </p>
                </div>
                ...
                <div class="flex items-center gap-x-1">
                    ...
                    >
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.add-btn')
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        <template v-if="element.type == 'file'">
                                            <div>
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.file')
                                        ...
                                        <template v-else>
                                            <div>
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.url')
                            ...
                            <div class="grid place-content-start gap-1 text-right">
                                <div class="flex items-center gap-x-5">
                                    <p
                                        ...
                                        @click="remove(element)"
                                    >
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.delete-btn')
                                    </p>
                                    ...
                                    >
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.edit-btn')
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.empty-info')
                    </p>
                </div>
            ...
            >
                <form @submit="handleSubmit($event, updateOrCreate)">
                    <!-- Search Drawer -->
                    <x-dashboard::drawer ref="updateCreateSampleDrawer">
                        <!-- Drawer Header -->
                        <x-slot:header>
                            <div class="grid gap-3">
                                <div class="flex items-center justify-between">
                                    <p class="text-xl font-medium dark:text-white">
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.title')
                                    </p>

                                    <button class="primary-button ltr:mr-11 rtl:ml-11">
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.save-btn')
                                    </button>
                                </div>
                            </div>
                        </x-slot>
                        ...
                        <x-slot:content class="!p-0">
                            ...
                            <div class="px-4 py-2.5">
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.name')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.name')"
                                    />
                                ...
                                <div class="flex gap-4">
                                    <x-dashboard::form.control-group class="flex-1">
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.file-type')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            rules="required"
                                            :label="trans('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.file-type')"
                                        >
                                            <option value="file">
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.file')
                                            </option>

                                            <option value="url">
                                                @lang('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.url')
                                            </option>
                                        </x-dashboard::form.control-group.control>
                                    ...
                                    <template v-if="selectedSample.type == 'file'">
                                        <x-dashboard::form.control-group class="flex-1">
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                :label="trans('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.file')"
                                            />
                                    ...
                                    <template v-else>
                                        <x-dashboard::form.control-group class="flex-1">
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                :label="trans('dashboard::app.catalog.products.edit.types.downloadable.samples.update-create.url')"
                                            />
