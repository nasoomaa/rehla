{!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.grouped.before', ['product' => $product]) !!}

<v-group-products :errors="errors"></v-group-products>

{!! view_render_event('rehla.dashboard.catalog.product.edit.form.types.grouped.after', ['product' => $product]) !!}
            ...
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.catalog.products.edit.types.grouped.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.catalog.products.edit.types.grouped.info')
                    </p>
                </div>
                ...
                <div class="flex items-center gap-x-1">
                    ...
                    >
                        @lang('dashboard::app.catalog.products.edit.types.grouped.add-btn')
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @{{ "@lang('dashboard::app.catalog.products.edit.types.grouped.sku')".replace(':sku', element.associated_product.sku) }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="grid place-content-start gap-1 ltr:text-right rtl:text-left">
                                ...
                                <x-dashboard::form.control-group class="!mb-0">
                                    <x-dashboard::form.control-group.label class="required !block">
                                        @lang('dashboard::app.catalog.products.edit.types.grouped.default-qty')
                                    ...
                                    <v-field
                                        ...
                                        label="@lang('dashboard::app.catalog.products.edit.types.grouped.default-qty')"
                                    >
                                    </v-field>
                                ...
                                >
                                    @lang('dashboard::app.catalog.products.edit.types.grouped.delete')
                                </p>
                            </div>
                        </div>
                    </template>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.grouped.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('dashboard::app.catalog.products.edit.types.grouped.empty-info')
                    </p>
                </div>
