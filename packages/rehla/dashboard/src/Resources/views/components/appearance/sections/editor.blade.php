...
>
    <x-dashboard::shimmer.appearance.sections />
</v-section-editor>

<x-dashboard::appearance.sections.fields />

{{-- Wrapped, because the component's own class attribute wins over one passed in. --}}
<div class="hidden">
    <x-dashboard::form.control-group.advance.select name="section-filter-picker" />

    <x-dashboard::form.control-group.advance.multiselect name="section-filter-multi-picker" />
</div>
    ...
    >
        <div class="flex h-[calc(100vh-140px)] min-h-[480px] flex-col">
            ...
            <div class="flex shrink-0 items-center justify-between gap-4 max-sm:flex-wrap">
                <div class="grid gap-1.5">
                    <p class="text-xl font-bold text-gray-800 dark:text-white">
                        @lang('dashboard::app.appearance.sections.index.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.appearance.sections.index.scoped-to', [
                            'theme'   => '@{{ themeName }}',
                            'channel' => '@{{ channelName }}',
                        ])
                    </p>
                ...
                <div class="flex items-center gap-2.5 max-sm:w-full max-sm:flex-wrap">
                    ...
                    <select
                        ...
                        :title="'@lang('dashboard::app.appearance.sections.index.locale')'"
                        v-model="locale"
                        @change="switchLocale"
                    ...
                    <select
                        class="custom-select cursor-pointer rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 ltr:pr-8 rtl:pl-8 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400"
                        :title="'@lang('dashboard::app.appearance.sections.index.channel')'"
                        v-model="channel"
                    ...
                    <template v-if="pendingCount">
                        <button
                            ...
                            @click="discardAll"
                        >
                            @lang('dashboard::app.appearance.sections.index.discard-btn')
                        </button>
                        ...
                        <button
                            ...
                            @click="publishAll"
                        >
                            @lang('dashboard::app.appearance.sections.index.publish-btn') (@{{ pendingCount }})
                        </button>
                    </template>
                </div>
            </div>
                    ...
                    <div class="box-shadow flex w-[340px] shrink-0 flex-col overflow-hidden rounded bg-white dark:bg-gray-900 max-lg:w-full">
                        <div class="flex shrink-0 items-center gap-2 border-b p-4 dark:border-gray-800">
                            <p class="text-base font-semibold text-gray-800 dark:text-white">
                                @lang('dashboard::app.components.layouts.sidebar.sections')
                            </p>
                            ...
                            @if (bouncer()->hasPermission('appearance.sections.create'))
                                <button
                                    ...
                                    :title="'@lang('dashboard::app.appearance.sections.index.create-btn')'"
                                    @click="openCreate"
                                >
                            ...
                            <span
                                ...
                                v-if="pendingCount"
                            >
                                @{{ pendingCount }} @lang('dashboard::app.appearance.sections.index.unsaved')
                            </span>
                        </div>
                        ...
                        <div class="min-h-0 flex-1 overflow-y-auto">
                                ...
                                <template #item="{ element }">
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            :title="'@lang('dashboard::app.appearance.sections.index.pinned')'"
                                            v-else
                                        >&mdash;</span>
                                        ...
                                        >
                                            <span class="flex items-center gap-1">
                                                ...
                                                <span
                                                    ...
                                                    :title="'@lang('dashboard::app.appearance.sections.index.unsaved')'"
                                        ...
                                        <button
                                            ...
                                            :title="element.status
                                                ? '@lang('dashboard::app.appearance.sections.edit.active')'
                                                : '@lang('dashboard::app.appearance.sections.edit.inactive')'"
                                        ...
                                        <x-dashboard::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'rtl' ? 'left' : 'right' }}">
                                            <x-slot:toggle>
                                                <button
                                                    type="button"
                                            ...
                                            <x-slot:menu>
                                                @if (bouncer()->hasPermission('appearance.sections.create'))
                                                    ...
                                                    >
                                                        @lang('dashboard::app.appearance.sections.index.duplicate-btn')
                                                    </x-dashboard::dropdown.menu.item>
                                                @endif

                                                @if (bouncer()->hasPermission('appearance.sections.delete'))
                                                    <x-dashboard::dropdown.menu.item @click="remove(element)">
                                                        @lang('dashboard::app.appearance.sections.edit.delete')
                                                    </x-dashboard::dropdown.menu.item>
                                                @endif
                                            </x-slot>
                            ...
                            <p
                                ...
                                v-if="! items.length"
                            >
                                @lang('dashboard::app.appearance.sections.index.empty')
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        <div class="flex shrink-0 items-center justify-between gap-2 border-b p-4 dark:border-gray-800">
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.appearance.sections.index.preview-btn')
                            </p>
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <button
                                    ...
                                    :title="'@lang('dashboard::app.appearance.sections.edit.preview')'"
                                    @click="reloadPreview"
                                ></button>
                            </div>
                        </div>
            ...
            >
                <x-slot:header class="p-4">
                    <p class="text-lg font-bold text-gray-800 dark:text-white">
                        @lang('dashboard::app.appearance.sections.create.title')
                    </p>
                </x-slot>
                        ...
                        >
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.appearance.sections.create.type.title')
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    rules="required"
                                    v-model="newType"
                                    :label="trans('dashboard::app.appearance.sections.create.type.title')"
                                />
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.appearance.sections.create.name')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    name="name"
                                    rules="required"
                                    :label="trans('dashboard::app.appearance.sections.create.name')"
                                    :placeholder="trans('dashboard::app.appearance.sections.create.name')"
                                />
                ...
                <x-slot:footer class="px-4 pb-8">
                    <div class="flex items-center justify-end">
                        <button
                            ...
                            :disabled="isBusy"
                        >
                            @lang('dashboard::app.appearance.sections.create.save-btn')
                        </button>
                    </div>
                </x-slot>
            </x-dashboard::drawer>
        ...
        app.component('v-section-editor', {
            ...
            data() {
                return {
                    ...
                    devices: [
                        { key: 'desktop', label: "@lang('dashboard::app.appearance.sections.index.desktop')" },
                        { key: 'tablet', label: "@lang('dashboard::app.appearance.sections.index.tablet')" },
                        { key: 'mobile', label: "@lang('dashboard::app.appearance.sections.index.mobile')" },
                    ],
                    ...
                    sectionTypes: [
                        {
                            ...
                            icon: 'icon-product',
                            label: "@lang('dashboard::app.appearance.sections.create.type.product-carousel')",
                        },
                        {
                            key: 'category_carousel',
                            icon: 'icon-folder',
                            label: "@lang('dashboard::app.appearance.sections.create.type.category-carousel')",
                        },
                        {
                            key: 'image_carousel',
                            icon: 'icon-image',
                            label: "@lang('dashboard::app.appearance.sections.create.type.image-carousel')",
                        },
                        {
                            key: 'static_content',
                            icon: 'icon-cms',
                            label: "@lang('dashboard::app.appearance.sections.create.type.static-content')",
                        },
                        {
                            key: 'footer_links',
                            icon: 'icon-list',
                            label: "@lang('dashboard::app.appearance.sections.create.type.footer-links')",
                        },
                        {
                            key: 'services_content',
                            icon: 'icon-store',
                            label: "@lang('dashboard::app.appearance.sections.create.type.services-content')",
                        },
                    ],
                };
            },
            ...
            methods: {
                ...
                remove(section) {
                    this.$emitter.emit('open-confirm-modal', {
                        message: "@lang('dashboard::app.appearance.sections.index.delete-confirm')",
