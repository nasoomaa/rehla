...
<x-dashboard::appearance.sections.code-editor />
                ...
                <div v-else-if="field.type === 'filters'">
                    ...
                    <button
                        ...
                        :title="allFiltersUsed(field)
                            ? '@lang('dashboard::app.appearance.sections.index.all-filters-used')'
                            : ''"
                ...
                <div v-else-if="field.type === 'image'">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <label class="secondary-button cursor-pointer">
                            @lang('dashboard::app.appearance.sections.edit.image')
