...
@pushOnce('scripts')
    ...
    >
        <div>
            <x-dashboard::modal ref="exportModal">
                <!-- Modal Toggler -->
                <x-slot:toggle>
                ...
                <x-slot:content>
                    <x-dashboard::form action="">
                        <x-dashboard::form.control-group class="!mb-0">
                            ...
                            >
                                <option value="csv">
                                    @lang('dashboard::app.export.csv')
                                </option>

                                <option value="xls">
                                    @lang('dashboard::app.export.xls')
                                </option>

                                <option value="xlsx">
                                    @lang('dashboard::app.export.xlsx')
                                </option>
                            </x-dashboard::form.control-group.control>
                ...
                <x-slot:footer>
                    ...
                    <x-dashboard::button
                        ...
                        :title="trans('dashboard::app.export.export')"
                        @click="download"
                    />
                </x-slot>
            </x-dashboard::modal>
            ...
            methods: {
                ...
                download() {
                    if (! this.available?.records?.length) {
                        this.$emitter.emit('add-flash', { type: 'warning', message: '@lang('dashboard::app.export.no-records')' });
