...
<template v-if="isLoading">
    <x-dashboard::shimmer.datagrid.toolbar />
</template>
    ...
    <div class="mt-7 flex items-center gap-4 max-md:flex-wrap max-md:gap-y-3">
        ...
        <div class="flex gap-x-1 md:me-auto max-md:w-full">
            ...
            <template v-if="applied.massActions.indices.length">
                <x-dashboard::datagrid.toolbar.mass-action>
            ...
            <!-- Search Panel -->
            <template v-else>
                <x-dashboard::datagrid.toolbar.search>
                    <template #search="{
                        available,
                        applied,
                        search,
        ...
        <div class="dg-fsbar flex items-center gap-x-4 max-md:w-full max-md:justify-center">
            ...
            <div class="dg-fsbar-filter">
                <x-dashboard::datagrid.toolbar.filter>
                    <template #filter="{
                        available,
                        applied,
                        filters,
                ...
                >
                    <x-slot:toggle>
                        <div
                            ...
                            title="@lang('dashboard::app.components.datagrid.toolbar.sort-by')"
                        >
                            <span class="icon-sort-up-down text-2xl"></span>

                            @lang('dashboard::app.components.datagrid.toolbar.sort-by')
                        </div>
                    </x-slot>
        ...
        <div class="max-md:flex max-md:w-full max-md:justify-center">
            <!-- Pagination Panel -->
            <x-dashboard::datagrid.toolbar.pagination>
                <template #pagination="{
                    available,
                    applied,
                    changePage,
