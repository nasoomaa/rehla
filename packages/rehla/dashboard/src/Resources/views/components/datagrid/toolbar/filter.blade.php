    ...
    >
        ...
        >
            <template v-if="isLoading">
                <x-dashboard::shimmer.datagrid.toolbar.filter />
            </template>
                ...
                >
                    <x-slot:toggle>
                        <div>
                            ...
                            >
                                ...
                                <span>
                                    @lang('dashboard::app.components.datagrid.toolbar.filter.title')
                                </span>
                    ...
                    <x-slot:header>
                        ...
                        >
                            <p class="text-xl font-semibold text-gray-800 dark:text-white">
                                @lang('dashboard::app.components.datagrid.filters.title')
                            </p>
                        </div>
                        ...
                        <div v-else class="flex items-center gap-x-2">
                            ...
                            <p class="text-xl font-semibold text-gray-800 dark:text-white">
                                @{{ applied.savedFilterId ? '@lang('dashboard::app.components.datagrid.toolbar.filter.update-filter')' : '@lang('dashboard::app.components.datagrid.toolbar.filter.save-filter')' }}
                            </p>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:content class="!p-0">
                        <template v-if="! isShowSavedFilters">
                            ...
                            >
                                <x-slot:header class="px-4">
                                    <p class="w-full text-base font-semibold text-gray-800 dark:text-white">
                                        @lang('dashboard::app.components.datagrid.toolbar.filter.quick-filters')
                                    </p>
                                </x-slot>
                            ...
                            <!-- Filters Accordion -->
                            <x-dashboard::accordion class="select-none !rounded-none !border-none !shadow-none">
                                <x-slot:header class="px-4">
                                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                                        @lang('dashboard::app.components.datagrid.toolbar.filter.custom-filters')
                                    </p>
                                    ...
                                    >
                                        @lang('dashboard::app.components.datagrid.filters.custom-filters.clear-all')
                                    </div>
                                </x-slot>
                                ...
                                <x-slot:content class="!p-4">
                                            ...
                                            <div v-if="column.type === 'boolean'">
                                                ...
                                                <template v-if="column.filterable_type === 'dropdown'">
                                                    ...
                                                    <div class="mb-2 mt-1.5">
                                                        <x-dashboard::dropdown :fit-toggle="true">
                                                            <x-slot:toggle>
                                                                <button
                                                                    type="button"
                                                                ...
                                                                >
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        v-text="'@lang('dashboard::app.components.datagrid.filters.select')'"
                                                                    ...
                                                                    <span
                                                                        class="text-sm text-gray-400 dark:text-gray-400"
                                                                        v-text="column.filterable_options.find((option => option.value === getAppliedColumnValues(column.index)))?.label ?? '@lang('dashboard::app.components.datagrid.filters.select')'"
                                                                        v-else
                                                                    >
                                                                    </span>
                                                            ...
                                                            <x-slot:menu class="!py-0">
                                                                ...
                                                                >
                                                                    <input
                                                                        ...
                                                                        placeholder="@lang('dashboard::app.components.datagrid.toolbar.search.title')"
                                                                ...
                                                                <div class="max-h-[240px] overflow-auto py-4">
                                                                    ...
                                                                    >
                                                                        @lang('dashboard::app.components.datagrid.filters.dropdown.searchable.no-results')
                                                                    </li>
                                                                </div>
                                                            </x-slot>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        >
                                            @lang('dashboard::app.components.datagrid.toolbar.filter.apply-filters-btn')
                                        </button>
                        ...
                        <template v-else>
                            <div class="flex items-center justify-between px-4 py-4">
                                <p class="text-base font-semibold text-gray-800 dark:text-white">
                                    @{{ applied.savedFilterId ? '@lang('dashboard::app.components.datagrid.toolbar.filter.update-filter')' : '@lang('dashboard::app.components.datagrid.toolbar.filter.create-new-filter')' }}
                                </p>
                            </div>
                                    ...
                                    <form @submit="handleSubmit($event, createOrUpdateFilter)">
                                        <div class="flex flex-col gap-4">
                                            ...
                                            <div class="flex flex-col gap-2 border-b px-4 dark:border-gray-800">
                                                <x-dashboard::form.control-group>
                                                    <x-dashboard::form.control-group.label class="required">
                                                        @lang('dashboard::app.components.datagrid.toolbar.filter.name')
                                                    ...
                                                    <x-dashboard::form.control-group.control
                                                        ...
                                                        rules="required"
                                                        :label="trans('dashboard::app.components.datagrid.toolbar.filter.name')"
                                                        :placeholder="trans('dashboard::app.components.datagrid.toolbar.filter.name')"
                                                    />
                                                ...
                                                <div class="mb-4 flex content-end items-center justify-end">
                                                    <button
                                                        ...
                                                        aria-label="@lang('dashboard::app.components.datagrid.toolbar.filter.save-btn')"
                                            ...
                                            <div class="flex flex-col gap-4 px-4">
                                                <p class="text-base font-semibold text-gray-800 dark:text-white">
                                                    @lang('dashboard::app.components.datagrid.toolbar.filter.selected-filters')
                                                </p>
                                                            ...
                                                            <div class="flex items-center gap-5 py-2.5">
                                                                ...
                                                                <div class="flex flex-col gap-1.5">
                                                                    <p class="text-base font-semibold text-gray-400">
                                                                        @lang('dashboard::app.components.datagrid.toolbar.filter.empty-title')
                                                                    </p>

                                                                    <p class="text-gray-400">
                                                                        @lang('dashboard::app.components.datagrid.toolbar.filter.empty-description')
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
