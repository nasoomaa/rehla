    ...
    >
        ...
        >
            <template v-if="isLoading">
                <x-dashboard::shimmer.datagrid.toolbar.pagination />
            </template>
            ...
            <template v-else>
                <div class="flex items-center gap-x-2">
                    ...
                    <p class="whitespace-nowrap text-gray-600 dark:text-gray-300 max-sm:hidden">
                        @lang('dashboard::app.components.datagrid.toolbar.per-page')
                    </p>
                    ...
                    <div class="whitespace-nowrap text-gray-600 dark:text-gray-300">
                        <span>
                            @lang('dashboard::app.components.datagrid.toolbar.of')
                        </span>
