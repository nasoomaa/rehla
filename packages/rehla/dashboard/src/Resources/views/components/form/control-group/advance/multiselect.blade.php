...
<v-multiselect
    ...
    placeholder="{{ $placeholder ?: trans('dashboard::app.components.datagrid.toolbar.search.title') }}"
    label="{{ $label }}"
    {{ $attributes }}
>
...
@pushOnce('scripts')
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <span
                            class="icon-cross cursor-pointer text-base leading-none hover:text-red-600"
                            role="button"
                            @click.stop="deselect(option.id)"
                        ></span>
                    </span>
                    ...
                    <span
                        class="icon-arrow-down flex items-center text-2xl text-gray-500 transition-transform ltr:ml-auto rtl:mr-auto dark:text-gray-400"
                    ...
                    <div class="border-b p-2 dark:border-gray-800">
                        <div class="relative">
                            <input
                                ...
                                v-model="search"
                                @keydown.delete="removeLastOnBackspace"
                            />
    ...
    <script type="module">
        app.component('v-multiselect', {
            ...
            data() {
                return {
                    selectedIds: this.value.map((id) => String(id)),

                    search: '',

                    isOpen: false,

                    searchPlaceholder: "@lang('dashboard::app.components.datagrid.toolbar.search.title')",
                };
            },
            ...
            computed: {
                selectedOptions() {
                    return this.selectedIds
                        .map((id) => this.options.find((option) => String(option.id) === id))
            ...
            methods: {
                ...
                toggle(id) {
                    if (this.isSelected(id)) {
                        ...
                        this.selectedIds = [...this.selectedIds, String(id)];
                    }
                ...
                deselect(id) {
                    this.selectedIds = this.selectedIds.filter((selectedId) => selectedId !== String(id));
                },

                removeLastOnBackspace() {
                    if (this.search === '' && this.selectedIds.length) {
