        ...
        <v-mega-search class="hidden sm:block">
            <div class="relative flex w-[200px] items-center sm:w-[300px] md:w-[400px] lg:w-[525px] xl:max-w-[525px] ltr:ml-2 rtl:mr-2 sm:ltr:ml-2.5 sm:rtl:mr-2.5">
                ...
                <input
                    ...
                    placeholder="@lang('dashboard::app.components.layouts.header.mega-search.title')"
                >
            </div>
        </v-mega-search>
    </div>
    ...
    <div class="flex items-center gap-1 sm:gap-2.5">
        ...
        >
            <span
                ...
                title="@lang('dashboard::app.components.layouts.header.visit-shop')"
            >
            </span>
        </a>
       ...
       <!-- Notification Component -->
        <v-notifications {{ $attributes }}>
            <span class="relative flex">
                <span
                    ...
                    title="@lang('dashboard::app.components.layouts.header.notifications')"
                >
                </span>
            </span>
        </v-notifications>
        ...
        <!-- Admin Profile -->
        <x-dashboard::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
            <x-slot:toggle>
                @if ($admin->image)
            ...
            <x-slot:content class="!p-0">
                <div class="flex items-center gap-1.5 border border-b-gray-300 px-4 py-2 dark:border-gray-800 sm:px-5 sm:py-2.5">
                    ...
                    <p class="text-xs text-gray-400 sm:text-sm">
                        @lang('dashboard::app.components.layouts.header.app-version', ['version' => 'v' . core()->version()])
                    </p>
                </div>
                ...
                <div class="grid gap-1 pb-2.5">
                    ...
                    >
                        @lang('dashboard::app.components.layouts.header.my-account')
                    </a>
                    ...
                    >
                        @lang('dashboard::app.components.layouts.header.logout')
                    </a>
                </div>
            </x-slot>
                ...
                <div class="group/item relative">
                    ...
                    >
                        ...
                        <p class="font-semibold text-gray-600 dark:text-gray-300 whitespace-nowrap text-sm {{ $isHelpActive ? 'text-white' : '' }} sm:text-base">
                            @lang('dashboard::app.components.layouts.sidebar.help')
                        </p>
                    </a>
                </div>
            </nav>
            ...
            >
                ...
                <template v-if="activeTab == 'products'">
                    <template v-if="isLoading">
                        <x-dashboard::shimmer.header.mega-search.products />
                    </template>
                    ...
                    <template v-else>
                                ...
                                <div class="flex gap-2 sm:gap-2.5">
                                    ...
                                    >
                                        <template v-if="! product.images.length">
                                            ...
                                            <p class="absolute bottom-0.5 w-full text-center text-[4px] font-semibold text-gray-400 sm:bottom-1.5 sm:text-[6px]">
                                                @lang('dashboard::app.catalog.products.edit.types.grouped.image-placeholder')
                                            </p>
                                        </template>
                                    ...
                                    <div class="grid place-content-start gap-1 sm:gap-1.5">
                                        ...
                                        <p class="text-xs text-gray-500 sm:text-sm">
                                            @{{ "@lang('dashboard::app.components.layouts.header.mega-search.sku')".replace(':sku', product.sku) }}
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="flex border-t p-2 dark:border-gray-800 sm:p-3">
                            ...
                            >
                                @{{ "@lang('dashboard::app.components.layouts.header.mega-search.explore-all-matching-products')".replace(':query', searchTerm).replace(':count', searchedResults.products.meta.total) }}
                            </a>
                            ...
                            <a
                                ...
                                v-else
                            >
                                @lang('dashboard::app.components.layouts.header.mega-search.explore-all-products')
                            </a>
                        </div>
                    </template>
                </template>
                ...
                <template v-if="activeTab == 'orders'">
                    <template v-if="isLoading">
                        <x-dashboard::shimmer.header.mega-search.orders />
                    </template>
                    ...
                    <template v-else>
                        ...
                        <div class="flex border-t p-2 dark:border-gray-800 sm:p-3">
                            ...
                            >
                                @{{ "@lang('dashboard::app.components.layouts.header.mega-search.explore-all-matching-orders')".replace(':query', searchTerm).replace(':count', searchedResults.orders.total) }}
                            </a>
                            ...
                            <a
                                ...
                                v-else
                            >
                                @lang('dashboard::app.components.layouts.header.mega-search.explore-all-orders')
                            </a>
                        </div>
                    </template>
                </template>
                ...
                <template v-if="activeTab == 'categories'">
                    <template v-if="isLoading">
                        <x-dashboard::shimmer.header.mega-search.categories />
                    </template>
                    ...
                    <template v-else>
                        ...
                        <div class="flex border-t p-2 dark:border-gray-800 sm:p-3">
                            ...
                            >
                                @{{ "@lang('dashboard::app.components.layouts.header.mega-search.explore-all-matching-categories')".replace(':query', searchTerm).replace(':count', searchedResults.categories.total) }}
                            </a>
                            ...
                            <a
                                ...
                                v-else
                            >
                                @lang('dashboard::app.components.layouts.header.mega-search.explore-all-categories')
                            </a>
                        </div>
                    </template>
                </template>
                ...
                <template v-if="activeTab == 'customers'">
                    <template v-if="isLoading">
                        <x-dashboard::shimmer.header.mega-search.customers />
                    </template>
                    ...
                    <template v-else>
                        ...
                        <div class="flex border-t p-2 dark:border-gray-800 sm:p-3">
                            ...
                            >
                                @{{ "@lang('dashboard::app.components.layouts.header.mega-search.explore-all-matching-customers')".replace(':query', searchTerm).replace(':count', searchedResults.customers.total) }}
                            </a>
                            ...
                            <a
                                ...
                                v-else
                            >
                                @lang('dashboard::app.components.layouts.header.mega-search.explore-all-customers')
                            </a>
                        </div>
                    </template>
                </template>
            ...
            data() {
                return {
                    ...
                    tabs: {
                        products: {
                            key: 'products',
                            title: "@lang('dashboard::app.components.layouts.header.mega-search.products')",
                            is_active: true,
                        ...
                        orders: {
                            key: 'orders',
                            title: "@lang('dashboard::app.components.layouts.header.mega-search.orders')",
                            endpoint: "{{ route('admin.sales.orders.search') }}"
                        },

                        categories: {
                            key: 'categories',
                            title: "@lang('dashboard::app.components.layouts.header.mega-search.categories')",
                            endpoint: "{{ route('admin.catalog.categories.search') }}"
                        },

                        customers: {
                            key: 'customers',
                            title: "@lang('dashboard::app.components.layouts.header.mega-search.customers')",
        ...
        <x-dashboard::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
            ...
            <x-slot:content class="min-w-[250px] max-w-[250px] !p-0">
                ...
                <div class="border-b p-3 text-base font-semibold text-gray-600 dark:border-gray-800 dark:text-gray-300">
                    @lang('dashboard::app.notifications.title', ['read' => 0])
                </div>
                ...
                <div class="flex h-[47px] justify-between gap-1.5 border-t px-6 py-4 dark:border-gray-800">
                    <a
                        ...
                        class="cursor-pointer text-xs font-semibold text-blue-600 transition-all hover:underline"
                    >
                        @lang('dashboard::app.notifications.view-all')
                    </a>
                    ...
                    <a
                        ...
                        @click="readAll()"
                    >
                        @lang('dashboard::app.notifications.read-all')
                    </a>
                </div>
            </x-slot>
        </x-dashboard::dropdown>
                    ...
                    return {
                        ...
                        ordertype: {
                            pending: {
                                ...
                                message: "@lang('dashboard::app.notifications.order-status-messages.pending-payment')"
                            },

                            processing: {
                                icon: 'icon-processing',
                                message: "@lang('dashboard::app.notifications.order-status-messages.processing')",
                            },

                            canceled: {
                                icon: 'icon-cancel-1',
                                message: "@lang('dashboard::app.notifications.order-status-messages.canceled')"
                            },

                            completed: {
                                icon: 'icon-done',
                                message: "@lang('dashboard::app.notifications.order-status-messages.completed')"
                            },

                            closed: {
                                icon: 'icon-cancel-1',
                                message: "@lang('dashboard::app.notifications.order-status-messages.closed')"
                            },
                        ...
                        orderTypeMessages: {
                            {{ \Webkul\Sales\Models\Order::STATUS_PENDING }}: "@lang('dashboard::app.notifications.order-status-messages.pending')",
                            {{ \Webkul\Sales\Models\Order::STATUS_CANCELED }}: "@lang('dashboard::app.notifications.order-status-messages.canceled')",
                            {{ \Webkul\Sales\Models\Order::STATUS_CLOSED }}: "@lang('dashboard::app.notifications.order-status-messages.closed')",
                            {{ \Webkul\Sales\Models\Order::STATUS_COMPLETED }}: "@lang('dashboard::app.notifications.order-status-messages.completed')",
                            {{ \Webkul\Sales\Models\Order::STATUS_PROCESSING }}: "@lang('dashboard::app.notifications.order-status-messages.processing')",
                            {{ \Webkul\Sales\Models\Order::STATUS_PENDING_PAYMENT }}: "@lang('dashboard::app.notifications.order-status-messages.pending-payment')",
                        }
                    }
                },
