...
<head>
    {!! view_render_event('rehla.dashboard.layout.head.before') !!}
    ...
    @rehlaVite(['src/Resources/assets/css/app.css', 'src/Resources/assets/js/app.js'])
    ...
    {!! view_render_event('rehla.dashboard.layout.head.after') !!}
</head>

<body class="h-full dark:bg-gray-950">
    {!! view_render_event('rehla.dashboard.layout.body.before') !!}
    ...
    >
        ...
        {!! view_render_event('rehla.dashboard.layout.content.before') !!}

        <!-- Page Header Blade Component -->
        <x-dashboard::layouts.header />
            ...
            <div class="flex min-h-[calc(100vh-62px)] max-w-full flex-1 flex-col bg-white transition-all duration-300 dark:bg-gray-950 pt-3 px-2 sm:px-4 lg:pt-3 lg:px-4 lg:ltr:pl-[286px] lg:group-[.sidebar-collapsed]/container:ltr:pl-[85px] lg:rtl:pr-[286px] lg:group-[.sidebar-collapsed]/container:rtl:pr-[85px]">
                ...
                <div class="mt-auto">
                    <div class="border-t bg-white py-2 text-center text-xs sm:text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-white">
                        @lang('dashboard::app.components.layouts.powered-by.description', [
        ...
        {!! view_render_event('rehla.dashboard.layout.content.after') !!}
    </div>

    {!! view_render_event('rehla.dashboard.layout.body.after') !!}

    @stack('scripts')

    {!! view_render_event('rehla.dashboard.layout.vue-app-mount.before') !!}
    ...
    {!! view_render_event('rehla.dashboard.layout.vue-app-mount.after') !!}
</body>
