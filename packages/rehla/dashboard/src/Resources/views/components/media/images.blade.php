...
<v-media-images
    ...
    :errors="errors"
>
    <x-dashboard::shimmer.image class="h-[110px] w-[110px] rounded" />
</v-media-images>
                    ...
                    >
                        <div class="flex flex-col items-center">
                            ...
                            <p class="grid text-center text-sm font-semibold text-blue-600">
                                @lang('dashboard::app.components.media.images.ai-add-image-btn')
                                
                                <span class="text-xs">
                                    @lang('dashboard::app.components.media.images.ai-btn-info')
                                </span>
                            </p>
                        </div>
                    </label>
                    ...
                    >
                        <div class="flex flex-col items-center">
                            ...
                            <p class="grid text-center text-sm font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.components.media.images.add-image-btn')
                                
                                <span class="text-xs">
                                    @lang('dashboard::app.components.media.images.allowed-types')
                                </span>
                            </p>
                                ...
                                <x-slot:header>
                                    <template v-if="! ai.images.length">
                                        <p class="flex items-center gap-2.5 text-lg font-bold text-gray-800 dark:text-white">
                                            ...
                                            @lang('dashboard::app.components.media.images.ai-generation.title')
                                        </p>
                                    </template>
                                    ...
                                    <div v-show="! ai.images.length">
                                        ...
                                        <x-dashboard::form.control-group>
                                            <x-dashboard::form.control-group.label class="required">
                                                @lang('dashboard::app.components.media.images.ai-generation.prompt')
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.prompt"
                                                :label="trans('dashboard::app.components.media.images.ai-generation.prompt')"
                                            />

                                            <x-dashboard::form.control-group.error control-name="prompt" />
                                        </x-dashboard::form.control-group>

                                        <x-dashboard::form.control-group>
                                            <x-dashboard::form.control-group.label class="required">
                                                @lang('dashboard::app.components.media.images.ai-generation.number-of-images')
                                            </x-dashboard::form.control-group.label>
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.n"
                                                :label="trans('dashboard::app.components.media.images.ai-generation.number-of-images')"
                                            />

                                            <x-dashboard::form.control-group.error control-name="n" />
                                        </x-dashboard::form.control-group>

                                        <x-dashboard::form.control-group>
                                            <x-dashboard::form.control-group.label class="required">
                                                @lang('dashboard::app.components.media.images.ai-generation.size')
                                            </x-dashboard::form.control-group.label>
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.size"
                                                :label="trans('dashboard::app.components.media.images.ai-generation.size')"
                                            >
                                                <option value="1:1">
                                                    @lang('dashboard::app.components.media.images.ai-generation.square')
                                                </option>

                                                <option value="2:3">
                                                    @lang('dashboard::app.components.media.images.ai-generation.portrait')
                                                </option>

                                                <option value="3:2">
                                                    @lang('dashboard::app.components.media.images.ai-generation.landscape')
                                                </option>
                                            </x-dashboard::form.control-group.control>

                                            <x-dashboard::form.control-group.error control-name="size" />
                                        </x-dashboard::form.control-group>

                                        <x-dashboard::form.control-group>
                                            <x-dashboard::form.control-group.label class="required">
                                                @lang('dashboard::app.components.media.images.ai-generation.quality')
                                            </x-dashboard::form.control-group.label>
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                rules="required"
                                                v-model="ai.quality"
                                                :label="trans('dashboard::app.components.media.images.ai-generation.quality')"
                                            >
                                                <option value="high">
                                                    @lang('dashboard::app.components.media.images.ai-generation.high')
                                                </option>

                                                <option value="medium">
                                                    @lang('dashboard::app.components.media.images.ai-generation.medium')
                                                </option>

                                                <option value="low">
                                                    @lang('dashboard::app.components.media.images.ai-generation.low')
                                                </option>
                                            </x-dashboard::form.control-group.control>

                                            <x-dashboard::form.control-group.error control-name="quality" />
                                        </x-dashboard::form.control-group>

                                        <!-- Model Select -->
                                        <x-dashboard::form.control-group v-if="ai.models && ai.models.length">
                                            <x-dashboard::form.control-group.label>
                                                @lang('dashboard::app.components.media.images.ai-generation.model')
                                            </x-dashboard::form.control-group.label>
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                name="model"
                                                v-model="ai.model"
                                                :label="trans('dashboard::app.components.media.images.ai-generation.model')"
                                            >
                                                <option
                                            ...
                                            <x-dashboard::form.control-group.error control-name="model" />
                                        </x-dashboard::form.control-group>
                                    </div>
                                        ...
                                        <template v-if="! ai.images.length">
                                            <button class="secondary-button">
                                                ...
                                                <template v-if="isLoading">
                                                    ...
                                                    @lang('dashboard::app.components.media.images.ai-generation.generating')
                                                </template>

                                                <template v-else>
                                                    <span class="icon-magic text-blue-600"></span>
                                                    
                                                    @lang('dashboard::app.components.media.images.ai-generation.generate')
                                                </template>
                                            </button>
                                        </template>
                                        ...
                                        <template v-else>
                                            <button class="secondary-button">
                                                ...
                                                <template v-if="isLoading">
                                                    ...
                                                    @lang('dashboard::app.components.media.images.ai-generation.regenerating')
                                                </template>

                                                <template v-else>
                                                    <span class="icon-magic text-2xl text-blue-600"></span>
                                                    
                                                    @lang('dashboard::app.components.media.images.ai-generation.regenerate')
                                                </template>
                                            </button>
                                            ...
                                            <x-dashboard::button
                                                ...
                                                :title="trans('dashboard::app.components.media.images.ai-generation.apply')"
            ...
            >
                <x-slot:header>
                    <p class="text-lg font-bold text-gray-800 dark:text-white">
                        @lang('dashboard::app.components.media.images.seo.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.components.media.images.seo.info')
                    </p>
                </x-slot>
                ...
                <x-slot:content>
                    ...
                    <div class="mb-4">
                        <x-dashboard::form.control-group.label>
                            @lang('dashboard::app.components.media.images.seo.alt-text')
                        </x-dashboard::form.control-group.label>

                        <input
                            type="text"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400 dark:focus:border-gray-400"
                            :placeholder="@js(trans('dashboard::app.components.media.images.seo.alt-text-placeholder'))"
                            v-model="image.alt_text"
                        />

                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">
                            @lang('dashboard::app.components.media.images.seo.alt-text-info')
                        </p>
                    </div>
                    ...
                    <div class="mb-4">
                        <x-dashboard::form.control-group.label>
                            @lang('dashboard::app.components.media.images.seo.file-name')
                        </x-dashboard::form.control-group.label>

                        <input
                            type="text"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400 dark:focus:border-gray-400"
                            :placeholder="@js(trans('dashboard::app.components.media.images.seo.file-name-placeholder'))"
                            v-model="image.file_name"
                        />

                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">
                            @lang('dashboard::app.components.media.images.seo.file-name-info')
                        </p>
                    </div>
                    ...
                    <div>
                        <x-dashboard::form.control-group.label>
                            @lang('dashboard::app.components.media.images.seo.replace')
                        </x-dashboard::form.control-group.label>
                        ...
                        <label
                            ...
                            :for="$.uid + '_imageInput_' + index"
                        >
                            @lang('dashboard::app.components.media.images.seo.replace-btn')
                        </label>

                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">
                            @lang('dashboard::app.components.media.images.seo.replace-info')
                        </p>
                    </div>
                </x-slot>
                ...
                <x-slot:footer>
                    <div class="flex justify-end px-3">
                        ...
                        >
                            @lang('dashboard::app.components.media.images.seo.done-btn')
                        </button>
                    </div>
                </x-slot>
            </x-dashboard::drawer>
        ...
        app.component('v-media-images', {
            ...
            data() {
                return {
                    ...
                    placeholders: [
                        {
                            label: "@lang('dashboard::app.components.media.images.placeholders.front')",
                            image: "{{ bagisto_asset('images/product-placeholders/front.svg') }}"
                        }, {
                            label: "@lang('dashboard::app.components.media.images.placeholders.next')",
                            image: "{{ bagisto_asset('images/product-placeholders/next-1.svg') }}"
                        }, {
                            label: "@lang('dashboard::app.components.media.images.placeholders.next')",
                            image: "{{ bagisto_asset('images/product-placeholders/next-2.svg') }}"
                        }, {
                            label: "@lang('dashboard::app.components.media.images.placeholders.zoom')",
                            image: "{{ bagisto_asset('images/product-placeholders/zoom.svg') }}"
                        }, {
                            label: "@lang('dashboard::app.components.media.images.placeholders.use-cases')",
                            image: "{{ bagisto_asset('images/product-placeholders/use-cases.svg') }}"
                        }, {
                            label: "@lang('dashboard::app.components.media.images.placeholders.size')",
                ...
                add() {
                    ...
                    if (! validFiles) {
                        this.$emitter.emit('add-flash', {
                            type: 'warning',
                            message: "@lang('dashboard::app.components.media.images.not-allowed-error')"
                        });
