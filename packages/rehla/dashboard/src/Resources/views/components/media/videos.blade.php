                ...
                >
                    <div class="flex flex-col items-center">
                        ...
                        <p class="grid text-center text-sm font-semibold text-gray-600 dark:text-gray-300">
                            @lang('dashboard::app.components.media.videos.add-video-btn')
                            
                            <span class="text-xs">
                                @lang('dashboard::app.components.media.videos.allowed-types')
                            </span>
                        </p>
            ...
            >
                <x-slot:header>
                    <p class="text-lg font-bold text-gray-800 dark:text-white">
                        @lang('dashboard::app.components.media.videos.seo.title')
                    </p>

                    <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                        @lang('dashboard::app.components.media.videos.seo.info')
                    </p>
                </x-slot>
                ...
                add() {
                    ...
                    if (! validFiles) {
                        this.$emitter.emit('add-flash', {
                            type: 'warning',
                            message: "@lang('dashboard::app.components.media.videos.not-allowed-error')"
                        });
