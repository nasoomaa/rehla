...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-modal-confirm', {
            ...
            methods: {
                open({
                    title = "@lang('dashboard::app.components.modal.confirm.title')",
                    message = "@lang('dashboard::app.components.modal.confirm.message')",
                    options = {
                        btnDisagree: "@lang('dashboard::app.components.modal.confirm.disagree-btn')",
                        btnAgree: "@lang('dashboard::app.components.modal.confirm.agree-btn')",
                    },
                    agree = () => {},
                    disagree = () => {},
                }) {
