                ...
                <div class="grid gap-3">
                    <div class="flex items-center justify-between">
                        <p class="text-xl font-medium dark:text-white">
                            @lang('dashboard::app.components.products.search.title')
                        </p>
                        ...
                        <div
                            ...
                            @click="addSelected"
                        >
                            @lang('dashboard::app.components.products.search.add-btn')
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="flex gap-2.5">
                            ...
                            >
                                <template v-if="! product.images.length">
                                    ...
                                    <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                                        @lang('dashboard::app.components.products.search.product-image')
                                    </p>
                                </template>
                            ...
                            <div class="grid place-content-start gap-1.5">
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('dashboard::app.components.products.search.sku')".replace(':sku', product.sku) }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid place-content-start gap-1 text-right">
                            ...
                            <p class="text-green-600">
                                @{{ "@lang('dashboard::app.components.products.search.qty')".replace(':qty', totalQty(product)) }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('dashboard::app.components.products.search.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('dashboard::app.components.products.search.empty-info')
                        </p>
                    </div>
                </div>
            </x-slot>
