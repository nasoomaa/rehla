...
<div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
        ...
        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
            ...
            <div>
                ...
                <div class="table-responsive box-shadow mt-4 grid w-full overflow-hidden rounded bg-white dark:bg-gray-900">
                    ...
                    <x-dashboard::shimmer.datagrid.table.head :isMultiRow="true" />

                    <x-dashboard::shimmer.datagrid.table.body :isMultiRow="true" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
        <div class="box-shadow rounded bg-white dark:bg-gray-900">
            <x-dashboard::shimmer.accordion class="!h-[200px]" />
        </div>

        <div class="box-shadow rounded bg-white dark:bg-gray-900">
            <x-dashboard::shimmer.accordion />
        </div>
    </div>
</div>