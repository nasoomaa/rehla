    ...
    >
        ...
        >
            <form @submit="handleSubmit($event, generate)">
                ...
                <x-dashboard::modal ref="magicAIModal">
                    <!-- Modal Header -->
                    <x-slot:header>
                        <p class="flex items-center gap-2.5 text-lg font-bold text-gray-800 dark:text-white">
                            ...
                            @lang('dashboard::app.components.tinymce.ai-generation.title')
                        </p>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-dashboard::form.control-group>
                            <x-dashboard::form.control-group.label class="required">
                                @lang('dashboard::app.components.tinymce.ai-generation.prompt')
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                rules="required"
                                v-model="ai.prompt"
                                :label="trans('dashboard::app.components.tinymce.ai-generation.prompt')"
                            />
                        ...
                        <x-dashboard::form.control-group v-if="ai.models && ai.models.length">
                            <x-dashboard::form.control-group.label>
                                @lang('dashboard::app.components.tinymce.ai-generation.model')
                            </x-dashboard::form.control-group.label>
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                name="model"
                                v-model="ai.model"
                                :label="trans('dashboard::app.components.tinymce.ai-generation.model')"
                            >
                                <option
                        ...
                        <div class="flex items-center gap-x-2.5">
                            ...
                            >
                                ...
                                <template v-if="isLoading">
                                    ...
                                    @lang('dashboard::app.components.tinymce.ai-generation.generating')
                                </template>

                                <template v-else>
                                    <span class="icon-magic text-2xl text-blue-600"></span>

                                    @lang('dashboard::app.components.tinymce.ai-generation.generate')
                                </template>
                            </button>
                        </div>

                        <!-- Generated Content -->
                        <x-dashboard::form.control-group class="mt-5">
                            <x-dashboard::form.control-group.label class="text-left">
                                @lang('dashboard::app.components.tinymce.ai-generation.generated-content')
                            </x-dashboard::form.control-group.label>
                            ...
                            <span class="text-xs text-gray-500">
                                @lang('dashboard::app.components.tinymce.ai-generation.generated-content-info')
                            </span>
                        </x-dashboard::form.control-group>
                    </x-slot>
                    ...
                    let tinyMCEHelper = {
                        ...
                        uploadImageHandler: function(config, blobInfo, resolve, reject, progress) {
                            ...
                            xhr.onload = function() {
                                ...
                                if (xhr.status === 403) {
                                    reject("@lang('dashboard::app.components.tinymce.errors.http-error')", {
                                        remove: true
                                    });
                                ...
                                if (! json || typeof json.location != 'string') {
                                    reject("@lang('dashboard::app.components.tinymce.errors.invalid-json')" + xhr.responseText);
                            ...
                            xhr.onerror = (()=>reject("@lang('dashboard::app.components.tinymce.errors.upload-failed')"));
                    ...
                    tinyMCEHelper.initTinyMCE({
                        ...
                        setup: editor => {
                            ...
                            editor.ui.registry.addButton('aibutton', {
                                text: "@lang('dashboard::app.components.tinymce.ai-btn-tile')",
                                icon: 'magic',
