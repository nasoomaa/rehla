@php
    $clearActions = [
        'clear-all'      => trans('dashboard::app.configuration.index.cache-management.actions.clear-all'),
        'clear-config'   => trans('dashboard::app.configuration.index.cache-management.actions.clear-config'),
        'clear-cache'    => trans('dashboard::app.configuration.index.cache-management.actions.clear-cache'),
        'clear-compiled' => trans('dashboard::app.configuration.index.cache-management.actions.clear-compiled'),
        'clear-events'   => trans('dashboard::app.configuration.index.cache-management.actions.clear-events'),
        'clear-routes'   => trans('dashboard::app.configuration.index.cache-management.actions.clear-routes'),
        'clear-views'    => trans('dashboard::app.configuration.index.cache-management.actions.clear-views'),
    ];

    $buildActions = [
        'build-all'    => trans('dashboard::app.configuration.index.cache-management.actions.build-all'),
        'build-config' => trans('dashboard::app.configuration.index.cache-management.actions.build-config'),
        'build-routes' => trans('dashboard::app.configuration.index.cache-management.actions.build-routes'),
        'build-views'  => trans('dashboard::app.configuration.index.cache-management.actions.build-views'),
    ];
@endphp
        ...
        <div>
            ...
            <div class="mb-4 rounded border border-amber-200 bg-amber-50 p-3 dark:border-amber-800 dark:bg-amber-900/20">
                <p class="mb-1 text-sm font-semibold text-amber-800 dark:text-amber-300">
                    @lang('dashboard::app.configuration.index.cache-management.warning-title')
                </p>

                <ul class="list-disc pl-5 text-xs text-amber-700 dark:text-amber-400">
                    <li>@lang('dashboard::app.configuration.index.cache-management.warning-route-closures')</li>
                    <li>@lang('dashboard::app.configuration.index.cache-management.warning-config-closures')</li>
                    <li>@lang('dashboard::app.configuration.index.cache-management.warning-permissions')</li>
                </ul>
            </div>
            ...
            <div class="mb-4">
                <p class="mb-3 text-sm font-semibold text-gray-800 dark:text-white">
                    @lang('dashboard::app.configuration.index.cache-management.clear-cache-title')
                </p>

                <p class="mb-3 text-xs text-gray-600 dark:text-gray-300">
                    @lang('dashboard::app.configuration.index.cache-management.clear-cache-info')
                </p>
            ...
            <div class="mb-4">
                <p class="mb-3 text-sm font-semibold text-gray-800 dark:text-white">
                    @lang('dashboard::app.configuration.index.cache-management.build-cache-title')
                </p>

                <p class="mb-3 text-xs text-gray-600 dark:text-gray-300">
                    @lang('dashboard::app.configuration.index.cache-management.build-cache-info')
                </p>
            ...
            <div class="overflow-hidden rounded border dark:border-gray-800">
                <div class="flex items-center justify-between border-b bg-gray-50 px-3 py-2 dark:border-gray-800 dark:bg-gray-900">
                    <p class="text-xs font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.configuration.index.cache-management.console-title')
                    </p>

                    <div class="flex items-center gap-3">
                        <span class="text-[11px] text-gray-500 dark:text-gray-400">
                            @{{ logs.length }} @lang('dashboard::app.configuration.index.cache-management.console-entries')
                        </span>
                        ...
                        <button
                            ...
                            v-if="logs.length"
                        >
                            @lang('dashboard::app.configuration.index.cache-management.clear-console')
                        </button>
                    </div>
                </div>
                ...
                >
                    ...
                    <div
                        ...
                        v-if="! logs.length"
                    >
                        @lang('dashboard::app.configuration.index.cache-management.console-empty')
                    </div>
                ...
                executeAction(action, label) {
                    ...
                    this.$axios.post("{{ route('admin.configuration.cache-management.execute') }}", {
                        ...
                        .catch((error) => {
                            ...
                            logEntry.command = data.command || action;
                            logEntry.message = data.message || '@lang("dashboard::app.configuration.index.cache-management.console-unknown-error")';
                            logEntry.output = data.output || '';
