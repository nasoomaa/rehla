...
@pushOnce('scripts')
    ...
    >
        <x-dashboard::form.control-group class="last:!mb-0">
            ...
            >
                <x-dashboard::form.control-group.label ::for="name">
            ...
            <template v-if="field.type == 'image' && field.is_visible">
                ...
                <template v-if="value">
                    <x-dashboard::form.control-group class="mt-1.5 flex w-max cursor-pointer select-none items-center gap-1.5">
                        <x-dashboard::form.control-group.control
                            type="checkbox"
                            ::id="`${name}[delete]`"
                            ::name="`${name}[delete]`"
                        ...
                        >
                            @lang('dashboard::app.configuration.index.delete')
                        </label>
            ...
            <template v-if="field.type == 'country' && field.is_visible">
                <v-country :selected-country="value">
                    <template v-slot:default="{ changeCountry }">
                        <x-dashboard::form.control-group class="flex">
                            <x-dashboard::form.control-group.control
                                type="select"
                                ::id="name"
                                ::name="name"
                            ...
                            >
                                <option value="">
                                    @lang('dashboard::app.configuration.index.select-country')
                                </option>
                        ...
                        <div v-if="isStateComponenetLoaded">
                            <template v-if="haveStates()">
                                <x-dashboard::form.control-group class="flex">
                                    ...
                                    >
                                        <option value="">
                                            @lang('dashboard::app.configuration.index.select-state')
                                        </option>
