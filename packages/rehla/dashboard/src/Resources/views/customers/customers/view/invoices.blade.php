<div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
    <p class="text-base font-semibold leading-none text-gray-800 dark:text-white">
        @lang('dashboard::app.customers.customers.view.invoices.count', ['count' => count($customer->invoices)])
    </p>
                ...
                >
                    ...
                    >
                        <div class="flex flex-col gap-1.5">
                            <!-- Id -->
                            <p class="text-gray-600 dark:text-gray-300">
                                @{{ "@lang('dashboard::app.customers.customers.view.invoices.increment-id')".replace(':increment_id', record.id) }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                        ...
                        <div class="flex flex-col items-center">
                            <p class="text-base font-semibold text-gray-400">
                                @lang('dashboard::app.customers.customers.view.datagrid.invoices.empty-invoice')
                            </p>
                        </div>
                    </div>
                </div>
