<div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
    <div class="flex justify-between">
        ...
        <p class="text-base font-semibold leading-none text-gray-800 dark:text-white">
            @lang('dashboard::app.customers.customers.view.orders.count', ['count' => count($customer->orders)])
        </p>

        <!-- Total Order Revenue -->
        <p class="text-base font-semibold leading-none text-gray-800 dark:text-white">
            @lang('dashboard::app.customers.customers.view.orders.total-revenue', ['revenue' => core()->formatPrice($customer->orders->whereNotIn('status', ['canceled', 'closed'])->sum('base_grand_total_invoiced'))])
        </p>
    </div>
                    ...
                    <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                        ...
                        <div class="flex flex-col items-center">
                            <p class="text-base font-semibold text-gray-400">
                                @lang('dashboard::app.customers.customers.view.datagrid.orders.empty-order')
                            </p>
                        </div>
                    </div>
                </div>
