<div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
    <div class="flex justify-between">
        ...
        <p class="text-base font-semibold leading-none text-gray-800 dark:text-white">
            @lang('dashboard::app.customers.customers.view.reviews.count', ['count' => count($customer->reviews)])
        </p>
    </div>
                ...
                >
                    <div class="flex justify-start [&amp;>*]:flex-1">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <!-- Review ID -->
                            <p class="text-gray-600 dark:text-gray-300">
                                @{{ "@lang('dashboard::app.customers.customers.view.reviews.id')".replace(':id', record.product_review_id) }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                        ...
                        <div class="flex flex-col items-center">
                            <p class="text-base font-semibold text-gray-400">
                                @lang('dashboard::app.customers.customers.view.datagrid.reviews.empty-reviews')
                            </p>
                        </div>
                    </div>
                </div>
