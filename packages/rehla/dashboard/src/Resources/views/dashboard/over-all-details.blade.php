...
<v-dashboard-overall-details>
    <!-- Shimmer -->
    <x-dashboard::shimmer.dashboard.over-all-details />
</v-dashboard-overall-details>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                ...
                                title="@lang('dashboard::app.dashboard.index.total-sales')"
                            >
                        </div>
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.dashboard.index.total-sales')
                            </p>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                ...
                                title="@lang('dashboard::app.dashboard.index.total-orders')"
                            >
                        </div>
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.dashboard.index.total-orders')
                            </p>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                ...
                                title="@lang('dashboard::app.dashboard.index.total-customers')"
                            >
                        </div>
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.dashboard.index.total-customers')
                            </p>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                ...
                                title="@lang('dashboard::app.dashboard.index.average-sale')"
                            >
                        </div>
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.dashboard.index.average-sale')
                            </p>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                ...
                                title="@lang('dashboard::app.dashboard.index.total-unpaid-invoices')"
                            >
                        </div>
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.dashboard.index.total-unpaid-invoices')
                            </p>
                        </div>
                    </div>
                </div>
