...
<v-dashboard-todays-details>
    <!-- Shimmer -->
    <x-dashboard::shimmer.dashboard.todays-details />
</v-dashboard-todays-details>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                ...
                                title="@lang('dashboard::app.dashboard.index.today-sales')"
                            >
                        </div>
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.dashboard.index.today-sales')
                            </p>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                ...
                                title="@lang('dashboard::app.dashboard.index.today-orders')"
                            >
                        </div>
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.dashboard.index.today-orders')
                            </p>
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                ...
                                title="@lang('dashboard::app.dashboard.index.today-customers')"
                            >
                        </div>
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.dashboard.index.today-customers')
                            </p>
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="flex min-w-[180px] flex-1 gap-2.5">
                            <div class="flex flex-col gap-1.5">
                                <!-- Order Id -->
                                <p class="text-base font-semibold leading-none text-gray-800 dark:text-white">
                                    @{{ "@lang('dashboard::app.dashboard.index.order-id', ['id' => ':replace'])".replace(':replace', order.increment_id) }}
                                </p>
