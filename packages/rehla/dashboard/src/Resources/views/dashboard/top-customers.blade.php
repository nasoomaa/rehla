...
<v-dashboard-top-customers>
    <!-- Shimmer -->
    <x-dashboard::shimmer.dashboard.top-customers />
</v-dashboard-top-customers>
            ...
            <div class="border-b dark:border-gray-800">
                <div class="flex items-center justify-between p-4">
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.dashboard.index.customer-with-most-sales')
                    </p>
                        ...
                        <div class="flex justify-between gap-1.5">
                            ...
                            <div class="flex flex-col">
                                ...
                                <p class="text-gray-600 dark:text-gray-300" v-if="customer.orders">
                                    @{{ "@lang('dashboard::app.dashboard.index.order-count')".replace(':count', customer.orders) }}
                                </p>
                            </div>
                        </div>
                    </a>
                    ...
                    <div class="grid justify-center justify-items-center gap-3.5 py-2.5">
                        ...
                        <div class="flex flex-col items-center">
                            <p class="text-base font-semibold text-gray-400">
                                @lang('dashboard::app.dashboard.index.add-customer')
                            </p>

                            <p class="text-gray-400">
                                @lang('dashboard::app.dashboard.index.customer-info')
                            </p>
                        </div>
                    </div>
                </div>
