...
<v-dashboard-top-selling-products>
    <!-- Shimmer -->
    <x-dashboard::shimmer.dashboard.top-selling-products />
</v-dashboard-top-selling-products>
            ...
            <div class="border-b dark:border-gray-800">
                <div class="flex items-center justify-between p-4">
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.dashboard.index.top-selling-products')
                    </p>
                    ...
                    <div class="grid justify-center justify-items-center gap-3.5 py-2.5">
                        ...
                        <div class="flex flex-col items-center">
                            <p class="text-base font-semibold text-gray-400">
                                @lang('dashboard::app.dashboard.index.add-product')
                            </p>

                            <p class="text-gray-400">
                                @lang('dashboard::app.dashboard.index.product-info')
                            </p>
                        </div>
                    </div>
                </div>
