...
<div style="margin-bottom: 34px;">
    <p style="font-weight: bold;font-size: 20px;color: #121A26;line-height: 24px;margin-bottom: 24px">
        @lang('dashboard::app.emails.dear', ['admin_name' => $userName]), 👋
    </p>

    <p style="font-size: 16px;color: #384860;line-height: 24px;">
        @lang('dashboard::app.emails.admin.forgot-password.greeting')
    </p>
</div>

<p style="font-size: 16px;color: #384860;line-height: 24px;margin-bottom: 40px">
    @lang('dashboard::app.emails.admin.forgot-password.description')
</p>
...
<div style="display: flex;margin-bottom: 95px">
    ...
    >
        @lang('dashboard::app.emails.admin.forgot-password.reset-password')
    </a>
</div>
@endcomponent