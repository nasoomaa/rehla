@component('admin::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            @lang('dashboard::app.emails.orders.inventory-source.title')
        </span> <br>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('dashboard::app.emails.dear', ['admin_name' => $shipment->inventory_source->contact_name]),👋
        </p>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('dashboard::app.emails.orders.inventory-source.greeting', [
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        @lang('dashboard::app.emails.orders.inventory-source.summary')
    </div>
    ...
    <div style="display: flex;flex-direction: row;margin-top: 20px;justify-content: space-between;margin-bottom: 40px;">
        @if ($shipment->order->shipping_address)
            <div style="line-height: 25px;">
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    @lang('dashboard::app.emails.orders.shipping-address')
                </div>
                ...
                <div style="font-size: 16px;font-weight: 400;color: #384860;margin-bottom: 40px;">
                    ...
                    @lang('dashboard::app.emails.orders.contact') : {{ $shipment->order->billing_address->phone }}
                </div>

                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    @lang('dashboard::app.emails.orders.shipping')
                </div>
                ...
                <div style="font-size: 16px; color: #384860;">
                    <div>
                        <span>@lang('dashboard::app.emails.orders.carrier') : </span>

                        {{ $shipment->carrier_title }}
                    </div>

                    <div>
                        <span>@lang('dashboard::app.emails.orders.tracking-number') : </span>
        ...
        @if ($shipment->order->billing_address)
            <div style="line-height: 25px;">
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    @lang('dashboard::app.emails.orders.billing-address')
                </div>
                ...
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    @lang('dashboard::app.emails.orders.payment')
                </div>
        ...
        border-spacing: 0;width: 100%">
            <thead>
                <tr style="color: #121A26;border-top: 1px solid #CBD5E1;border-bottom: 1px solid #CBD5E1;">
                    <th style="text-align: left;padding: 15px">@lang('dashboard::app.emails.orders.sku')</th>
                    <th style="text-align: left;padding: 15px">@lang('dashboard::app.emails.orders.name')</th>
                    <th style="text-align: left;padding: 15px">@lang('dashboard::app.emails.orders.price')</th>
                    <th style="text-align: left;padding: 15px">@lang('dashboard::app.emails.orders.qty')</th>
                </tr>
            </thead>
