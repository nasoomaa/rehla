@component('admin::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            {{ trans('dashboard::app.emails.orders.invoiced.title') }}
        </span> <br>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            {{ trans('dashboard::app.emails.dear', ['admin_name' => core()->getAdminEmailDetails()['name']]) }},👋
        </p>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('dashboard::app.emails.orders.invoiced.greeting', [
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        {{ trans('dashboard::app.emails.orders.invoiced.summary') }}
    </div>
    ...
    <div style="display: flex;flex-direction: row;margin-top: 20px;justify-content: space-between;margin-bottom: 40px;">
        @if ($invoice->order->shipping_address)
            <div style="line-height: 25px;">
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    {{ trans('dashboard::app.emails.orders.shipping-address') }}
                </div>
                ...
                <div style="font-size: 16px;font-weight: 400;color: #384860;margin-bottom: 40px;">
                    ...
                    {{ trans('dashboard::app.emails.orders.contact') }} : {{ $invoice->order->billing_address->phone }}
                </div>

                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    {{ trans('dashboard::app.emails.orders.shipping') }}
                </div>
        ...
        @if ($invoice->order->billing_address)
            <div style="line-height: 25px;">
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    {{ trans('dashboard::app.emails.orders.billing-address') }}
                </div>
                ...
                <div style="font-size: 16px;font-weight: 600;color: #121A26;">
                    {{ trans('dashboard::app.emails.orders.payment') }}
                </div>
        ...
        border-spacing: 0;width: 100%">
            <thead>
                <tr style="color: #121A26;border-top: 1px solid #CBD5E1;border-bottom: 1px solid #CBD5E1;">
                    <th style="text-align: left;padding: 15px">{{ trans('dashboard::app.emails.orders.sku') }}</th>
                    <th style="text-align: left;padding: 15px">{{ trans('dashboard::app.emails.orders.name') }}</th>
                    <th style="text-align: left;padding: 15px">{{ trans('dashboard::app.emails.orders.price') }}</th>
                    <th style="text-align: left;padding: 15px">{{ trans('dashboard::app.emails.orders.qty') }}</th>
                </tr>
            </thead>
                        ...
                        <td style="display: flex;flex-direction: column;text-align: left;padding: 15px">
                            ...
                            @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                ...
                                <span style="font-size: 12px; white-space: nowrap">
                                    @lang('dashboard::app.emails.orders.excl-tax')
    ...
    <div style="display: grid;justify-content: end;font-size: 16px;color: #384860;line-height: 30px;padding-top: 20px;padding-bottom: 20px;">
        @if (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'including_tax')
            <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>
                    @lang('dashboard::app.emails.orders.subtotal')
                </span>
        ...
        @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
            <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>
                    @lang('dashboard::app.emails.orders.subtotal-excl-tax')
                </span>
            ...
            <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>
                    @lang('dashboard::app.emails.orders.subtotal-incl-tax')
                </span>
        ...
        @if ($invoice->order->shipping_address)
            @if (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'including_tax')
                <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                    <span>
                        @lang('dashboard::app.emails.orders.shipping-handling')
                    </span>
            ...
            @elseif (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both')
                <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                    <span>
                        @lang('dashboard::app.emails.orders.shipping-handling-excl-tax')
                    </span>
                ...
                <div style="display: grid;gap: 20px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                    <span>
                        @lang('dashboard::app.emails.orders.shipping-handling-incl-tax')
                    </span>
        ...
        <div style="display: grid;gap: 100px;grid-template-columns: repeat(2, minmax(0, 1fr));">
            <span>
                @lang('dashboard::app.emails.orders.tax')
            </span>
        ...
        @if ($invoice->discount_amount > 0)
            <div style="display: grid;gap: 100px;grid-template-columns: repeat(2, minmax(0, 1fr));">
                <span>{{ trans('dashboard::app.emails.orders.discount') }}</span>
        ...
        <div style="display: grid;gap: 100px;grid-template-columns: repeat(2, minmax(0, 1fr));font-weight: bold">
            <span>{{ trans('dashboard::app.emails.orders.grand-total') }}</span>
