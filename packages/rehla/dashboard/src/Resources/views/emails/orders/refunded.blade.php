@component('admin::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            {{ trans('dashboard::app.emails.orders.refunded.title') }}
        </span> <br>
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('dashboard::app.emails.orders.refunded.greeting', [
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        {{ trans('dashboard::app.emails.orders.refunded.summary') }}
    </div>
        ...
        @if ($refund->order->shipping_address)
            <div style="line-height: 25px;">
                ...
                <div style="font-size: 16px;font-weight: 400;color: #384860;margin-bottom: 40px;">
                    ...
                    {{ trans('dashboard::app.emails.orders.contact') }} : {{ $refund->order->billing_address->phone }}
                </div>
