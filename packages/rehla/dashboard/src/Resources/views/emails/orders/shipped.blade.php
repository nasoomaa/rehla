@component('admin::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            @lang('dashboard::app.emails.orders.shipped.title')
        </span> <br>
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('dashboard::app.emails.orders.shipped.greeting', [
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        @lang('dashboard::app.emails.orders.shipped.summary')
    </div>
        ...
        @if ($shipment->order->shipping_address)
            <div style="line-height: 25px;">
                ...
                <div style="font-size: 16px; color: #384860;">
                    ...
                    <div>
                        <span>
                            @lang('dashboard::app.emails.orders.tracking-number', ['tracking_number' => $shipment->track_number])
                        </span>
                    </div>
                </div>
