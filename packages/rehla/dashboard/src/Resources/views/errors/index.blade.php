<x-dashboard::layouts.anonymous>
    <!-- Page Title -->
    <x-slot:title>
        @lang("dashboard::app.errors.{$errorCode}.title")
    </x-slot>
        ...
        <div class="flex max-w-[745px] items-center gap-5">
            <div class="w-full">
                ...
                <p class="mb-6 text-sm text-gray-800">
                    @lang("dashboard::app.errors.{$errorCode}.description")
                </p>
                ...
                <div class="mb-6">
                    <div class="flex items-center gap-2.5">
                        ...
                        >
                            @lang('dashboard::app.errors.go-back')
                        </a>
                        ...
                        <a
                            ...
                            class="text-sm font-semibold text-blue-600 transition-all hover:underline"
                        >
                            @lang('dashboard::app.errors.dashboard')
                        </a>
                    </div>
                </div>

                <p class="text-sm text-gray-800">
                    @lang('dashboard::app.errors.support', [
