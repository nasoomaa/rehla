<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.help.index.title')
    </x-slot>

    @php
        $services = [
            [
                'title' => trans('dashboard::app.help.index.cloud-hosting'),
                'info'  => trans('dashboard::app.help.index.cloud-hosting-info'),
            ...
            [
                'title' => trans('dashboard::app.help.index.support'),
                'info'  => trans('dashboard::app.help.index.support-info'),
            ...
            [
                'title' => trans('dashboard::app.help.index.paid-services'),
                'info'  => trans('dashboard::app.help.index.paid-services-info'),
        ...
        $resources = [
            [
                'title' => trans('dashboard::app.help.index.extensions'),
                'info'  => trans('dashboard::app.help.index.extensions-info'),
            ...
            [
                'title' => trans('dashboard::app.help.index.docs'),
                'info'  => trans('dashboard::app.help.index.docs-info'),
            ...
            [
                'title' => trans('dashboard::app.help.index.api-docs'),
                'info'  => trans('dashboard::app.help.index.api-docs-info'),
    ...
    {!! view_render_event('rehla.dashboard.help.index.before') !!}
    ...
    <div class="grid gap-1.5 mb-8 max-w-3xl">
        ...
        <p class="!leading-relaxed text-gray-600 dark:text-gray-300">
            @lang('dashboard::app.help.index.description')
        </p>
    </div>
    ...
    <div class="mb-10">
        <p class="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-400 mb-4">
            @lang('dashboard::app.help.index.services-title')
        </p>

        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
            @foreach ($services as $card)
                @include('dashboard::help.card', ['card' => $card])
            @endforeach
        </div>
    </div>
    ...
    <div class="mb-10">
        <p class="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-400 mb-4">
            @lang('dashboard::app.help.index.resources-title')
        </p>
    ...
    <div class="flex flex-wrap items-center justify-between gap-5 rounded-xl bg-gradient-to-r from-blue-600 to-blue-800 px-7 py-6 shadow-lg">
        <div class="flex items-center gap-4">
            ...
            <div class="grid gap-0.5">
                <p class="text-lg font-bold !leading-snug text-white">
                    @lang('dashboard::app.help.index.cta-title')
                </p>

                <p class="!leading-snug text-white/80">
                    @lang('dashboard::app.help.index.cta-description')
                </p>
            </div>
        </div>
        ...
        >
            @lang('dashboard::app.help.index.cta-btn')
    ...
    {!! view_render_event('rehla.dashboard.help.index.after') !!}
</x-dashboard::layouts>
