<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.marketing.communications.subscribers.index.title')
    </x-slot>
                        ...
                        <x-dashboard::modal ref="groupCreateModal">
                            ...
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    @lang('dashboard::app.marketing.communications.subscribers.index.edit.title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                ...
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.marketing.communications.subscribers.index.edit.email')
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.marketing.communications.subscribers.index.edit.email')"
                                        disabled
                                    />
                                ...
                                <x-dashboard::form.control-group class="!mb-0">
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.marketing.communications.subscribers.index.edit.subscribed')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.marketing.communications.subscribers.index.edit.subscribed')"
                                    >
                                        @foreach (['true', 'false'] as $state)
                                            <option
                                                value="{{ $state == 'true' ? 1 : 0 }}"
                                            >
                                                @lang('dashboard::app.marketing.communications.subscribers.index.edit.' . $state)
                                            </option>
                                        @endforeach
                                    </x-dashboard::form.control-group.control>

                                    <x-dashboard::form.control-group.error control-name="is_subscribed" />
                                </x-dashboard::form.control-group>
                            </x-slot>
                            ...
                            <x-slot:footer>
                                ...
                                <x-dashboard::button
                                    ...
                                    :title="trans('dashboard::app.marketing.communications.subscribers.index.edit.save-btn')"
                                    ::loading="isLoading"
                                    ::disabled="isLoading"
                                />
                            </x-slot>
