<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.marketing.promotions.catalog-rules.edit.title')
    </x-slot>

    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.before', ['catalogRule' => $catalogRule]) !!}
    ...
    >
        ...
        {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.create.create_form_controls.before', ['catalogRule' => $catalogRule]) !!}
        ...
        <div class="mt-3 flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('dashboard::app.marketing.promotions.catalog-rules.edit.back-btn')
                </a>
                ...
                >
                    @lang('dashboard::app.marketing.promotions.catalog-rules.edit.save-btn')
                </button>
            </div>
        </div>
        ...
        <v-catalog-rule-edit-form>
            <!-- Shimmer Effect -->
            <x-dashboard::shimmer.marketing.promotions.catalog-rules />
        </v-catalog-rule-edit-form>

        {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.create.create_form_controls.after', ['catalogRule' => $catalogRule]) !!}

    </x-dashboard::form>

    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.after', ['catalogRule' => $catalogRule]) !!}
        ...
        >
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    ...
                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.general.before', ['catalogRule' => $catalogRule]) !!}

                    <!-- General Form -->
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                            @lang('dashboard::app.marketing.promotions.catalog-rules.edit.general')
                        </p>

                        <!-- Name -->
                        <x-dashboard::form.control-group>
                            <x-dashboard::form.control-group.label class="required">
                                @lang('dashboard::app.marketing.promotions.catalog-rules.edit.name')
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.name')"
                                :placeholder="trans('dashboard::app.marketing.promotions.catalog-rules.edit.name')"
                            />
                        ...
                        <x-dashboard::form.control-group class="!mb-0">
                            <x-dashboard::form.control-group.label>
                                @lang('dashboard::app.marketing.promotions.catalog-rules.edit.description')
                            </x-dashboard::form.control-group.label>
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.description')"
                                :placeholder="trans('dashboard::app.marketing.promotions.catalog-rules.edit.description')"
                            />
                    ...
                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.general.after', ['catalogRule' => $catalogRule]) !!}

                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.conditions.before', ['catalogRule' => $catalogRule]) !!}

                    <!-- Conditions -->
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <div class="flex items-center justify-between gap-4">
                            <p class="text-base font-semibold text-gray-800 dark:text-white">
                                @lang('dashboard::app.marketing.promotions.catalog-rules.edit.conditions')
                            </p>
                            ...
                            <x-dashboard::form.control-group class="!mb-0">
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.marketing.promotions.catalog-rules.condition-type')"
                                    :placeholder="trans('dashboard::app.marketing.promotions.catalog-rules.condition-type')"
                                >
                                    <option value="1">
                                        @lang('dashboard::app.marketing.promotions.catalog-rules.edit.all-conditions-true')
                                    </option>

                                    <option value="2">
                                        @lang('dashboard::app.marketing.promotions.catalog-rules.edit.any-conditions-true')
                                    </option>
                                </x-dashboard::form.control-group.control>
                        ...
                        <div
                            ...
                            @click="addCondition"
                        >
                            @lang('dashboard::app.marketing.promotions.catalog-rules.edit.add-condition')
                        </div>

                    </div>

                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.conditions.after', ['catalogRule' => $catalogRule]) !!}

                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.actions.before', ['catalogRule' => $catalogRule]) !!}

                    <!-- Actions -->
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        <div class="grid gap-1.5">
                            <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('dashboard::app.marketing.promotions.catalog-rules.edit.actions')
                            </p>
                            ...
                            <div class="flex gap-4 max-sm:flex-wrap">
                                <div class="w-full">
                                    ...
                                    <x-dashboard::form.control-group>
                                        <x-dashboard::form.control-group.label class="required">
                                            @lang('dashboard::app.marketing.promotions.catalog-rules.edit.action-type')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.action-type')"
                                        >
                                            <option
                                                value="by_percent"
                                                {{ $selectedOption == 'by_percent' ? 'selected' : '' }}
                                            >
                                                @lang('dashboard::app.marketing.promotions.catalog-rules.edit.percentage-product-price')
                                            </option>
                                            ...
                                            >
                                                @lang('dashboard::app.marketing.promotions.catalog-rules.edit.fixed-amount')
                                            </option>
                                        </x-dashboard::form.control-group.control>
                                ...
                                <x-dashboard::form.control-group class="w-full">
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.marketing.promotions.catalog-rules.edit.discount-amount')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.discount-amount')"
                                        :placeholder="trans('dashboard::app.marketing.promotions.catalog-rules.edit.discount-amount')"
                                    />
                                ...
                                <x-dashboard::form.control-group class="w-full">
                                    <x-dashboard::form.control-group.label>
                                        @lang('dashboard::app.marketing.promotions.catalog-rules.edit.end-other-rules')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.end-other-rules')"
                                    >
                                        <option
                                            value="0"
                                            {{ ! $selectedOption ? 'selected' : '' }}
                                        >
                                            @lang('dashboard::app.marketing.promotions.catalog-rules.edit.no')
                                        </option>
                                        ...
                                        <option
                                            ...
                                            {{ $selectedOption ? 'selected' : '' }}
                                        >
                                            @lang('dashboard::app.marketing.promotions.catalog-rules.edit.yes')
                                        </option>
                                    </x-dashboard::form.control-group.control>
                    ...
                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.actions.after', ['catalogRule' => $catalogRule]) !!}
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    ...
                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.accordion.settings.before', ['catalogRule' => $catalogRule]) !!}
                    ...
                    <x-dashboard::accordion>
                        <x-slot:header>
                            <div class="flex items-center justify-between">
                                <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                    @lang('dashboard::app.marketing.promotions.catalog-rules.edit.settings')
                                </p>
                            </div>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label>
                                    @lang('dashboard::app.marketing.promotions.catalog-rules.edit.priority')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.priority')"
                                    :placeholder="trans('dashboard::app.marketing.promotions.catalog-rules.edit.priority')"
                                />
                            ...
                            <div class="mb-4">
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.marketing.promotions.catalog-rules.edit.channels')
                                </x-dashboard::form.control-group.label>
                                ...
                                @foreach(core()->getAllChannels() as $channel)
                                    <x-dashboard::form.control-group class="!mb-2 flex items-center gap-2.5">
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.channels')"
                            ...
                            <div class="mb-4">
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.marketing.promotions.catalog-rules.edit.customer-groups')
                                </x-dashboard::form.control-group.label>
                                ...
                                @foreach(app('Webkul\Customer\Repositories\CustomerGroupRepository')->all() as $customerGroup)
                                    <x-dashboard::form.control-group class="!mb-2 flex items-center gap-2.5">
                                        <x-dashboard::form.control-group.control
                                            ...
                                            :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.customer-groups')"
                            ...
                            <x-dashboard::form.control-group class="!mb-0">
                                <x-dashboard::form.control-group.label>
                                    @lang('dashboard::app.marketing.promotions.catalog-rules.edit.status')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.status')"
                    ...
                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.accordion.settings.after', ['catalogRule' => $catalogRule]) !!}

                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.accordion.marketing_time.before', ['catalogRule' => $catalogRule]) !!}
                    ...
                    <x-dashboard::accordion>
                        <x-slot:header>
                            <div class="flex items-center justify-between">
                                <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                    @lang('dashboard::app.marketing.promotions.catalog-rules.edit.marketing-time')
                                </p>
                            </div>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <div class="flex gap-4">
                                ...
                                <x-dashboard::form.control-group class="!mb-0">
                                    <x-dashboard::form.control-group.label>
                                        @lang('dashboard::app.marketing.promotions.catalog-rules.edit.from')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        id="starts_from"
                                        name="starts_from"
                                        :value="(old('starts_from') ?? $catalogRule->starts_from) ?? null"
                                        :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.from')"
                                        :placeholder="trans('dashboard::app.marketing.promotions.catalog-rules.edit.from')"
                                    />
                                ...
                                <x-dashboard::form.control-group class="!mb-0">
                                    <x-dashboard::form.control-group.label>
                                        @lang('dashboard::app.marketing.promotions.catalog-rules.edit.to')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        id="ends_till"
                                        name="ends_till"
                                        :value="(old('ends_till') ?? $catalogRule->ends_till) ?? null"
                                        :label="trans('dashboard::app.marketing.promotions.catalog-rules.edit.to')"
                                        :placeholder="trans('dashboard::app.marketing.promotions.catalog-rules.edit.to')"
                                    />
                    ...
                    {!! view_render_event('rehla.dashboard.marketing.promotions.catalog_rules.edit.card.accordion.marketing_time.after', ['catalogRule' => $catalogRule]) !!}
        ...
        >
            <div class="mt-4 flex justify-between gap-4">
                <div class="flex flex-1 gap-4 max-sm:flex-1 max-sm:flex-wrap">
                    ...
                    >
                        <option value="">@lang('dashboard::app.marketing.promotions.catalog-rules.edit.choose-condition-to-add')</option>
                        ...
                        <div v-else>
                            ...
                            >
                                <v-field
                                    ...
                                    label="@lang('dashboard::app.marketing.promotions.catalog-rules.edit.conditions')"
                ...
                data() {
                    return {
                        ...
                        conditionOperators: {
                            'price': [{
                                    'operator': '==',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.is-equal-to')"
                                }, {
                                    'operator': '!=',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.is-not-equal-to')"
                                }, {
                                    'operator': '>=',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.equals-or-greater-than')"
                                }, {
                                    'operator': '<=',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.equals-or-less-than')"
                                }, {
                                    'operator': '>',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.greater-than')"
                                }, {
                                    'operator': '<',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.less-than')"
                                }],
                            'decimal': [{
                                    'operator': '==',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.is-equal-to')"
                            ...
                            'text': [{
                                    ...
                                    'operator': '{}',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.contain')"
                                }, {
                                    'operator': '!{}',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.does-not-contain')"
                                }],
                            'boolean': [{
                                    'operator': '==',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.is-equal-to')"
                            ...
                            'multiselect': [{
                                    'operator': '{}',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.contains')"
                                }, {
                                    'operator': '!{}',
                                    'label': "@lang('dashboard::app.marketing.promotions.catalog-rules.edit.does-not-contain')"
                                }],
