<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.notifications.title')
    </x-slot>

    {!! view_render_event('rehla.dashboard.marketing.notifications.create.before') !!}

    <!-- Vue Component -->
    <v-notification-list>
        <!-- Shimmer Effect -->
        <x-dashboard::shimmer.notifications />
    </v-notification-list>

    {!! view_render_event('rehla.dashboard.marketing.notifications.create.after') !!}
                ...
                <div class="mb-5 flex items-center justify-between gap-4 max-sm:flex-wrap">
                    <div class="grid gap-1.5">
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            @lang('dashboard::app.notifications.description-text')
                        </p>
                    </div>
                </div>
                ...
                <div class="box-shadow flex h-[calc(100vh-179px)] max-w-max flex-col justify-between rounded-md bg-white dark:bg-gray-900">
                    <div>
                        ...
                        <div
                            ...
                            v-else
                        >
                            @lang('dashboard::app.notifications.no-record')
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-x-2 border-t p-4 dark:border-gray-800">
                        ...
                        <span class="whitespace-nowrap text-gray-600 dark:text-gray-300">
                            @lang('dashboard::app.notifications.per-page')
                        </span>
                        ...
                        <span class="whitespace-nowrap text-gray-600 dark:text-gray-300">
                            @lang('dashboard::app.notifications.of')
                        </span>
                ...
                data() {
                    return {
                        ...
                        orderType: {
                            all : {
                                icon: 'icon',
                                message: '@lang('dashboard::app.notifications.order-status-messages.all')',
                                status: 'all'
                            },

                            pending : {
                                icon: 'icon-information bg-amber-100 text-amber-600 dark:!text-amber-600',
                                message: '@lang('dashboard::app.notifications.order-status-messages.pending')',
                                status: 'pending'
                            },
