...
<v-reporting-customers-total-customers>
    <!-- Shimmer -->
    <x-dashboard::shimmer.reporting.customers.total-customers /> 
</v-reporting-customers-total-customers>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.customers.index.total-customers')
                    </p>
                    ...
                    >
                        @lang('dashboard::app.reporting.customers.index.view-details')
                    </a>
                </div>
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.reporting.customers.index.customers-over-time')
                    </p>
