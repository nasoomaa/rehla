...
<v-reporting-products-last-search-terms>
    <!-- Shimmer -->
    <x-dashboard::shimmer.reporting.products.last-search-terms />
</v-reporting-products-last-search-terms>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.products.index.last-search-terms')
                    </p>
                    ...
                    >
                        @lang('dashboard::app.reporting.products.index.view-details')
                    </a>
                </div>
                            ...
                            >
                                <div class="flex gap-2.5">
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @lang('dashboard::app.reporting.products.index.search-term')
                                    </p>
                                </div>

                                <div class="flex gap-2.5">
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @lang('dashboard::app.reporting.products.index.results')
                                    </p>
                                </div>

                                <div class="flex gap-2.5">
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @lang('dashboard::app.reporting.products.index.uses')
                                    </p>
                                </div>
                            </div>
