...
<v-reporting-products-total-sold-quantity>
    <!-- Shimmer -->
    <x-dashboard::shimmer.reporting.products.sold-quantities />
</v-reporting-products-total-sold-quantity>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.products.index.total-sold-quantities')
                    </p>
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.reporting.products.index.quantities-sold-over-time')
                    </p>
