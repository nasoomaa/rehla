...
<v-reporting-products-wishlist-products>
    <!-- Shimmer -->
    <x-dashboard::shimmer.reporting.products.wishlist-products />
</v-reporting-products-wishlist-products>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.products.index.total-products-added-to-wishlist')
                    </p>
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.reporting.products.index.products-added-over-time')
                    </p>
