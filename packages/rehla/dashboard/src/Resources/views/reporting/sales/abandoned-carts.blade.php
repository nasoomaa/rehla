...
<v-reporting-sales-abandoned-carts>
    <!-- Shimmer -->
    <x-dashboard::shimmer.reporting.sales.abandoned-carts />
</v-reporting-sales-abandoned-carts>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.sales.index.abandoned-carts')
                    </p>
                    ...
                    >
                        @lang('dashboard::app.reporting.sales.index.view-details')
                    </a>
                </div>
                ...
                <div class="grid gap-4">
                    ...
                    <div class="flex justify-between gap-4">
                        ...
                        <div class="grid gap-1">
                            ...
                            <p class="text-xs font-semibold leading-none text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.reporting.sales.index.abandoned-revenue')
                            </p>
                        ...
                        <div class="grid gap-1">
                            ...
                            <p class="text-xs font-semibold leading-none text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.reporting.sales.index.abandoned-rate')
                            </p>
                    ...
                    <p class="mt-4 py-2.5 text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.sales.index.abandoned-products')
                    </p>
                    ...
                    <!-- Empty State -->
                    <template v-else>
                        @include('dashboard::reporting.empty')
                    </template>
