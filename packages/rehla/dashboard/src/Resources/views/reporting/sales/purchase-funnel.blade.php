...
<v-reporting-sales-purchase-funnel>
    <!-- Shimmer -->
    <x-dashboard::shimmer.reporting.sales.purchase-funnel />
</v-reporting-sales-purchase-funnel>
        ...
        <template v-else>
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <p class="mb-4 text-base font-semibold text-gray-600 dark:text-white">
                    @lang('dashboard::app.reporting.sales.index.purchase-funnel')
                </p>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="grid gap-0.5">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.reporting.sales.index.added-to-cart')
                            </p>
                        </div>
                        ...
                        <p
                            ...
                            v-html="'@lang('dashboard::app.reporting.sales.index.added-to-cart-info')'.replace(':progress', '<span class=\'text-emerald-400 font-semibold\'>' + report.statistics.carts.progress + '%</span>')"
                        ></p>
                    </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="grid gap-0.5">
                            ...
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.reporting.sales.index.purchased')
                            </p>
                        </div>
                        ...
                        <p
                            class="text-gray-600 dark:text-gray-300"
                            v-html="'@lang('dashboard::app.reporting.sales.index.purchased-info')'.replace(':progress', '<span class=\'text-emerald-400 font-semibold\'>' + report.statistics.orders.progress + '%</span>')"
                        ></p>
                    </div>
                </div>
