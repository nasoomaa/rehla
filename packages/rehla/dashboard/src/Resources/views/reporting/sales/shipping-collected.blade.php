...
<v-reporting-sales-shipping-collected>
    <!-- Shimmer -->
    <x-dashboard::shimmer.reporting.sales.shipping-collected />
</v-reporting-sales-shipping-collected>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.sales.index.shipping-collected')
                    </p>
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.reporting.sales.index.shipping-collected-over-time')
                    </p>
                    ...
                    <p class="py-2.5 text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.sales.index.top-shipping-methods')
                    </p>
