...
<v-reporting-sales-tax-collected>
    <!-- Shimmer -->
    <x-dashboard::shimmer.reporting.sales.tax-collected />
</v-reporting-sales-tax-collected>
            ...
            <div class="box-shadow relative flex-1 rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.sales.index.tax-collected')
                    </p>
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.reporting.sales.index.tax-collected-over-time')
                    </p>
                    ...
                    <p class="py-2.5 text-base font-semibold text-gray-600 dark:text-white">
                        @lang('dashboard::app.reporting.sales.index.top-tax-categories')
                    </p>
