            ...
            <x-dashboard::modal ref="myModal">
                ...
                <x-slot:header>
                    <div class="flex w-full items-center justify-between gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-lg font-semibold text-gray-900 dark:text-white">
                                    @lang('dashboard::app.sales.booking.calendar.booking-details')
                                </div>
                        ...
                        >
                            ...
                            <span v-text="
                                event.status === 'completed' ? '@lang('dashboard::app.sales.booking.calendar.done')' :
                                event.status === 'pending' ? '@lang('dashboard::app.sales.booking.calendar.pending')' :
                                event.status === 'canceled' ? '@lang('dashboard::app.sales.booking.calendar.canceled')' :
                                event.status === 'closed' ? '@lang('dashboard::app.sales.booking.calendar.closed')' :
                                event.status"
                            >
                            </span>
                        </span>
                    ...
                    <div class="grid gap-5 text-sm font-normal">
                        ...
                        <div class="grid grid-cols-[120px_auto] gap-x-3 gap-y-2.5 rounded-lg border border-gray-100 bg-gray-50/60 p-4 dark:border-gray-700 dark:bg-gray-800/60">
                            ...
                            <div
                                ...
                                v-text="'@lang('dashboard::app.sales.booking.calendar.booking-date')'"
                            >
                            </div>
                            ...
                            <div
                                class="text-gray-500 dark:text-gray-400"
                                v-text="'@lang('dashboard::app.sales.booking.calendar.product')'"
                            >
                            </div>
                            ...
                            <div
                                class="text-gray-500 dark:text-gray-400"
                                v-text="'@lang('dashboard::app.sales.booking.calendar.order-id')'"
                            >
                            </div>
                ...
                <x-slot:footer>
                    <button
                        ...
                        @click="redirect"
                    >
                        @lang('dashboard::app.sales.booking.calendar.view-details')
                    </button>
                </x-slot>
            </x-dashboard::modal>
        </div>
