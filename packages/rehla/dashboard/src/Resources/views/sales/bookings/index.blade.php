<x-dashboard::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('dashboard::app.sales.booking.index.title')
    </x-slot>
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                <div class="flex flex-col">
                    ...
                    <p class="-mt-1 text-sm text-gray-500 dark:text-gray-400">
                        @lang('dashboard::app.sales.booking.index.title') overview
                    </p>
                </div>
            ...
            <template v-if="viewType == 'table'">
                <x-dashboard::datagrid :src="route('admin.sales.bookings.index')" />
            </template>

            <template v-else>
                @include('dashboard::sales.bookings.calendar')
            </template>
        </script>
