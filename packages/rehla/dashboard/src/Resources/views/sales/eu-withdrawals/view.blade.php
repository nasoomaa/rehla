...
<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.eu_withdrawal.view.title', ['uuid' => $withdrawal->uuid])
    </x-slot>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        <div class="flex items-center gap-2.5">
            <p class="py-3 text-xl font-bold leading-6 text-gray-800 dark:text-white">
                @lang('dashboard::app.eu_withdrawal.view.heading')
            ...
            <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium {{ $statusBadge }}">
                @lang('dashboard::app.eu_withdrawal.status.'.$withdrawal->status)
            </span>
            ...
            @if ($withdrawal->is_guest)
                <span class="inline-flex items-center rounded-full bg-gray-100 px-3 py-1 text-xs font-medium text-gray-700 dark:bg-gray-800 dark:text-gray-300">
                    @lang('dashboard::app.eu_withdrawal.view.guest_badge')
                </span>
            @endif
        </div>
        ...
        >
            @lang('dashboard::app.eu_withdrawal.view.back')
        </a>
    </div>
    ...
    <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
        ...
        <div class="flex flex-1 flex-col gap-2.5 max-xl:flex-auto">
            ...
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <div class="flex items-center justify-between border-b border-slate-300 p-4 dark:border-gray-800">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.eu_withdrawal.view.evidence')
                    </p>

                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        @lang('dashboard::app.eu_withdrawal.view.evidence_note')
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 divide-y divide-slate-200 dark:divide-gray-800 sm:grid-cols-2 sm:divide-x sm:divide-y-0">
                    <div class="px-4 py-4">
                        <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                            @lang('dashboard::app.eu_withdrawal.view.received_at')
                        </p>
                    ...
                    <div class="px-4 py-4">
                        <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                            @lang('dashboard::app.eu_withdrawal.view.uuid')
                        </p>
                        ...
                        <div class="mt-1 flex items-center gap-2 rounded-lg border border-slate-200 bg-gray-50 px-3 py-2 dark:border-gray-800 dark:bg-gray-950">
                            ...
                            <button
                                type="button"
                                title="@lang('dashboard::app.eu_withdrawal.view.copy_reference')"
                                data-eu-clipboard="{{ $withdrawal->uuid }}"
                                data-eu-clipboard-message="@lang('dashboard::app.eu_withdrawal.view.reference_copied')"
                    ...
                    <div class="px-4 py-4">
                        <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                            @lang('dashboard::app.eu_withdrawal.view.order')
                        </p>
                    ...
                    <div class="px-4 py-4">
                        <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                            @lang('dashboard::app.eu_withdrawal.view.customer_email')
                        </p>
                    ...
                    <div class="px-4 py-4">
                        <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                            @lang('dashboard::app.eu_withdrawal.view.channel')
                        </p>
                    ...
                    <div class="px-4 py-4">
                        <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                            @lang('dashboard::app.eu_withdrawal.view.locale')
                        </p>
                ...
                @if ($withdrawal->reason_text)
                    <div class="border-t border-slate-200 px-4 py-4 dark:border-gray-800">
                        <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                            @lang('dashboard::app.eu_withdrawal.view.reason')
                        </p>
            ...
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <div class="flex justify-between p-4">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.eu_withdrawal.view.timeline')
                    </p>
                </div>
                ...
                <ol class="grid gap-0">
                    <li class="flex gap-3 border-t border-slate-200 px-4 py-3 dark:border-gray-800">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.eu_withdrawal.view.timeline_received')
                            </p>

                            <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                @lang('dashboard::app.eu_withdrawal.view.timeline_received_desc')
                            </p>
                    ...
                    <li class="flex gap-3 border-t border-slate-200 px-4 py-3 dark:border-gray-800">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.eu_withdrawal.view.timeline_initial_email')
                            </p>

                            @if ($withdrawal->confirmation_sent_at)
                                <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                    @lang('dashboard::app.eu_withdrawal.view.timeline_initial_email_desc_sent')
                                </p>
                            ...
                            @elseif ($withdrawal->confirmation_error)
                                <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                    @lang('dashboard::app.eu_withdrawal.view.timeline_initial_email_desc_error')
                                </p>
                            ...
                            @else
                                <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                    @lang('dashboard::app.eu_withdrawal.view.timeline_initial_email_desc_pending')
                                </p>
                            @endif
                        </div>
                    </li>
                    ...
                    <li class="flex gap-3 border-t border-slate-200 px-4 py-3 dark:border-gray-800">
                        @if ($withdrawal->declined_at)
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800 dark:text-white">
                                    @lang('dashboard::app.eu_withdrawal.view.timeline_declined')
                                </p>

                                <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                    @if ($withdrawal->declinedBy)
                                        @lang('dashboard::app.eu_withdrawal.view.timeline_declined_desc', ['name' => $withdrawal->declinedBy->name])
                                    @else
                                        @lang('dashboard::app.eu_withdrawal.view.timeline_declined_desc_system')
                                    @endif
                                </p>
                                ...
                                @if ($withdrawal->declined_reason)
                                    <div class="mt-2 rounded-md border border-red-100 bg-red-50 p-2.5 dark:border-red-900/40 dark:bg-red-900/20">
                                        <p class="text-xs font-medium uppercase tracking-wide text-red-700 dark:text-red-300">
                                            @lang('dashboard::app.eu_withdrawal.view.timeline_declined_reason_label')
                                        </p>
                        ...
                        @elseif ($withdrawal->refunded_at)
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800 dark:text-white">
                                    @lang('dashboard::app.eu_withdrawal.view.timeline_refunded')
                                </p>

                                <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                    @if ($withdrawal->refundedBy)
                                        @lang('dashboard::app.eu_withdrawal.view.timeline_refunded_desc', ['name' => $withdrawal->refundedBy->name])
                                    @else
                                        @lang('dashboard::app.eu_withdrawal.view.timeline_refunded_desc_system')
                                    @endif
                                </p>
                                ...
                                @if ($withdrawal->refund_note)
                                    <div class="mt-2 rounded-md border border-emerald-100 bg-emerald-50 p-2.5 dark:border-emerald-900/40 dark:bg-emerald-900/20">
                                        <p class="text-xs font-medium uppercase tracking-wide text-emerald-700 dark:text-emerald-300">
                                            @lang('dashboard::app.eu_withdrawal.view.timeline_refunded_note_label')
                                        </p>
                        ...
                        @else
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800 dark:text-white">
                                    @lang('dashboard::app.eu_withdrawal.view.timeline_resolution')
                                </p>

                                <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                    @lang('dashboard::app.eu_withdrawal.view.timeline_resolution_desc')
                                </p>
                            </div>
                        @endif
                    </li>
                    ...
                    @if ($withdrawal->declined_at || $withdrawal->refunded_at)
                        <li class="flex gap-3 border-t border-slate-200 px-4 py-3 dark:border-gray-800">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800 dark:text-white">
                                    @lang('dashboard::app.eu_withdrawal.view.timeline_final_email')
                                </p>

                                @if ($withdrawal->final_confirmation_sent_at)
                                    <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                        @lang('dashboard::app.eu_withdrawal.view.timeline_final_email_desc_sent')
                                    </p>
                                ...
                                @else
                                    <p class="mt-0.5 text-xs text-gray-600 dark:text-gray-400">
                                        @lang('dashboard::app.eu_withdrawal.view.timeline_final_email_desc_pending')
                                    </p>
                                @endif
                            </div>
                        </li>
        ...
        <div class="flex w-full max-w-[360px] flex-col gap-2.5 max-xl:max-w-full">
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <div class="flex justify-between p-4">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.eu_withdrawal.view.actions')
                    </p>
                </div>

                <div class="border-t border-slate-200 p-4 dark:border-gray-800">
                    <p class="text-xs leading-relaxed text-gray-500 dark:text-gray-400">
                        @lang('dashboard::app.eu_withdrawal.view.actions_note')
                    </p>
                </div>
                ...
                @php
                    ...
                    $confirmationButtonLabel = $isTerminalStatus
                        ? 'dashboard::app.eu_withdrawal.view.send_final_confirmation'
                        : 'dashboard::app.eu_withdrawal.view.resend_confirmation';

                    $confirmationModalMessage = $isTerminalStatus
                        ? 'dashboard::app.eu_withdrawal.view.send_final_confirmation_confirm_msg'
                        : 'dashboard::app.eu_withdrawal.view.resend_confirmation_confirm_msg';
                @endphp
                ...
                @if (bouncer()->hasPermission('sales.eu_withdrawals.mark_refunded'))
                    ...
                    >
                        ...
                        <label class="text-sm font-medium text-gray-700 dark:text-gray-200">
                            @lang('dashboard::app.eu_withdrawal.view.refund_note_label')
                        </label>
                        ...
                        <input
                            ...
                            name="refund_note"
                            maxlength="500"
                            placeholder="@lang('dashboard::app.eu_withdrawal.view.refund_note_placeholder')"
                        ...
                        <button
                            ...
                            @click="$emitter.emit('open-confirm-modal', {
                                message: '@lang('dashboard::app.eu_withdrawal.view.mark_refunded_confirm_msg')',
                                agree: () => this.$refs['markRefundedForm'].submit(),
                            })"
                        >
                            @lang('dashboard::app.eu_withdrawal.view.mark_refunded')
                        </button>
                    </form>
                @endif
                ...
                @if (bouncer()->hasPermission('sales.eu_withdrawals.decline'))
                    ...
                    >
                        ...
                        <label class="text-sm font-medium text-gray-700 dark:text-gray-200">
                            @lang('dashboard::app.eu_withdrawal.view.decline_reason_label')
                        </label>
                        ...
                        <input
                            ...
                            maxlength="500"
                            required
                            placeholder="@lang('dashboard::app.eu_withdrawal.view.decline_reason_placeholder')"
                            class="w-full rounded-lg border bg-white px-3 py-2 text-sm text-gray-700 transition-all hover:border-gray-400 focus:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300"
                        >
                        ...
                        <button
                            ...
                            @click="
                                ...
                                $emitter.emit('open-confirm-modal', {
                                    message: '@lang('dashboard::app.eu_withdrawal.view.decline_confirm_msg')',
                                    agree: () => this.$refs['declineForm'].submit(),
                                });
                            "
                        >
                            @lang('dashboard::app.eu_withdrawal.view.decline')
                        </button>
                    </form>
                @endif
            </div>
