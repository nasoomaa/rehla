...
<v-create-invoices>
    <div class="transparent-button px-1 py-1.5 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-800">
        ...
        @lang('dashboard::app.sales.invoices.create.invoice')
    </div>
</v-create-invoices>
...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <x-dashboard::drawer ref="invoice">
                    <!-- Drawer Header -->
                    <x-slot:header>
                        <div class="grid h-8 gap-3">
                            <div class="flex items-center justify-between">
                                <p class="text-xl font-medium dark:text-white">
                                    @lang('dashboard::app.sales.invoices.create.new-invoice')
                                </p>
                                ...
                                @if (bouncer()->hasPermission('sales.invoices.create'))
                                    ...
                                    >
                                        @lang('dashboard::app.sales.invoices.create.create-invoice')
                                    </button>
                                @endif
                            </div>
                        </div>
                    ...
                    <x-slot:content class="!p-0">
                        <div class="grid p-4 !pt-0">
                                            ...
                                            @else
                                                <div class="relative h-[60px] max-h-[60px] w-full max-w-[60px] rounded border border-dashed border-gray-300 dark:border-gray-800 dark:mix-blend-exclusion dark:invert">
                                                    ...
                                                    <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                                                        @lang('dashboard::app.sales.invoices.create.product-image')
                                                    </p>
                                                </div>
                                            @endif
                                            ...
                                            <div class="grid place-content-start gap-1.5">
                                                ...
                                                <div class="flex flex-col place-items-start gap-1.5">
                                                    <p class="text-gray-600 dark:text-gray-300">
                                                        @lang('dashboard::app.sales.invoices.create.amount-per-unit', [
                                                    ...
                                                    <p class="text-gray-600 dark:text-gray-300">
                                                        @lang('dashboard::app.sales.invoices.create.sku', ['sku' => $item->sku])
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid ltr:text-right rtl:text-left">
                                            ...
                                            <x-dashboard::form.control-group>
                                                <x-dashboard::form.control-group.label class="required !block">
                                                    @lang('dashboard::app.sales.invoices.create.qty-to-invoiced')
                                                ...
                                                <x-dashboard::form.control-group.control
                                                    ...
                                                    :label="trans('dashboard::app.sales.invoices.create.qty-to-invoiced')"
                                                    :placeholder="trans('dashboard::app.sales.invoices.create.qty-to-invoiced')"
                                                />

                                                <x-dashboard::form.control-group.error :control-name="'invoice[items][' . $item->id . ']'" />
                                            </x-dashboard::form.control-group>
                                        </div>
                                    </div>
                                @endif
                            ...
                            <x-dashboard::form.control-group class="!mb-0 flex w-max cursor-pointer select-none items-center gap-2.5 p-1.5">
                                <x-dashboard::form.control-group.control
                                    type="checkbox"
                                ...
                                >
                                    @lang('dashboard::app.sales.invoices.create.create-transaction')
                                </label>
                            </x-dashboard::form.control-group>
                        </div>
                    </x-slot>
