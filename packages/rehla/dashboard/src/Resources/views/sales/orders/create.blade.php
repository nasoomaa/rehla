<x-dashboard::layouts>
    <!-- Title of the page -->
    <x-slot:title>
        @lang('dashboard::app.sales.orders.create.title', ['name' => e($cart->customer->name)])
    </x-slot>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        ...
        >
            @lang('dashboard::app.sales.orders.create.back-btn')
        </a>
    </div>
    ...
    <v-create-order>
        ...
        <x-dashboard::shimmer.sales.orders.create />
    </v-create-order>
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                <!-- Left Component -->
                {!! view_render_event('rehla.dashboard.sales.order.create.left_component.before') !!}
                ...
                >
                    ...
                    >
                        <form
                            ...
                            ref="addToCartForm"
                        >
                            <x-dashboard::drawer ref="productConfigurationDrawer">
                                <!-- Drawer Header -->
                                <x-slot:header>
                                    <div class="flex items-center justify-between">
                                        <p class="text-xl font-medium dark:text-white">
                                            @lang('dashboard::app.sales.orders.create.configuration')
                                        </p>

                                        <button class="primary-button ltr:mr-11 rtl:ml-11">
                                            @lang('dashboard::app.sales.orders.create.add-to-cart')
                                        </button>
                                    </div>
                                </x-slot>
                ...
                {!! view_render_event('rehla.dashboard.sales.order.create.left_component.after') !!}

                <!-- Right Component -->
                {!! view_render_event('rehla.dashboard.sales.order.right_component.before') !!}
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    ...
                    @include('dashboard::sales.orders.create.wishlist-items')

                    <!-- Compare Items Component -->
                    @include('dashboard::sales.orders.create.compare-items')

                    <!-- Recent Order Items Component -->
                    @include('dashboard::sales.orders.create.recent-order-items')
                </div>

                {!! view_render_event('rehla.dashboard.sales.order.create.right_component.after') !!}
            </div>
        </script>
