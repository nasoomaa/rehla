{!! view_render_event('rehla.dashboard.sales.order.create.cart_items.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.cart_items.after') !!}
                    ...
                    >
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <div class="mt-2 flex gap-2.5">
                                ...
                                >
                                    @lang('dashboard::app.sales.orders.create.cart-items.add-to-cart')
                                </p>
                            </div>
                        </div>
                    </div>
