{!! view_render_event('rehla.dashboard.sales.order.create.cart.address.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.cart.address.after') !!}

@include('dashboard::sales.orders.create.cart.address.form')
        ...
        >
            <div class="flex items-center border-b p-4 dark:border-gray-800">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('dashboard::app.sales.orders.create.cart.address.title')
                </p>
            </div>
                    ...
                    <form @submit="handleSubmit($event, addAddressToCart)">
                        ...
                        <div class="mb-4 flex items-center justify-between">
                            <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                @lang('dashboard::app.sales.orders.create.cart.address.billing-address')
                            </p>
                            ...
                            >
                                @lang('dashboard::app.sales.orders.create.cart.address.add-btn')
                            </p>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-8">
                            ...
                            >
                                <x-dashboard::form.control-group class="!mb-0 flex items-center gap-2.5 self-start">
                                    <x-dashboard::form.control-group.control
                                        ...
                                        rules="required"
                                        label="{{ trans('dashboard::app.sales.orders.create.cart.address.billing-address') }}"
                                    />
                                ...
                                <div class="grid gap-3">
                                    ...
                                    <p
                                        ...
                                        "
                                    >
                                        @lang('dashboard::app.sales.orders.create.cart.address.edit-btn')
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Error Message Block -->
                        <x-dashboard::form.control-group.error name="billing.id" />

                        <!-- Shipping Address Block if have stockable items -->
                        <template v-if="cart.have_stockable_items">
                            <!-- Use for Shipping Checkbox -->
                            <x-dashboard::form.control-group class="!mb-0 mt-5 flex items-center gap-2.5">
                                <x-dashboard::form.control-group.control
                                    type="checkbox"
                                ...
                                <label
                                    ...
                                    for="use_for_shipping"
                                >
                                    @lang('dashboard::app.sales.orders.create.cart.address.same-as-billing')
                                </label>
                            </x-dashboard::form.control-group>
                            ...
                            >
                                ...
                                <div class="mb-4 flex items-center justify-between">
                                    <p class="text-base font-medium text-gray-600 dark:text-gray-300">
                                        @lang('dashboard::app.sales.orders.create.cart.address.shipping-address')
                                    </p>
                                    ...
                                    >
                                        <x-dashboard::form.control-group class="!mb-0 flex items-center gap-2.5 self-start">
                                            <x-dashboard::form.control-group.control
                                                ...
                                                rules="required"
                                                label="{{ trans('dashboard::app.sales.orders.create.cart.address.shipping-address') }}"
                                            />
                                        </x-dashboard::form.control-group>
                                ...
                                <!-- Error Message Block -->
                                <x-dashboard::form.control-group.error name="shipping.id" />
                            </div>
                        </template>
