{!! view_render_event('rehla.dashboard.sales.order.create.cart.items.before') !!}
...
>
    ...
    <x-dashboard::shimmer.sales.orders.create.cart.items />
</v-cart-items>

{!! view_render_event('rehla.dashboard.sales.order.create.cart.items.after') !!}
        ...
        <div class="box-shadow rounded bg-white dark:bg-gray-900">
            <div class="flex justify-between p-4">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('dashboard::app.sales.orders.create.cart.items.title')
                </p>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <template v-else>
                        <p class="flex flex-col gap-1 text-base font-semibold text-gray-800 dark:text-white">
                            <template v-if="displayTax.subtotal == 'including_tax'">
                                @{{ "@lang('dashboard::app.sales.orders.create.cart.items.sub-total', ['sub_total' => 'replace'])".replace('replace', cart.formatted_sub_total_incl_tax) }}
                            </template>
                            ...
                            <template v-else-if="displayTax.subtotal == 'both'">
                                ...
                                <span class="text-xs font-normal">
                                    @lang('dashboard::app.sales.orders.create.cart.items.excl-tax')
                            ...
                            <template v-else>
                                @{{ "@lang('dashboard::app.sales.orders.create.cart.items.sub-total', ['sub_total' => 'replace'])".replace('replace', cart.formatted_sub_total) }}
                            </template>
                        </p>
                    </template>
                    ...
                    >
                        @lang('dashboard::app.sales.orders.create.cart.items.add-product')
                    </button>
                </div>
            </div>
            ...
            >
                ...
                >
                        ...
                        <div class="flex gap-2.5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('dashboard::app.sales.orders.create.cart.items.sku', ['sku' => ':replace'])".replace(':replace', item.sku) }}
                                </p>

                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('dashboard::app.sales.orders.create.cart.items.amount-per-unit', ['amount' => ':replaceAmount', 'qty' => ':replaceQty'])".replace(':replaceAmount', item.formatted_price).replace(':replaceQty', item.quantity) }}
                                </p>
                                ...
                                >
                                    ...
                                    >
                                        @lang('dashboard::app.sales.orders.create.cart.items.see-details')
                    ...
                    <div class="flex justify-end gap-2.5">
                        ...
                        >
                            @lang('dashboard::app.sales.orders.create.cart.items.delete')
                        </p>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div class="flex flex-col items-center gap-1.5">
                    <p class="text-base font-semibold text-gray-400">
                        @lang('dashboard::app.sales.orders.create.cart.items.empty-title')
                    </p>

                    <p class="text-gray-400">
                        @lang('dashboard::app.sales.orders.create.cart.items.empty-description')
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <x-slot:header>
                    <div class="grid gap-5">
                        <p class="text-xl font-medium dark:text-white">
                            @lang('dashboard::app.sales.orders.create.cart.items.search.title')
                        </p>
                ...
                <x-slot:content class="!p-0">
                            ...
                            <div class="flex gap-2.5">
                                ...
                                >
                                    <template v-if="! product.images.length">
                                        ...
                                        <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                                            @lang('dashboard::app.sales.orders.create.cart.items.search.product-image')
                                        </p>
                                    </template>
                                ...
                                <div class="grid place-content-start gap-1.5">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @{{ "@lang('dashboard::app.sales.orders.create.cart.items.search.sku')".replace(':sku', product.sku) }}
                                    </p>
                                    ...
                                    >
                                        @{{ "@lang('dashboard::app.sales.orders.create.cart.items.search.available-qty')".replace(':qty', availbleQty(product)) }}
                                    </p>
                                </div>
                            </div>
                                ...
                                <form @submit="handleSubmit($event, addToCart)">
                                    <div class="grid place-content-start gap-2 text-right">
                                        ...
                                        <x-dashboard::form.control-group class="!mb-0">
                                            <x-dashboard::form.control-group.label class="required justify-end">
                                                @lang('dashboard::app.sales.orders.create.cart.items.search.qty')
                                            ...
                                            <x-dashboard::form.control-group.control
                                                ...
                                                :label="trans('dashboard::app.sales.orders.create.cart.items.search.qty')"
                                                :placeholder="trans('dashboard::app.sales.orders.create.cart.items.search.qty')"
                                            />

                                            <x-dashboard::form.control-group.error name="qty" />
                                        ...
                                        >
                                            @lang('dashboard::app.sales.orders.create.cart.items.search.add-to-cart')
                                        </button>
                                    </div>
                                </form>
                            </x-dashboard::form>
                    ...
                    >
                        ...
                        <div class="flex flex-col items-center gap-1.5">
                            <p class="text-base font-semibold text-gray-400">
                                @lang('dashboard::app.sales.orders.create.cart.items.search.empty-title')
                            </p>

                            <p class="text-gray-400">
                                @lang('dashboard::app.sales.orders.create.cart.items.search.empty-info')
                            </p>
                        </div>
                    </div>
                </x-slot>
