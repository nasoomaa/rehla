{!! view_render_event('rehla.dashboard.sales.order.create.cart.payment.before') !!}
...
>
    ...
    <x-dashboard::shimmer.sales.orders.create.cart.payment />
</v-cart-payment-methods>

{!! view_render_event('rehla.dashboard.sales.order.create.cart.payment.after') !!}
        ...
        >
            <div class="flex items-center border-b p-4 dark:border-gray-800">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('dashboard::app.sales.orders.create.cart.payment.title')
                </p>
            </div>
