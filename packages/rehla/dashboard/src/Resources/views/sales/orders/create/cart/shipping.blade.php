{!! view_render_event('rehla.dashboard.sales.order.create.cart.shipping.before') !!}
...
>
    ...
    <x-dashboard::shimmer.sales.orders.create.cart.shipping />
</v-cart-shipping-methods>

{!! view_render_event('rehla.dashboard.sales.order.create.cart.shipping.after') !!}
        ...
        >
            <div class="flex items-center border-b p-4 dark:border-gray-800">
                <p class="text-base font-semibold text-gray-800 dark:text-white">
                    @lang('dashboard::app.sales.orders.create.cart.shipping.title')
                </p>
            </div>
