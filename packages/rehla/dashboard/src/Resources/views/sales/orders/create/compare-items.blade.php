{!! view_render_event('rehla.dashboard.sales.order.create.compare_items.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.compare_items.after') !!}
            ...
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <div class="flex items-center justify-between p-4">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.sales.orders.create.compare-items.title')
                    </p>
                </div>
                    ...
                    >
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                @{{ "@lang('dashboard::app.sales.orders.create.compare-items.sku', ['sku' => ':replace'])".replace(':replace', item.product.sku) }}
                            </p>
                            ...
                            <div class="mt-2 flex gap-2.5">
                                ...
                                >
                                    @lang('dashboard::app.sales.orders.create.compare-items.delete')
                                </button>
                                ...
                                >
                                    @lang('dashboard::app.sales.orders.create.compare-items.add-to-cart')
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('dashboard::app.sales.orders.create.compare-items.empty-title')
                        </p>
    
                        <p class="text-gray-400">
                            @lang('dashboard::app.sales.orders.create.compare-items.empty-description')
                        </p>
                    </div>
                </div>
            </div>
