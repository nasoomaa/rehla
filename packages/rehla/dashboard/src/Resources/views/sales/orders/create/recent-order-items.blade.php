{!! view_render_event('rehla.dashboard.sales.order.create.recent_order_items.before') !!}
...
>
    ...
    <x-dashboard::shimmer.sales.orders.create.items />
</v-recent-order-items>

{!! view_render_event('rehla.dashboard.sales.order.create.recent_order_items.after') !!}
            ...
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <div class="flex items-center justify-between p-4">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        @lang('dashboard::app.sales.orders.create.recent-order-items.title')
                    </p>
                </div>
                    ...
                    >
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                @{{ "@lang('dashboard::app.sales.orders.create.recent-order-items.sku', ['sku' => ':replace'])".replace(':replace', item.product.sku) }}
                            </p>
                            ...
                            >
                                ...
                                >
                                    @lang('dashboard::app.sales.orders.create.recent-order-items.see-details')
                            ...
                            <div class="mt-2 flex items-center gap-2.5">
                                <a
                                    ...
                                    target="_blank"
                                >
                                    @lang('dashboard::app.sales.orders.create.recent-order-items.view')
                                </a>
                                ...
                                >
                                    @lang('dashboard::app.sales.orders.create.recent-order-items.add-to-cart')
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('dashboard::app.sales.orders.create.recent-order-items.empty-title')
                        </p>
    
                        <p class="text-gray-400">
                            @lang('dashboard::app.sales.orders.create.recent-order-items.empty-description')
                        </p>
                    </div>
                </div>
            </div>
