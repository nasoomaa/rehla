{!! view_render_event('rehla.dashboard.sales.order.create.types.booking.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.types.booking.after') !!}
        ...
        <div class="p-4">
            ...
            <template v-if="isLoading">
                <p class="text-sm text-gray-500 dark:text-gray-300">
                    @lang('dashboard::app.sales.orders.create.types.booking.loading')
                </p>
            </template>
            ...
            <template v-else-if="config">
                ...
                <template v-if="['default', 'appointment', 'table'].includes(config.type)">
                    <x-dashboard::form.control-group>
                        <x-dashboard::form.control-group.label class="required">
                            @lang('dashboard::app.sales.orders.create.types.booking.date')
                        ...
                        <x-dashboard::form.control-group.control
                            ...
                            name="booking[date]"
                            rules="required"
                            :label="trans('dashboard::app.sales.orders.create.types.booking.date')"
                            ::min-date="minDate"
                            ::max-date="maxDate"
                        ...
                        <x-dashboard::form.control-group.error control-name="booking[date]" />
                    </x-dashboard::form.control-group>

                    <x-dashboard::form.control-group>
                        <x-dashboard::form.control-group.label class="required">
                            @lang('dashboard::app.sales.orders.create.types.booking.slot')
                        </x-dashboard::form.control-group.label>
                        ...
                        <x-dashboard::form.control-group.control
                            ...
                            :label="trans('dashboard::app.sales.orders.create.types.booking.slot')"
                        >
                            <option value="">
                                @lang('dashboard::app.sales.orders.create.types.booking.select-slot')
                            </option>

                            <option v-if="! slots.length" disabled>
                                @lang('dashboard::app.sales.orders.create.types.booking.no-slots-available')
                            </option>
                        ...
                        <x-dashboard::form.control-group.error control-name="booking[slot]" />
                    </x-dashboard::form.control-group>

                    <!-- Optional note (table only) -->
                    <x-dashboard::form.control-group v-if="config.type === 'table'">
                        <x-dashboard::form.control-group.label>
                            @lang('dashboard::app.sales.orders.create.types.booking.note')
                        </x-dashboard::form.control-group.label>

                        <x-dashboard::form.control-group.control
                            type="textarea"
                            name="booking[note]"
                            :label="trans('dashboard::app.sales.orders.create.types.booking.note')"
                        />
                    </x-dashboard::form.control-group>
                </template>
                ...
                <template v-else-if="config.type === 'rental'">
                    <x-dashboard::form.control-group v-if="rentingTypeIsSelectable">
                        <x-dashboard::form.control-group.label class="required">
                            @lang('dashboard::app.sales.orders.create.types.booking.renting-type')
                        </x-dashboard::form.control-group.label>
                        ...
                        <x-dashboard::form.control-group.control
                            ...
                            rules="required"
                            v-model="rentingType"
                            :label="trans('dashboard::app.sales.orders.create.types.booking.renting-type')"
                        >
                            <option value="daily">@lang('dashboard::app.sales.orders.create.types.booking.daily')</option>
                            <option value="hourly">@lang('dashboard::app.sales.orders.create.types.booking.hourly')</option>
                        </x-dashboard::form.control-group.control>
                    </x-dashboard::form.control-group>
                    ...
                    <template v-if="rentingType === 'daily'">
                        <div class="grid grid-cols-2 gap-4">
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.sales.orders.create.types.booking.date-from')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    rules="required"
                                    :label="trans('dashboard::app.sales.orders.create.types.booking.date-from')"
                                    ::min-date="minDate"
                                    ::max-date="maxDate"
                                    ::disable="disabledDates"
                                ...
                                <x-dashboard::form.control-group.error control-name="booking[date_from]" />
                            </x-dashboard::form.control-group>

                            <x-dashboard::form.control-group v-if="dateFrom">
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.sales.orders.create.types.booking.date-to')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    rules="required"
                                    :label="trans('dashboard::app.sales.orders.create.types.booking.date-to')"
                                    ::min-date="dateFrom"
                                    ::max-date="maxDate"
                                    ::disable="disabledDates"
                                />

                                <x-dashboard::form.control-group.error control-name="booking[date_to]" />
                            </x-dashboard::form.control-group>
                        </div>
                    </template>
                    ...
                    <template v-if="rentingType === 'hourly'">
                        ...
                        <x-dashboard::form.control-group>
                            ...
                            <x-dashboard::form.control-group.control
                                ...
                                :label="trans('dashboard::app.sales.orders.create.types.booking.slot')"
                            >
                                <option value="">@lang('dashboard::app.sales.orders.create.types.booking.select-slot')</option>
                            ...
                            <x-dashboard::form.control-group.error control-name="booking[slot][from]" />
                        </x-dashboard::form.control-group>
                    </template>
                </template>
                        ...
                        >
                            ...
                            <x-dashboard::form.control-group class="!mb-0">
                                <x-dashboard::form.control-group.control
                                    ...
                                    ::value="0"
                                    ::max="ticket.qty || 999"
                                    :label="trans('dashboard::app.sales.orders.create.types.booking.quantity')"
                                />
                            </x-dashboard::form.control-group>
                        </div>
                    </div>
            ...
            <template v-else>
                <p class="text-sm text-red-600">
                    @lang('dashboard::app.sales.orders.create.types.booking.config-missing')
                </p>
            </template>
        </div>
    </script>
