{!! view_render_event('rehla.dashboard.sales.order.create.types.bundle.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.types.bundle.after') !!}
            ...
            <div class="p-4">
                <div class="my-5 flex items-center justify-between">
                    <p class="text-sm dark:text-white">
                        @lang('dashboard::app.sales.orders.create.types.bundle.total-amount')
                    </p>
        ...
        <div class="border-b border-[#E9E9E9] p-4">
            <x-dashboard::form.control-group>
                ...
                <template v-if="option.type == 'select'">
                    ...
                    >
                        ...
                        >
                            @lang('dashboard::app.sales.orders.create.types.bundle.none')
                        </option>
                ...
                <x-dashboard::form.control-group.error ::name="'bundle_options[' + option.id + '][]'" />
            </x-dashboard::form.control-group>
            ...
            <template v-if="['select', 'radio'].includes(option.type)">
                <x-dashboard::quantity-changer
                    ...
                    ::value="productQty"
                    class="mt-5 w-max gap-x-4 rounded-l px-4 py-1"
