{!! view_render_event('rehla.dashboard.sales.order.create.types.configurable.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.types.configurable.after') !!}
        ...
        <div class="w-[455px] max-w-full p-4">
            ...
            <template v-for='(attribute, index) in childAttributes'>
                <x-dashboard::form.control-group>
                    ...
                    <x-dashboard::form.control-group.error ::name="'super_attribute[' + attribute.id + ']'" />
                </x-dashboard::form.control-group>
            </template>
        </div>
    </script>
        ...
        app.component('v-product-configurable-options', {
            ...
            methods: {
                ...
                fillSelect(attribute) {
                    ...
                    attribute.options = [{
                        'id': '',
                        'label': "@lang('dashboard::app.sales.orders.create.types.configurable.select-options')",
                        'products': []
                    }];
