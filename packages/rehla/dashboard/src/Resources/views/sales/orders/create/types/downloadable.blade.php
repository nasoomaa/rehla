{!! view_render_event('rehla.dashboard.sales.order.create.types.grouped.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.types.grouped.after') !!}
...
@pushOnce('scripts')
    ...
    >
        <x-dashboard::form.control-group class="p-4">
            <x-dashboard::form.control-group.label class="!mt-0 dark:text-white">
                @lang('dashboard::app.sales.orders.create.types.downloadable.title')
            ...
            <div class="grid gap-2">
                ...
                >
                    <x-dashboard::form.control-group.control
                        ...
                        ::value="link.id"
                        rules="required"
                        :label="trans('dashboard::app.sales.orders.create.types.downloadable.title')"
                    />
            ...
            <x-dashboard::form.control-group.error name="links[]" />
