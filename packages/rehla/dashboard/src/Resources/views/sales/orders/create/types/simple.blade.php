{!! view_render_event('rehla.dashboard.sales.order.create.types.simple.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.types.simple.after') !!}
            ...
            <div class="p-4">
                <div class="my-5 flex items-center justify-between">
                    <p class="text-sm dark:text-white">
                        @lang('dashboard::app.sales.orders.create.types.simple.total-amount')
                    </p>
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            ...
                            <label
                                ...
                                :for="'customizable_options[' + option.id + '][' + index + ']'"
                            >
                                @lang('dashboard::app.sales.orders.create.types.simple.none')
                            </label>
                        </div>
