{!! view_render_event('rehla.dashboard.sales.order.create.types.virtual.before') !!}
...
{!! view_render_event('rehla.dashboard.sales.order.create.types.virtual.after') !!}
            ...
            <div class="p-4">
                <div class="my-5 flex items-center justify-between">
                    <p class="text-sm dark:text-white">
                        @lang('dashboard::app.sales.orders.create.types.virtual.total-amount')
                    </p>
    ...
    >
        <div class="border-b border-[#E9E9E9] p-4">
            <x-dashboard::form.control-group>
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            ...
                            <label
                                ...
                                :for="'customizable_options[' + option.id + '][' + index + ']'"
                            >
                                @lang('dashboard::app.sales.orders.create.types.virtual.none')
                            </label>
                        </div>
                ...
                <x-dashboard::form.control-group.error ::name="'customizable_options[' + option.id + '][]'" />
            </x-dashboard::form.control-group>
        </div>
    </script>
