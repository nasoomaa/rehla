    ...
    >
        <div>
            ...
            <x-dashboard::form
                ...
                ref="refundForm"
            >
                <x-dashboard::drawer ref="refund">
                    <!-- Drawer Header -->
                    <x-slot:header>
                        <div class="grid h-8 gap-3">
                            <div class="flex items-center justify-between">
                                <p class="text-xl font-medium dark:text-white">
                                    @lang('dashboard::app.sales.refunds.create.title')
                                </p>
                                ...
                                <div class="flex gap-x-2.5">
                                    ...
                                    @if (bouncer()->hasPermission('sales.refunds.create'))
                                        <div
                                            ...
                                            @click="updateTotals"
                                        >
                                            @lang('dashboard::app.sales.refunds.create.update-totals-btn')
                                        </div>
                                        ...
                                        >
                                            @lang('dashboard::app.sales.refunds.create.refund-btn')
                                        </button>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="grid p-4 !pt-0">
                                                ...
                                                <div class="grid place-content-start gap-1.5">
                                                    ...
                                                    <div class="flex flex-col place-items-start gap-1.5">
                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            @lang('dashboard::app.sales.refunds.create.amount-per-unit', [
                                                        ...
                                                        <!-- Item SKU -->
                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            @lang('dashboard::app.sales.refunds.create.sku', ['sku' => $item->getTypeInstance()->getOrderedItem($item)->sku])
                                                        </p>

                                                        <!-- Item Status -->
                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            {{ $item->qty_ordered ? trans('dashboard::app.sales.refunds.create.item-ordered', ['qty_ordered' => $item->qty_ordered]) : '' }}

                                                            {{ $item->qty_invoiced ? trans('dashboard::app.sales.refunds.create.item-invoice', ['qty_invoiced' => $item->qty_invoiced]) : '' }}

                                                            {{ $item->qty_shipped ? trans('dashboard::app.sales.refunds.create.item-shipped', ['qty_shipped' => $item->qty_shipped]) : '' }}

                                                            {{ $item->qty_refunded ? trans('dashboard::app.sales.refunds.create.item-refunded', ['qty_refunded' => $item->qty_refunded]) : '' }}

                                                            {{ $item->qty_canceled ? trans('dashboard::app.sales.refunds.create.item-canceled', ['qty_canceled' => $item->qty_canceled]) : '' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex justify-between">
                                                ...
                                                <div>
                                                    <x-dashboard::form.control-group.label class="required">
                                                        @lang('dashboard::app.sales.refunds.create.qty-to-refund')
                                                    ...
                                                    <x-dashboard::form.control-group class="!mb-0">
                                                        <x-dashboard::form.control-group.control
                                                            ...
                                                            :label="trans('dashboard::app.sales.refunds.create.qty-to-refund')"
                                                        />

                                                        <x-dashboard::form.control-group.error control-name="refund[items][{{ $item->id }}]" />
                                                ...
                                                <div class="item flex w-full justify-end gap-5">
                                                    <div class="flex flex-col gap-y-1.5">
                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            @lang('dashboard::app.sales.refunds.create.price')
                                                        </p>

                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            @lang('dashboard::app.sales.refunds.create.subtotal')
                                                        </p>

                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            @lang('dashboard::app.sales.refunds.create.tax-amount')
                                                        </p>

                                                        @if ($order->base_discount_amount > 0)
                                                            <p class="text-gray-600 dark:text-gray-300">
                                                                @lang('dashboard::app.sales.refunds.create.discount-amount')
                                                            </p>
                                                        @endif

                                                        <p class="font-semibold text-gray-600 dark:text-gray-300">
                                                            @lang('dashboard::app.sales.refunds.create.grand-total')
                                                        </p>
                                                    </div>
                            ...
                            >
                                ...
                                <x-dashboard::form.control-group>
                                    ...
                                    <x-dashboard::form.control-group.error control-name="refund[shipping]" />
                                </x-dashboard::form.control-group>

                                <!-- Adjustment Refund -->
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.sales.refunds.create.adjustment-refund')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.sales.refunds.create.adjustment-refund')"
                                    />

                                    <x-dashboard::form.control-group.error control-name="refund[adjustment_refund]" />
                                </x-dashboard::form.control-group>

                                <!-- Adjustment Fee -->
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.sales.refunds.create.adjustment-fee')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        rules="required|min_value:0"
                                        :label="trans('dashboard::app.sales.refunds.create.adjustment-fee')"
                                    />

                                    <x-dashboard::form.control-group.error control-name="refund[adjustment_fee]" />
                                </x-dashboard::form.control-group>
                            </div>
