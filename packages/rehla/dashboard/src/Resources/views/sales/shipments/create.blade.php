...
<v-create-shipment>
    ...
    >
        ...
        @lang('dashboard::app.sales.orders.view.ship')
    </div>
</v-create-shipment>
...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <x-dashboard::drawer ref="shipment">
                    <!-- Drawer Header -->
                    <x-slot:header>
                        <div class="grid gap-3 sm:h-8">
                            <div class="flex items-center justify-between">
                                <p class="text-xl font-medium dark:text-white">
                                    @lang('dashboard::app.sales.shipments.create.title')
                                </p>
                                ...
                                @if (bouncer()->hasPermission('sales.shipments.create'))
                                    ...
                                    >
                                        @lang('dashboard::app.sales.shipments.create.create-btn')
                                    </button>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="grid p-4 pt-2">
                            <div class="grid grid-cols-2 gap-x-5">
                                ...
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label>
                                        @lang('dashboard::app.sales.shipments.create.carrier-name')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.sales.shipments.create.carrier-name')"
                                        :placeholder="trans('dashboard::app.sales.shipments.create.carrier-name')"
                                    />

                                    <x-dashboard::form.control-group.error control-name="carrier_name" />
                                </x-dashboard::form.control-group>

                                <!-- Tracking Number -->
                                <x-dashboard::form.control-group>
                                    <x-dashboard::form.control-group.label>
                                        @lang('dashboard::app.sales.shipments.create.tracking-number')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.sales.shipments.create.tracking-number')"
                                        :placeholder="trans('dashboard::app.sales.shipments.create.tracking-number')"
                                    />

                                    <x-dashboard::form.control-group.error control-name="shipment[track_number]" />
                                </x-dashboard::form.control-group>
                            </div>
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.sales.shipments.create.source')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    rules="required"
                                    v-model="source"
                                    :label="trans('dashboard::app.sales.shipments.create.source')"
                                    :placeholder="trans('dashboard::app.sales.shipments.create.source')"
                                ...
                                <x-dashboard::form.control-group.error control-name="shipment[source]" />
                            </x-dashboard::form.control-group>
                                                ...
                                                <div class="grid place-content-start gap-1.5">
                                                    ...
                                                    <div class="flex flex-col place-items-start gap-1.5">
                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            @lang('dashboard::app.sales.shipments.create.amount-per-unit', [
                                                        ...
                                                        <!-- Item SKU -->
                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            @lang('dashboard::app.sales.shipments.create.sku', ['sku' => $item->sku])
                                                        </p>

                                                        <!--Item Status -->
                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            {{ $item->qty_ordered ? trans('dashboard::app.sales.shipments.create.item-ordered', ['qty_ordered' => $item->qty_ordered]) : '' }}

                                                            {{ $item->qty_invoiced ? trans('dashboard::app.sales.shipments.create.item-invoice', ['qty_invoiced' => $item->qty_invoiced]) : '' }}

                                                            {{ $item->qty_shipped ? trans('dashboard::app.sales.shipments.create.item-shipped', ['qty_shipped' => $item->qty_shipped]) : '' }}

                                                            {{ $item->qty_refunded ? trans('dashboard::app.sales.shipments.create.item-refunded', ['qty_refunded' => $item->qty_refunded]) : '' }}

                                                            {{ $item->qty_canceled ? trans('dashboard::app.sales.shipments.create.item-canceled', ['qty_canceled' => $item->qty_canceled]) : '' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        @foreach ($order->channel->inventory_sources as $inventorySource)
                                            <div class="grid grid-cols-2 gap-2.5 border-b border-slate-300 py-2.5 dark:border-gray-800">
                                                <div class="grid gap-1">
                                                    ...
                                                    <!-- Available Quantity -->
                                                    <p class="text-gray-600 dark:text-gray-300">
                                                        @lang('dashboard::app.sales.shipments.create.qty-available') :
                                                ...
                                                <div class="grid ltr:text-right rtl:text-left">
                                                    ...
                                                    <x-dashboard::form.control-group class="!mb-0">
                                                        <x-dashboard::form.control-group.label class="required !block">
                                                            @lang('dashboard::app.sales.shipments.create.qty-to-ship')
                                                        </x-dashboard::form.control-group.label>
                                                        ...
                                                        <x-dashboard::form.control-group.control
                                                            ...
                                                            :label="trans('dashboard::app.sales.shipments.create.qty-to-ship')"
                                                            data-original-quantity="{{ $canShipQty['qty'] }}"
                                                            ::disabled="'{{ empty($sourceQty) }}' || source != '{{ $inventorySource->id }}'"
                                                            :ref="$inputName"
                                                        />

                                                        <x-dashboard::form.control-group.error :control-name="$inputName" />
                                                    </x-dashboard::form.control-group>
                                                </div>
