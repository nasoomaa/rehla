...
>
    <p class="text-base font-semibold text-gray-800 dark:text-white">
        @lang('dashboard::app.settings.data-transfer.imports.images.title')
    </p>

    <p class="mb-4 mt-1 text-xs text-gray-600 dark:text-gray-300">
        @lang('dashboard::app.settings.data-transfer.imports.images.info')
    </p>
    ...
    <div class="grid gap-2.5">
        ...
        <label class="relative grid cursor-pointer gap-1 rounded border border-gray-300 p-4 transition-all ltr:pl-12 rtl:pr-12 hover:border-gray-400 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50 dark:border-gray-700 dark:hover:border-gray-600 dark:has-[:checked]:border-blue-400 dark:has-[:checked]:bg-gray-800">
            ...
            <span class="flex flex-wrap items-center gap-2">
                <span class="font-medium text-gray-800 dark:text-white">
                    @lang('dashboard::app.settings.data-transfer.imports.images.url-title')
                </span>

                <span class="label-active">
                    @lang('dashboard::app.settings.data-transfer.imports.images.recommended')
                </span>
            </span>

            <span class="text-xs text-gray-600 dark:text-gray-300">
                @lang('dashboard::app.settings.data-transfer.imports.images.url-info')
            </span>
        </label>
        ...
        <label class="relative grid cursor-pointer gap-1 rounded border border-gray-300 p-4 transition-all ltr:pl-12 rtl:pr-12 hover:border-gray-400 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50 dark:border-gray-700 dark:hover:border-gray-600 dark:has-[:checked]:border-blue-400 dark:has-[:checked]:bg-gray-800">
            ...
            <span class="font-medium text-gray-800 dark:text-white">
                @lang('dashboard::app.settings.data-transfer.imports.images.upload-title')
            </span>

            <span class="text-xs text-gray-600 dark:text-gray-300">
                @lang('dashboard::app.settings.data-transfer.imports.images.upload-info')
            </span>
            ...
            <span class="mt-2 hidden peer-checked:block">
                <x-dashboard::form.control-group class="!mb-0">
                    <x-dashboard::form.control-group.control
                        ...
                        name="upload_images"
                        accept=".zip"
                        :label="trans('dashboard::app.settings.data-transfer.imports.images.upload-title')"
                    />
                    ...
                    @if ($hasSampleImagesZip)
                        ...
                        >
                            @lang('dashboard::app.settings.data-transfer.imports.images.download-sample-zip')
                        </a>
                    @endif
                    ...
                    @if ($archiveImages)
                        <p class="mt-2 text-xs text-gray-600 dark:text-gray-300">
                            @if ($archiveName)
                                @lang('dashboard::app.settings.data-transfer.imports.images.current-archive', [
                                    'name'  => $archiveName,
                                    'count' => $archiveImages,
                                ])
                            @else
                                @lang('dashboard::app.settings.data-transfer.imports.images.current-images', [
                                    'count' => $archiveImages,
                                ])
                            @endif
                        </p>
                        ...
                        <p class="mt-1 text-xs text-gray-600 dark:text-gray-300">
                            @lang('dashboard::app.settings.data-transfer.imports.images.replace-archive')
                        </p>
                    @endif

                    <x-dashboard::form.control-group.error control-name="upload_images" />
        ...
        <label class="relative grid cursor-pointer gap-1 rounded border border-gray-300 p-4 transition-all ltr:pl-12 rtl:pr-12 hover:border-gray-400 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50 dark:border-gray-700 dark:hover:border-gray-600 dark:has-[:checked]:border-blue-400 dark:has-[:checked]:bg-gray-800">
            ...
            <span class="font-medium text-gray-800 dark:text-white">
                @lang('dashboard::app.settings.data-transfer.imports.images.directory-title')
            </span>

            <span class="text-xs text-gray-600 dark:text-gray-300">
                @lang('dashboard::app.settings.data-transfer.imports.images.directory-info')
            </span>
            ...
            <span class="mt-2 hidden peer-checked:block">
                <x-dashboard::form.control-group class="!mb-0">
                    <x-dashboard::form.control-group.control
                        ...
                        :placeholder="trans('dashboard::app.settings.data-transfer.imports.images.directory-placeholder')"
                    />

                    <p class="mt-2 text-xs text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.settings.data-transfer.imports.images.directory-hint')
                    </p>

                    <p class="mt-2 text-xs text-gray-600 dark:text-gray-300">
                        @lang('dashboard::app.settings.data-transfer.imports.images.directory-example')
                    </p>

                    <x-dashboard::form.control-group.error control-name="images_directory_path" />
                </x-dashboard::form.control-group>
            </span>
        </label>
    </div>
