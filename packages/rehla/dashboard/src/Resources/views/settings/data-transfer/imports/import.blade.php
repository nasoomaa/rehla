<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.settings.data-transfer.imports.import.title')
    </x-slot>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        ...
        <div class="flex items-center gap-x-2.5">
            ...
            >
                @lang('dashboard::app.settings.data-transfer.imports.import.back-btn')
            </a>
            ...
            >
                @lang('dashboard::app.settings.data-transfer.imports.import.edit-btn')
            </a>
        </div>
    </div>
    ...
    @php
        ...
        $prefix = 'dashboard::app.settings.data-transfer.imports.import.';
                ...
                <div class="box-shadow grid gap-2.5 rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    >
                        <p class="flex items-center gap-2">
                            ...
                            @lang('dashboard::app.settings.data-transfer.imports.import.validate-info')
                        </p>
                        ...
                        <button
                            ...
                            @click="validate"
                        >
                            @lang('dashboard::app.settings.data-transfer.imports.import.validate')
                        </button>
                    </div>
                    ...
                    >
                        <p class="flex items-center gap-2">
                            ...
                            @lang('dashboard::app.settings.data-transfer.imports.import.validating-info')
                        </p>
                        ...
                        >
                            ...
                            @lang('dashboard::app.settings.data-transfer.imports.import.rows-validated')
                    ...
                    >
                        ...
                        <div class="grid gap-2">
                            ...
                            >
                                ...
                                @lang('dashboard::app.settings.data-transfer.imports.import.validation-success-info')
                            </p>
                            ...
                            >
                                ...
                                @lang('dashboard::app.settings.data-transfer.imports.import.validation-partial-info')
                            </p>
                            ...
                            >
                                ...
                                @lang('dashboard::app.settings.data-transfer.imports.import.validation-failed-info')
                            </p>
                            ...
                            <p class="flex items-center gap-2 dark:text-white">
                                ...
                                <span class="font-medium text-gray-800 dark:text-white">
                                    @lang('dashboard::app.settings.data-transfer.imports.import.total-rows-processed')
                                </span>
                            ...
                            <p class="flex items-center gap-2 dark:text-white">
                                ...
                                <span class="font-medium text-gray-800 dark:text-white">
                                    @lang('dashboard::app.settings.data-transfer.imports.import.total-invalid-rows')
                                </span>
                            ...
                            <p class="flex items-center gap-2 dark:text-white">
                                ...
                                <span class="font-medium text-gray-800 dark:text-white">
                                    @lang('dashboard::app.settings.data-transfer.imports.import.total-errors')
                                </span>
                        ...
                        <div class="flex gap-2">
                            ...
                            >
                                @lang('dashboard::app.settings.data-transfer.imports.import.download-error-report')
                            </a>
                        </div>
                    </div>
                    ...
                    >
                        <p class="flex items-center gap-2">
                            ...
                            @lang('dashboard::app.settings.data-transfer.imports.import.downloading-info')
                        </p>
                        ...
                        <p class="flex items-center gap-2">
                            ...
                            @lang('dashboard::app.settings.data-transfer.imports.import.images-progress')
                    ...
                    >
                        <p class="flex items-center gap-2">
                            ...
                            <span v-if="importResource.state == 'processing' && isDelete">
                                @lang('dashboard::app.settings.data-transfer.imports.import.deleting-info')
                            </span>

                            <span v-else-if="importResource.state == 'processing'">
                                @lang('dashboard::app.settings.data-transfer.imports.import.importing-info')
                            </span>

                            <span v-else-if="importResource.state == 'linking'">
                                @lang('dashboard::app.settings.data-transfer.imports.import.linking-info')
                            </span>

                            <span v-else>
                                @lang('dashboard::app.settings.data-transfer.imports.import.indexing-info')
                            </span>
                        </p>
                        ...
                        <p class="flex items-center gap-2">
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.settings.data-transfer.imports.import.progress')
                            </span>
                        ...
                        <p class="flex items-center gap-2">
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.settings.data-transfer.imports.import.total-batches')
                            </span>
                        ...
                        <p class="flex items-center gap-2">
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.settings.data-transfer.imports.import.completed-batches')
                            </span>
                        ...
                        >
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.settings.data-transfer.imports.import.total-created')
                            </span>
                        ...
                        >
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.settings.data-transfer.imports.import.total-updated')
                            </span>
                        ...
                        >
                            <span class="font-medium text-gray-800 dark:text-white">
                                @lang('dashboard::app.settings.data-transfer.imports.import.total-deleted')
                            </span>
                    ...
                    >
                        ...
                        <div class="grid gap-2">
                            <p class="mb-2 flex items-center gap-2 text-base">
                                ...
                                @lang('dashboard::app.settings.data-transfer.imports.import.imported-info')
                            </p>
                            ...
                            >
                                ...
                                @{{ "@lang('dashboard::app.settings.data-transfer.imports.import.failed-batches')".replace(':count', stats.batches.failed) }}
                            </p>
                            ...
                            >
                                ...
                                <span class="font-medium text-gray-800 dark:text-white">
                                    @lang('dashboard::app.settings.data-transfer.imports.import.images-downloaded')
                                </span>
