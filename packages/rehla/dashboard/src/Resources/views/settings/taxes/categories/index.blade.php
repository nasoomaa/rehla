<x-dashboard::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('dashboard::app.settings.taxes.categories.index.title')
    </x-slot>
            ...
            <div class="flex items-center gap-x-2.5">
                <div class="flex items-center gap-x-2.5">
                    ...
                    @if (bouncer()->hasPermission('settings.taxes.tax_categories.create'))
                        ...
                        >
                            @lang('dashboard::app.settings.taxes.categories.index.create.title')
                        </button>
                    @endif
                </div>
            </div>
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            >
                ...
                >
                    <x-dashboard::modal ref="taxCategory">
                        <!-- Modal Header -->
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                <span v-if="selectedTaxCategories">
                                    @lang('dashboard::app.settings.taxes.categories.index.edit.title')
                                </span>
                        ...
                        <x-slot:content>
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.settings.taxes.categories.index.create.code')
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.settings.taxes.categories.index.create.code')"
                                    :placeholder="trans('dashboard::app.settings.taxes.categories.index.create.code')"
                                />
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.settings.taxes.categories.index.create.name')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.settings.taxes.categories.index.create.name')"
                                    :placeholder="trans('dashboard::app.settings.taxes.categories.index.create.name')"
                                />
                            ...
                            <x-dashboard::form.control-group class="!mb-0">
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.settings.taxes.categories.index.create.description')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.settings.taxes.categories.index.create.description')"
                                    :placeholder="trans('dashboard::app.settings.taxes.categories.index.create.description')"
                                />
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.settings.taxes.categories.index.create.tax-rates')
                                </x-dashboard::form.control-group.label>

                                <v-field
                                    name="taxrates[]"
                                    rules="required"
                                    label="@lang('dashboard::app.settings.taxes.categories.index.create.tax-rates')"
                        ...
                        <x-slot:footer>
                            ...
                            <x-dashboard::button
                                button-type="submit"
                                class="primary-button"
                                :title="trans('dashboard::app.settings.taxes.categories.index.create.save-btn')"
                                ::loading="isLoading"
                                ::disabled="isLoading"
                            />
                        </x-slot>
