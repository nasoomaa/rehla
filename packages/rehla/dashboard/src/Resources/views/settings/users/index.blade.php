<x-dashboard::layouts>
    <x-slot:title>
        @lang('dashboard::app.settings.users.index.title')
    </x-slot>
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            >
                    ...
                    >
                        ...
                        @if ($hasPermission)
                            <p class="flex justify-end gap-2.5">
                                @lang('dashboard::app.components.datagrid.table.actions')
                            </p>
                        @endif
                    </div>
                </template>
                ...
                <template #body="{
                    ...
                    <template v-else>
                        ...
                        >
                            <!-- ID -->
                            <p data-label="@lang('dashboard::app.settings.users.index.datagrid.id')">@{{ record.user_id }}</p>

                            <!-- User Profile -->
                            <p data-label="@lang('dashboard::app.settings.users.index.datagrid.name')">
                            ...
                            <!-- Status -->
                            <p data-label="@lang('dashboard::app.settings.users.index.datagrid.status')">@{{ record.status }}</p>

                            <!-- Email -->
                            <p
                                class="break-words"
                                data-label="@lang('dashboard::app.settings.users.index.datagrid.email')"
                            >@{{ record.email }}</p>

                            <!-- Role -->
                            <p data-label="@lang('dashboard::app.settings.users.index.datagrid.role')">@{{ record.role_name }}</p>
            ...
            >
                ...
                >
                    <!-- User Create Modal -->
                    <x-dashboard::modal ref="userUpdateOrCreateModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                            <p
                                ...
                                v-if="isUpdating"
                            >
                                @lang('dashboard::app.settings.users.index.edit.title')
                            </p>
                        ...
                        <x-slot:content>
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.settings.users.index.create.name')
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.settings.users.index.create.name')"
                                    :placeholder="trans('dashboard::app.settings.users.index.create.name')"
                                />
                            ...
                            <x-dashboard::form.control-group>
                                <x-dashboard::form.control-group.label class="required">
                                    @lang('dashboard::app.settings.users.index.create.email')
                                </x-dashboard::form.control-group.label>
                                ...
                                <x-dashboard::form.control-group.control
                                    ...
                                    :label="trans('dashboard::app.settings.users.index.create.email')"
                            ...
                            <div class="flex gap-4">
                                <!-- Password -->
                                <x-dashboard::form.control-group class="mb-2.5 flex-1">
                                    <x-dashboard::form.control-group.label>
                                        @lang('dashboard::app.settings.users.index.create.password')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.settings.users.index.create.password')"
                                        :placeholder="trans('dashboard::app.settings.users.index.create.password')"
                                        ref="password"
                                    />
                                ...
                                <x-dashboard::form.control-group class="flex-1">
                                    <x-dashboard::form.control-group.label>
                                        @lang('dashboard::app.settings.users.index.create.confirm-password')
                                    </x-dashboard::form.control-group.label>
                                    ...
                                    <x-dashboard::form.control-group.control
                                        ...
                                        :label="trans('dashboard::app.settings.users.index.create.password')"
                                        :placeholder="trans('dashboard::app.settings.users.index.create.confirm-password')"
                                    />
                            ...
                            <div class="flex gap-4">
                                <!-- Role -->
                                <x-dashboard::form.control-group class="w-full flex-1">
                                    <x-dashboard::form.control-group.label class="required">
                                        @lang('dashboard::app.settings.users.index.create.role')
                                    </x-dashboard::form.control-group.label>

                                    <v-field
                                        name="role_id"
                                        rules="required"
                                        label="@lang('dashboard::app.settings.users.index.create.role')"
                                    ...
                                    >
                                        <select
                                            ...
                                            v-model="data.user.role_id"
                                        >
                                            <option value="" disabled>@lang('dashboard::app.settings.taxes.categories.index.create.select')</option>
                                    ...
                                    <x-dashboard::form.control-group.error control-name="role_id" />
                                </x-dashboard::form.control-group>

                                <template v-if="currentUserId != data.user.id">
                                    <x-dashboard::form.control-group class="!mb-0 w-full flex-1">
                                        <x-dashboard::form.control-group.label>
                                            @lang('dashboard::app.settings.users.index.create.status')
                                        </x-dashboard::form.control-group.label>
                                        ...
                                        <div class="mt-2.5 w-full gap-2.5">
                                            <x-dashboard::form.control-group.control
                                                ...
                                                :label="trans('dashboard::app.settings.users.index.create.status')"
                            ...
                            <x-dashboard::form.control-group>
                                ...
                                <p class="required my-3 text-sm text-gray-400">
                                    @lang('dashboard::app.settings.users.index.create.upload-image-info')
                                </p>
                            </x-dashboard::form.control-group>
                        </x-slot>
                        ...
                        <x-slot:footer>
                            ...
                            <x-dashboard::button
                                ...
                                :title="trans('dashboard::app.settings.users.index.create.save-btn')"
                                ::loading="isLoading"
                                ::disabled="isLoading"
                            />
                        </x-slot>
