...
use Rehla\Dashboard\Http\Controllers\DashboardController;
use Rehla\Dashboard\Http\Controllers\DataGrid\DataGridController;
use Rehla\Dashboard\Http\Controllers\DataGrid\SavedFilterController;
use Rehla\Dashboard\Http\Controllers\MagicAIController;
use Rehla\Dashboard\Http\Controllers\TinyMCEController;
use Rehla\Dashboard\Http\Controllers\User\AccountController;
use Rehla\Dashboard\Http\Controllers\User\SessionController;
use Rehla\Dashboard\Http\Controllers\User\TwoFactorController;
