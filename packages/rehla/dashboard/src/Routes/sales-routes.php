...
use Rehla\Dashboard\Http\Controllers\Sales\BookingController;
use Rehla\Dashboard\Http\Controllers\Sales\BookingProductController;
use Rehla\Dashboard\Http\Controllers\Sales\CartController;
use Rehla\Dashboard\Http\Controllers\Sales\EUWithdrawalController;
use Rehla\Dashboard\Http\Controllers\Sales\InvoiceController;
use Rehla\Dashboard\Http\Controllers\Sales\OrderController;
use Rehla\Dashboard\Http\Controllers\Sales\RefundController;
use Rehla\Dashboard\Http\Controllers\Sales\RMA\CustomFieldController;
use Rehla\Dashboard\Http\Controllers\Sales\RMA\ReasonController;
use Rehla\Dashboard\Http\Controllers\Sales\RMA\RequestController;
use Rehla\Dashboard\Http\Controllers\Sales\RMA\RulesController;
use Rehla\Dashboard\Http\Controllers\Sales\RMA\StatusController;
use Rehla\Dashboard\Http\Controllers\Sales\ShipmentController;
use Rehla\Dashboard\Http\Controllers\Sales\TransactionController;
