...
it('should return attribute family listing page', function () {
    ...
    get(route('admin.catalog.families.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.families.index.title'))
        ->assertSeeText(trans('dashboard::app.catalog.families.index.add'));
});
...
it('should return attribute family create page', function () {
    ...
    get(route('admin.catalog.families.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.families.create.title'))
        ->assertSeeText(trans('dashboard::app.catalog.families.create.back-btn'));
});
...
it('should return edit page of attribute families', function () {
    ...
    get(route('admin.catalog.families.edit', $attributeFamily->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.families.edit.title'))
        ->assertSeeText(trans('dashboard::app.catalog.families.edit.back-btn'));
});
...
it('should delete the existing attribute family', function () {
    ...
    deleteJson(route('admin.catalog.families.delete', $attributeFamily->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.families.delete-success'));
...
it('should refuse to delete the default attribute family', function () {
    ...
    deleteJson(route('admin.catalog.families.delete', $attributeFamily->id))
        ->assertStatus(400)
        ->assertJsonPath('message', trans('dashboard::app.catalog.families.default-delete-error'));
