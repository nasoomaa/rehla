...
it('should show attribute page', function () {
    ...
    get(route('admin.catalog.attributes.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.attributes.index.title'))
        ->assertSeeText(trans('dashboard::app.catalog.attributes.index.create-btn'));
});
...
it('should show create page of attribute', function () {
    ...
    get(route('admin.catalog.attributes.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.attributes.create.title'))
        ->assertSeeText(trans('dashboard::app.catalog.attributes.create.save-btn'));
});
...
it('should show edit page of attribute', function () {
    ...
    get(route('admin.catalog.attributes.edit', $attribute->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.attributes.edit.title'))
        ->assertSeeText(trans('dashboard::app.catalog.attributes.edit.back-btn'));
});
...
it('should destroy an attribute', function () {
    ...
    deleteJson(route('admin.catalog.attributes.delete', $attribute->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.attributes.delete-success'));
...
it('should not destroy an attribute if it is not user-defined', function () {
    ...
    deleteJson(route('admin.catalog.attributes.delete', $attribute->id))
        ->assertBadRequest()
        ->assertSeeText(trans('dashboard::app.catalog.attributes.user-define-error'));
...
it('should mass delete attributes', function () {
    ...
    postJson(route('admin.catalog.attributes.mass_delete', [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.attributes.index.datagrid.mass-delete-success'));
