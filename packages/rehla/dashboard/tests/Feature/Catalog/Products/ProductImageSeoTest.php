...
it('should render the seo drawer on the product edit page', function () {
    ...
    get(route('admin.catalog.products.edit', $product->id))
        ...
        ->assertSee(trans('dashboard::app.components.media.images.seo.title'))
        ->assertSee(trans('dashboard::app.components.media.images.seo.alt-text'))
        ->assertSee(trans('dashboard::app.components.media.images.seo.file-name'));
});
