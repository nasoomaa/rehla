...
it('should return the product index page', function () {
    ...
    get(route('admin.catalog.products.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.catalog.products.index.title'))
        ->assertSeeText(trans('dashboard::app.catalog.products.index.create-btn'));
});
...
it('should copy the existing product', function () {
    ...
    postJson(route('admin.catalog.products.copy', $product->id))
        ->assertOk()
        ->assertJsonPath('message', trans('dashboard::app.catalog.products.product-copied'));
...
it('should perform the mass action from update status for products', function () {
    ...
    postJson(route('admin.catalog.products.mass_update'), [
        ...
        ->assertOk()
        ->assertJsonPath('message', trans('dashboard::app.catalog.products.index.datagrid.mass-update-success'));
...
it('should perform the mass action for delete for products', function () {
    ...
    postJson(route('admin.catalog.products.mass_delete'), [
        ...
        ->assertOk()
        ->assertJsonPath('message', trans('dashboard::app.catalog.products.index.datagrid.mass-delete-success'));
