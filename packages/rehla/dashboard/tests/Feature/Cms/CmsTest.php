...
it('should returns the cms page', function () {
    ...
    get(route('admin.cms.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.cms.index.title'))
        ->assertSeeText(trans('dashboard::app.cms.index.create-btn'));
});
...
it('should return the cms create page', function () {
    ...
    get(route('admin.cms.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.cms.create.title'))
...
it('should show the edit cms page', function () {
    ...
    get(route('admin.cms.edit', $cms->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.cms.edit.title'))
        ->assertSeeText(trans('dashboard::app.cms.edit.back-btn'));
});
...
it('should delete the cms page', function () {
    ...
    deleteJson(route('admin.cms.delete', $cms->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.cms.delete-success'));
...
it('should mass delete cms pages', function () {
    ...
    postJson(route('admin.cms.mass_delete'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.cms.index.datagrid.mass-delete-success'));
