...
it('should return the captcha configuration page', function () {
    ...
    get(route('admin.configuration.index', ['customer', 'captcha']))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.configuration.index.customer.captcha.title'))
        ->assertSeeText(trans('dashboard::app.configuration.index.customer.captcha.credentials.title'));
});
...
it('should save captcha configuration with all required fields', function () {
    ...
    postJson(route('admin.configuration.store', ['customer', 'captcha']), [
        ...
        ->assertRedirect()
        ->assertSessionHas('success', trans('dashboard::app.configuration.index.save-message'));
