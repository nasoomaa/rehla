...
it('should return the dashboard index page', function () {
    ...
    get(route('admin.dashboard.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.dashboard.index.title'))
        ->assertSeeText(trans('dashboard::app.dashboard.index.overall-details'))
        ->assertSeeText(trans('dashboard::app.dashboard.index.total-sales'))
        ->assertSeeText(trans('dashboard::app.dashboard.index.product-image'))
        ->assertSeeText(trans('dashboard::app.dashboard.index.today-sales'));
});
