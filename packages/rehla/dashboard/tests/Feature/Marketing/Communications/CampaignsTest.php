...
it('should return the campaign index page', function () {
    ...
    get(route('admin.marketing.communications.campaigns.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.campaigns.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.communications.campaigns.index.create-btn'));
});
...
it('should returns the create page of campaigns', function () {
    ...
    get(route('admin.marketing.communications.campaigns.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.campaigns.create.title'))
...
it('should show the edit page of campaigns', function () {
    ...
    get(route('admin.marketing.communications.campaigns.edit', $campaign->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.campaigns.edit.title'))
        ->assertSeeText(trans('dashboard::app.marketing.communications.campaigns.edit.back-btn'));
});
...
it('should delete the campaign', function () {
    ...
    deleteJson(route('admin.marketing.communications.campaigns.delete', $campaign->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.campaigns.delete-success'));
