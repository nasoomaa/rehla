...
it('should return the email template index page', function () {
    ...
    get(route('admin.marketing.communications.email_templates.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.templates.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.communications.templates.index.create-btn'));
});
...
it('should return the create page of email template', function () {
    ...
    get(route('admin.marketing.communications.email_templates.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.templates.create.title'))
        ->assertSeeText(trans('dashboard::app.marketing.communications.templates.create.save-btn'));
});
...
it('should edit the email template', function () {
    ...
    get(route('admin.marketing.communications.email_templates.edit', $marketingEmailTemplate->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.templates.edit.title'))
        ->assertSeeText(trans('dashboard::app.marketing.communications.templates.edit.save-btn'))
        ->assertSeeText(trans('dashboard::app.marketing.communications.templates.create.content'));
});
...
it('should delete the specified email template', function () {
    ...
    deleteJson(route('admin.marketing.communications.email_templates.delete', $marketingEmailTemplate->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.templates.delete-success'));
});
...
it('should refuse to delete an email template a campaign is using', function () {
    ...
    deleteJson(route('admin.marketing.communications.email_templates.delete', $template->id))
        ->assertStatus(400)
        ->assertJsonPath('message', trans('dashboard::app.marketing.communications.templates.campaign-associate'));
