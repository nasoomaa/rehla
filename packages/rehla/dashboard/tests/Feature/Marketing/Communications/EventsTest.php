...
it('should return the events index page', function () {
    ...
    get(route('admin.marketing.communications.events.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.events.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.communications.events.index.create-btn'));
});
...
it('should store the newly create event', function () {
    ...
    postJson(route('admin.marketing.communications.events.store', $data = [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.events.index.create.success'));
...
it('should update the existing the events', function () {
    ...
    putJson(route('admin.marketing.communications.events.update'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.events.index.edit.success'));
...
it('should delete the specified events', function () {
    ...
    deleteJson(route('admin.marketing.communications.events.delete', $event->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.communications.events.delete-success'));
});
...
it('should refuse to delete an event a campaign is using', function () {
    ...
    deleteJson(route('admin.marketing.communications.events.delete', $event->id))
        ->assertStatus(400)
        ->assertJsonPath('message', trans('dashboard::app.marketing.communications.events.campaign-associate'));
