...
it('should returns the cart rule page', function () {
    ...
    get(route('admin.marketing.promotions.cart_rules.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.promotions.cart-rules.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.promotions.cart-rules.index.create-btn'));
});
...
it('should returns the create page of cart rules', function () {
    ...
    get(route('admin.marketing.promotions.cart_rules.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.promotions.cart-rules.create.title'))
        ->assertSeeText(trans('dashboard::app.account.edit.back-btn'))
        ->assertSeeText(trans('dashboard::app.marketing.promotions.cart-rules.create.save-btn'));
});
...
it('should copy the existing cart rule', function () {
    ...
    get(route('admin.marketing.promotions.cart_rules.copy', $cartRule->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.promotions.cart-rules.edit.title'));
});
...
it('should delete the cart rules', function () {
    ...
    deleteJson(route('admin.marketing.promotions.cart_rules.delete', $cartRule->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.promotions.cart-rules.delete-success'));
