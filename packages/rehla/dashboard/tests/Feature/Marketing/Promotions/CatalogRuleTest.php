...
it('should returns the catalog rule page', function () {
    ...
    get(route('admin.marketing.promotions.catalog_rules.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.promotions.catalog-rules.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.promotions.catalog-rules.index.create-btn'));
});
...
it('should returns the create page of catalog rules', function () {
    ...
    get(route('admin.marketing.promotions.catalog_rules.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.promotions.catalog-rules.create.title'))
        ->assertSeeText(trans('dashboard::app.marketing.promotions.catalog-rules.create.back-btn'))
        ->assertSeeText(trans('dashboard::app.marketing.promotions.catalog-rules.create.save-btn'));
});
...
it('should returns the edit page of catalog rules', function () {
    ...
    get(route('admin.marketing.promotions.catalog_rules.edit', $catalogRule->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.promotions.catalog-rules.edit.title'))
        ->assertSeeText(trans('dashboard::app.marketing.promotions.catalog-rules.edit.save-btn'));
});
...
it('should delete a specific catalog rule', function () {
    ...
    deleteJson(route('admin.marketing.promotions.catalog_rules.delete', $catalogRule->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.promotions.catalog-rules.delete-success'));
});
