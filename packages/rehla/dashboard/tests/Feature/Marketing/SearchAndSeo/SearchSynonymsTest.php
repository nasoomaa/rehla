...
it('should show the search synonyms index page', function () {
    ...
    get(route('admin.marketing.search_seo.search_synonyms.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-synonyms.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-synonyms.index.create-btn'));
});
...
it('should store the newly created search synonyms', function () {
    ...
    postJson(route('admin.marketing.search_seo.search_synonyms.store'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-synonyms.index.create.success'));
...
it('should update the search synonyms', function () {
    ...
    putJson(route('admin.marketing.search_seo.search_synonyms.update'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-synonyms.index.edit.success'));
...
it('should delete the search synonyms', function () {
    ...
    deleteJson(route('admin.marketing.search_seo.search_synonyms.delete', $searchSynonym->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-synonyms.index.edit.delete-success'));
...
it('should mass delete the search synonyms', function () {
    ...
    postJson(route('admin.marketing.search_seo.search_synonyms.mass_delete'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-synonyms.index.datagrid.mass-delete-success'));
