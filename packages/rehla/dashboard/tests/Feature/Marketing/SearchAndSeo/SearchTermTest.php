...
it('should show the search terms index page', function () {
    ...
    get(route('admin.marketing.search_seo.search_terms.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-terms.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-terms.index.create-btn'));
});
...
it('should store the newly created search term', function () {
    ...
    postJson(route('admin.marketing.search_seo.search_terms.store'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-terms.index.create.success'));
...
it('should update the search term', function () {
    ...
    putJson(route('admin.marketing.search_seo.search_terms.update'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-terms.index.edit.success'));
...
it('should delete the search term', function () {
    ...
    deleteJson(route('admin.marketing.search_seo.search_terms.delete', $searchTerm->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-terms.index.edit.delete-success'));
...
it('should mass delete the search term', function () {
    ...
    postJson(route('admin.marketing.search_seo.search_terms.mass_delete'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.search-terms.index.datagrid.mass-delete-success'));
