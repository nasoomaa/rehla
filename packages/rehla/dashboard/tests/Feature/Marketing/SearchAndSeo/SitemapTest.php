...
it('should show the sitemap index page', function () {
    ...
    get(route('admin.marketing.search_seo.sitemaps.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.sitemaps.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.sitemaps.index.create-btn'));
});
...
it('should store the newly created sitemap', function () {
    ...
    postJson(route('admin.marketing.search_seo.sitemaps.store'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.sitemaps.index.create.success'));
...
it('should update the sitemap', function () {
    ...
    putJson(route('admin.marketing.search_seo.sitemaps.update'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.sitemaps.index.edit.success'));
...
it('should delete the sitemap', function () {
    ...
    deleteJson(route('admin.marketing.search_seo.sitemaps.delete', $sitemap->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.sitemaps.index.edit.delete-success'));
