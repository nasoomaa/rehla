...
it('should show the url rewrite index page', function () {
    ...
    get(route('admin.marketing.search_seo.url_rewrites.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.url-rewrites.index.title'))
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.url-rewrites.index.create-btn'));
});
...
it('should store the newly created url', function () {
    ...
    postJson(route('admin.marketing.search_seo.url_rewrites.store'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.url-rewrites.index.create.success'));
...
it('should update the existing url rewrite', function () {
    ...
    putJson(route('admin.marketing.search_seo.url_rewrites.update'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.url-rewrites.index.edit.success'));
...
it('should delete the existing url rewrite', function () {
    ...
    deleteJson(route('admin.marketing.search_seo.url_rewrites.delete', $urlRewrite->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.url-rewrites.index.edit.delete-success'));
...
it('should mass delete the existing url rewrites', function () {
    ...
    postJson(route('admin.marketing.search_seo.url_rewrites.mass_delete'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.marketing.search-seo.url-rewrites.index.datagrid.mass-delete-success'));
