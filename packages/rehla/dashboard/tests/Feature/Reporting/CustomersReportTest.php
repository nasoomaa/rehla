...
it('should return the index page of customers reporting', function () {
    ...
    get(route('admin.reporting.customers.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.reporting.customers.index.title'))
        ->assertSeeText(trans('dashboard::app.reporting.customers.index.customers-with-most-orders'))
        ->assertSeeText(trans('dashboard::app.reporting.customers.index.customers-with-most-reviews'))
        ->assertSeeText(trans('dashboard::app.reporting.customers.index.customers-with-most-sales'))
        ->assertSeeText(trans('dashboard::app.reporting.customers.index.top-customer-groups'))
        ->assertSeeText(trans('dashboard::app.reporting.customers.index.total-customers'));
});
