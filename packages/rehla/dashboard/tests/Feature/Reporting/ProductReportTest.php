...
it('should returns the reporting product page', function () {
    ...
    get(route('admin.reporting.products.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.reporting.products.index.title'))
        ->assertSeeText(trans('dashboard::app.reporting.products.index.last-search-terms'))
        ->assertSeeText(trans('dashboard::app.reporting.products.index.products-with-most-reviews'))
        ->assertSeeText(trans('dashboard::app.reporting.products.index.view-details'))
        ->assertSeeText(trans('dashboard::app.reporting.products.index.top-selling-products-by-quantity'))
        ->assertSeeText(trans('dashboard::app.reporting.products.index.top-selling-products-by-revenue'))
        ->assertSeeText(trans('dashboard::app.reporting.products.index.view-details'))
        ->assertSeeText(trans('dashboard::app.reporting.products.index.top-search-terms'));
});
...
it('should return the product view page', function () {
    ...
    get(route('admin.reporting.products.view', [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.reporting.products.index.total-sold-quantities'))
        ->assertSeeText(trans('dashboard::app.reporting.view.export-csv'))
        ->assertSeeText(trans('dashboard::app.reporting.view.export-xls'));
});
