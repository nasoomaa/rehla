...
it('should return the sales index page', function () {
    ...
    get(route('admin.reporting.sales.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.reporting.sales.index.title'))
        ->assertSeeText(trans('dashboard::app.reporting.sales.index.refunds'))
        ->assertSeeText(trans('dashboard::app.reporting.sales.index.total-sales'));
});
