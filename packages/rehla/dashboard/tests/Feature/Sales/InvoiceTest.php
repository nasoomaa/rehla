...
it('should returns the invoice index page', function () {
    ...
    get(route('admin.sales.invoices.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.sales.invoices.index.title'));
});
...
it('should return the view page of the invoice', function () {
    ...
    get(route('admin.sales.invoices.view', $invoice->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.sales.invoices.view.title', ['invoice_id' => $invoice->increment_id ?? $invoice->id]))
        ->assertSeeText(trans('dashboard::app.account.edit.back-btn'))
        ->assertSeeText(trans('dashboard::app.sales.invoices.view.print'));
