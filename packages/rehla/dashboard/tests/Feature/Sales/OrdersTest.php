...
it('should return the index page of Orders page', function () {
    ...
    get(route('admin.sales.orders.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.sales.orders.index.title'));
});
...
it('should return the view page of order', function () {
    ...
    get(route('admin.sales.orders.view', $order->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.sales.orders.view.'.$order->status))
        ->assertSeeText(trans('dashboard::app.sales.orders.view.title', ['order_id' => $order->increment_id]))
        ->assertSeeText(trans('dashboard::app.sales.orders.view.summary-tax'))
        ->assertSeeText(trans('dashboard::app.sales.orders.view.summary-grand-total'))
        ->assertSeeText(trans('dashboard::app.sales.orders.view.comments'));
