...
it('should return the refund index page', function () {
    ...
    get(route('admin.sales.refunds.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.sales.refunds.index.title'));
});
...
it('should return the view page of refund', function () {
    ...
    get(route('admin.sales.refunds.view', $refund->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.sales.refunds.view.title', ['refund_id' => $refund->id]))
        ->assertSeeText(trans('dashboard::app.sales.refunds.view.product-ordered'));
