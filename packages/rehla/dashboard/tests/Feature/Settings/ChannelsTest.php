...
it('should returns the channel index page', function () {
    ...
    get(route('admin.settings.channels.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.channels.index.title'))
        ->assertSeeText(trans('dashboard::app.settings.channels.index.create-btn'));
});
...
it('should return the create page of channel', function () {
    ...
    get(route('admin.settings.channels.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.channels.create.title'))
        ->assertSeeText(trans('dashboard::app.settings.channels.create.save-btn'));
});
...
it('should returns the edit page of channels', function () {
    ...
    get(route('admin.settings.channels.edit', $channel->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.channels.edit.title'))
        ->assertSeeText(trans('dashboard::app.settings.channels.edit.save-btn'));
});
...
it('should delete the existing channel', function () {
    ...
    deleteJson(route('admin.settings.channels.delete', $channel->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.channels.index.delete-success'));
