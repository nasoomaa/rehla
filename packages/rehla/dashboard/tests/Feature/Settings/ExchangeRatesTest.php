...
it('should returns the exchange rate index page', function () {
    ...
    get(route('admin.settings.exchange_rates.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.exchange-rates.index.title'))
        ->assertSeeText(trans('dashboard::app.settings.exchange-rates.index.create-btn'))
        ->assertSeeText(trans('dashboard::app.settings.exchange-rates.index.update-rates'));
});
...
it('should store the newly created exchange rates', function () {
    ...
    postJson(route('admin.settings.exchange_rates.store'), [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.exchange-rates.index.create-success'));
...
it('should update the currency exchange rate', function () {
    ...
    putJson(route('admin.settings.exchange_rates.update'), [
        ...
        ->assertOk()
        ->assertJsonPath('message', trans('dashboard::app.settings.exchange-rates.index.update-success'));
...
it('should delete the exchange rate', function () {
    ...
    deleteJson(route('admin.settings.exchange_rates.delete', $currencyExchangeRate->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.exchange-rates.index.delete-success'));
