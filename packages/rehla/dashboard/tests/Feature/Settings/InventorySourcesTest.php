...
it('should returns the inventory sources index page', function () {
    ...
    get(route('admin.settings.inventory_sources.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.inventory-sources.index.title'))
        ->assertSeeText(trans('dashboard::app.settings.inventory-sources.index.create-btn'));
});
...
it('should return the inventory sources create page', function () {
    ...
    get(route('admin.settings.inventory_sources.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.inventory-sources.create.add-title'))
        ->assertSeeText(trans('dashboard::app.marketing.communications.campaigns.create.back-btn'));
});
...
it('should return the edit of the inventory sources', function () {
    ...
    get(route('admin.settings.inventory_sources.edit', $inventorySource->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.inventory-sources.edit.title'))
        ->assertSeeText(trans('dashboard::app.settings.inventory-sources.edit.back-btn'))
        ->assertSeeText(trans('dashboard::app.settings.inventory-sources.edit.save-btn'));
});
...
it('should delete the inventory source', function () {
    ...
    deleteJson(route('admin.settings.inventory_sources.delete', $inventorySource->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.inventory-sources.delete-success'));
});
