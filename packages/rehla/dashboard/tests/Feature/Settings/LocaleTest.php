...
it('should returns the locale index page', function () {
    ...
    get(route('admin.settings.locales.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.locales.index.title'))
        ->assertSeeText(trans('dashboard::app.settings.locales.index.create-btn'));
});
...
it('should store the newly created locale', function () {
    ...
    postJson(route('admin.settings.locales.store'), $data = [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.locales.index.create-success'));
...
it('should update the specified locale', function () {
    ...
    putJson(route('admin.settings.locales.update'), $data = [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.locales.index.update-success'));
...
it('should delete the locale', function () {
    ...
    deleteJson(route('admin.settings.locales.delete', $locale->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.locales.index.delete-success'));
