...
it('should returns the role index page', function () {
    ...
    get(route('admin.settings.roles.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.roles.index.title'))
        ->assertSeeText(trans('dashboard::app.settings.roles.index.create-btn'));
});
...
it('should returns the create page of role', function () {
    ...
    get(route('admin.settings.roles.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.roles.create.title'))
        ->assertSeeText(trans('dashboard::app.settings.roles.create.save-btn'));
});
...
it('should delete the existing role', function () {
    ...
    deleteJson(route('admin.settings.roles.delete', $role->id))
        ->assertOk()
        ->assertJsonPath('message', trans('dashboard::app.settings.roles.delete-success'));
