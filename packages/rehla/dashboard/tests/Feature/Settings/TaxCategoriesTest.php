...
it('should returns the tax category index page', function () {
    ...
    get(route('admin.settings.taxes.categories.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.taxes.categories.index.title'))
        ->assertSeeText(trans('dashboard::app.settings.taxes.categories.index.create.title'));
});
...
it('should store the tax category', function () {
    ...
    postJson(route('admin.settings.taxes.categories.store'), $data = [
        ...
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.taxes.categories.index.create-success'));
...
it('should update the tax category', function () {
    ...
    putJson(route('admin.settings.taxes.categories.update'), $data = [
        ...
        ->assertOk()
        ->assertJsonPath('message', trans('dashboard::app.settings.taxes.categories.index.update-success'));
...
it('should delete the tax category', function () {
    ...
    deleteJson(route('admin.settings.taxes.categories.delete', $taxCategory->id))
        ->assertOk()
        ->assertJsonPath('message', trans('dashboard::app.settings.taxes.categories.index.delete-success'));
});
