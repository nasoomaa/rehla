...
it('should returns the tax rate index page', function () {
    ...
    get(route('admin.settings.taxes.rates.index'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.taxes.rates.index.title'))
        ->assertSeeText(trans('dashboard::app.settings.taxes.rates.index.button-title'));
});
...
it('should returns the create page of tax rate', function () {
    ...
    get(route('admin.settings.taxes.rates.create'))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.taxes.rates.create.title'))
        ->assertSeeText(trans('dashboard::app.settings.taxes.rates.create.back-btn'));
});
...
it('should returns the edit page of the tax rate', function () {
    ...
    get(route('admin.settings.taxes.rates.edit', $taxRate->id))
        ->assertOk()
        ->assertSeeText(trans('dashboard::app.settings.taxes.rates.edit.title'))
        ->assertSeeText(trans('dashboard::app.settings.taxes.rates.edit.back-btn'));
});
...
it('should delete the tax rate', function () {
    ...
    deleteJson(route('admin.settings.taxes.rates.delete', $taxRate->id))
        ->assertOk()
        ->assertJsonPath('message', trans('dashboard::app.settings.taxes.rates.delete-success'));
